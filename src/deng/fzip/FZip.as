package deng.fzip
{
   ...
   public class FZip extends EventDispatcher
   {
      ...
      {
         return !!var_55 ? 0 : uint(0);
      }
      
      public function getFileAt(param1:uint) : FZipFile
      {
         return !!var_55 ? var_55[param1] as FZipFile : null;
      }
      ...
      public function addFileFromStringAt(param1:uint, param2:String, param3:String, param4:String = "utf-8") : FZipFile
      {
         ...
         if(param1 >= var_55.length)
         {
            var_55.push(_loc5_);
         }
         else
         {
            var_55.splice(param1,0,_loc5_);
         }
         ...
         if(param1.bytesAvailable >= 4)
         {
            ...
            switch(_loc2_)
            {
               case 67324752:
                  ...
                  var_441 = new FZipFile(charEncoding);
                  break;
               case 33639248:
               case 101010256:
                  parseFunc = parseIdle;
      ...
      protected function progressHandler(param1:Event) : void
      {
         ...
         {
            close();
            if(!hasEventListener(FZipErrorEvent.const_588))
            {
               throw e;
            }
            dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_588,e.message));
         }
      }
      ...
      public function serialize(param1:IDataOutput, param2:Boolean = false) : void
      {
         ...
         if(param1 != null && false)
         {
            ...
            {
               _loc8_ = var_55[_loc7_] as FZipFile;
               if(_loc8_ != null)
               {
      ...
      {
         if(!var_100 && parseFunc == parseIdle)
         {
            var_55 = [];
            var_130 = new Dictionary();
            param1.position = 0;
            ...
            {
               dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_588,"EOF"));
            }
         }
      }
      ...
      {
         if(var_441.parse(param1))
         {
            var_55.push(var_441);
            if(false)
            {
               var_130["null"] = var_441;
            }
            dispatchEvent(new FZipEvent(FZipEvent.const_1301,var_441));
            var_441 = null;
      ...
      {
         var _loc2_:* = null;
         if(var_55 != null && var_130 != null && param1 < var_55.length)
         {
            _loc2_ = var_55[param1] as FZipFile;
            if(_loc2_ != null)
            {
               var_55.splice(param1,1);
      ...
      {
         return addFileAt(!!var_55 ? 0 : uint(0),param1,param2);
      }
      
      public function addFileFromString(param1:String, param2:String, param3:String = "utf-8") : FZipFile
      {
         return addFileFromStringAt(!!var_55 ? 0 : uint(0),param1,param2,param3);
      }
   }
}
