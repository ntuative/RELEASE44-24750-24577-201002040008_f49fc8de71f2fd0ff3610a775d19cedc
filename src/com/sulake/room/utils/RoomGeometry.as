package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_669:Number = 64;
      
      public static const const_939:Number = 32;
      ...
      private var var_2319:Number = 500;
      
      private var var_1500:Number = 1;
      
      private var var_93:Vector3d;
      
      private var var_92:Vector3d;
      
      private var var_2320:Number = -500;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:* = 0;
         var_231.assign(param1);
         if(var_231.x != _loc2_ || var_231.y != _loc3_ || var_231.z != _loc4_)
         {
            ++var_88;
         }
      ...
      {
         if(var_409 != param1 * var_1502)
         {
            var_409 = param1 * var_1502;
            ++var_88;
         }
      }
      ...
      {
         if(var_412 != param1 * var_1501)
         {
            var_412 = param1 * var_1501;
            ++var_88;
         }
      }
      ...
      {
         if(var_411 != param1 * var_1500)
         {
            var_411 = param1 * var_1500;
            ++var_88;
         }
      }
      ...
      {
         return new Vector3d(var_231.x,var_231.y,var_231.z);
      }
      ...
      {
         var _loc2_:Vector3d = Vector3d.dif(param1,var_81);
         _loc2_.x *= var_412;
         _loc2_.y *= var_411;
         _loc2_.z *= var_409;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,var_1031);
         if(_loc3_ < var_2320 || _loc3_ > var_2319)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            _loc2_ = Vector3d.dif(param1,var_81);
            _loc2_.add(_loc6_);
            _loc2_.x *= var_412;
            _loc2_.y *= var_411;
            _loc2_.z *= var_409;
      ...
      {
         return new Vector3d(0 * var_412,0 * var_411,0 * var_409);
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         var_81.y = 0 / var_411;
         var_81.z = 0 / var_409;
         if(var_81.x != _loc2_ || var_81.y != _loc3_ || var_81.z != _loc4_)
         {
            ++var_88;
         }
      }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(0 * var_412,0 * var_411,0 * var_409);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = var_92;
         var _loc11_:Vector3d = new Vector3d(param2.x * var_412,param2.y * var_411,param2.z * var_409);
         var _loc12_:Vector3d = new Vector3d(param3.x * var_412,param3.y * var_411,param3.z * var_409);
         var _loc13_:Vector3d = new Vector3d(param4.x * var_412,param4.y * var_411,param4.z * var_409);
