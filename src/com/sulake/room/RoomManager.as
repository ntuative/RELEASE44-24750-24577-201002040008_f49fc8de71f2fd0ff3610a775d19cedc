package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      private var var_461:IRoomObjectFactory = null;
      
      private var var_1491:int;
      
      private var var_2339:IRoomContentLoader;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         var_462 = [];
         var_460 = [];
         _events.addEventListener(RoomContentLoadedEvent.const_313,onContentLoaded);
         _events.addEventListener(RoomContentLoadedEvent.const_405,onContentLoaded);
         _events.addEventListener(RoomContentLoadedEvent.const_665,onContentLoaded);
      }
      
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         var _loc5_:* = null;
         if(var_47 == const_1274)
         {
            if(var_805 != null)
            {
               return false;
         ...
         var_1491 = 50;
         var_121 = param2;
         var _loc3_:Array = var_54.getPlaceHolderTypes();
         var _loc4_:int = 0;
         while(_loc4_ < _loc3_.length)
         {
            _loc5_ = _loc3_[_loc4_];
            if(var_462.indexOf(_loc5_) < 0)
            {
               var_54.loadObjectContent(_loc5_,_events);
               var_462.push(_loc5_);
            }
            _loc4_++;
         }
      ...
      {
         if(var_47 < ROOM_MANAGER_INITIALIZED)
         {
         ...
         if(!var_54.hasInternalContent(param3))
         {
            _loc7_ = var_54.getGraphicAssetCollection(param3);
            if(_loc7_ == null)
            {
               var_54.loadObjectContent(param3,_events);
               _loc12_ = var_54.getPlaceHolderType(param3);
               _loc7_ = var_54.getGraphicAssetCollection(_loc12_);
            }
            _loc8_ = var_54.getVisualizationXML(_loc12_);
            _loc9_ = var_54.getLogicXML(_loc12_);
            if(_loc8_ == null || _loc7_ == null)
            {
               return null;
            }
            _loc10_ = var_54.getVisualizationType(_loc12_);
            _loc11_ = var_54.getLogicType(_loc12_);
         }
         else
         {
            _loc10_ = param3;
         ...
         var _loc17_:IRoomObjectGraphicVisualization = var_391.createRoomObjectVisualization(_loc10_);
         if(_loc17_ == null)
         {
            _loc5_.disposeObject(param2,param4);
            return null;
         ...
         var _loc18_:* = null;
         _loc18_ = var_391.getRoomObjectVisualizationData(_loc12_,_loc10_,_loc8_);
         ...
         var _loc19_:IRoomObjectEventHandler = var_461.createRoomObjectLogic(_loc11_);
      ...
      public function isContentAvailable(param1:String) : Boolean
      {
         if(var_54 != null)
         {
            if(var_54.getGraphicAssetCollection(param1) != null)
            {
               return true;
            }
         }
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_461 = param2 as IRoomObjectFactory;
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(var_461 != null)
         {
            return var_461.createRoomObjectManager();
         }
         return null;
      }
      ...
      private function onContentLoaded(param1:RoomContentLoadedEvent) : void
      {
         ...
         var _loc3_:XML = var_54.getVisualizationXML(_loc2_);
         if(_loc3_ == null)
         {
            if(var_121 != null)
            {
         ...
         var _loc4_:IGraphicAssetCollection = var_54.getGraphicAssetCollection(_loc2_);
         if(_loc4_ == null)
         {
            if(var_121 != null)
            {
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(var_54.getGraphicAssetCollection(param1) != null)
         {
            _loc2_ = var_462.indexOf(param1);
            if(_loc2_ >= 0)
            {
               var_462.splice(_loc2_,1);
            }
            if(false)
            {
               var_47 = ROOM_MANAGER_INITIALIZED;
               if(var_121 != null)
               {
      ...
      private function updateObjectContent(param1:String) : void
      {
         ...
         if(var_54 == null || var_391 == null)
         {
            return;
         }
         var _loc2_:XML = var_54.getVisualizationXML(param1);
         var _loc3_:XML = var_54.getLogicXML(param1);
         var _loc4_:IGraphicAssetCollection = var_54.getGraphicAssetCollection(param1);
               ...
               while(_loc10_ >= 0)
               {
                  ...
                  while(_loc13_ >= 0)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        _loc16_ = var_54.getContentType(_loc15_);
                        if(_loc16_ == param1)
                        {
                           _loc17_ = var_54.getVisualizationType(_loc15_);
                           _loc18_ = var_54.getLogicType(_loc15_);
                           _loc5_ = var_391.getRoomObjectVisualizationData(_loc15_,_loc17_,_loc2_);
                           _loc19_ = var_391.createRoomObjectVisualization(_loc17_);
                           if(_loc19_ != null)
                           {
                              ...
                              else
                              {
                                 ...
                                 _loc20_ = var_461.createRoomObjectLogic(_loc18_);
