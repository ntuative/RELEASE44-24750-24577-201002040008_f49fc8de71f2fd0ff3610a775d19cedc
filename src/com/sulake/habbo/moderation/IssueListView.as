package com.sulake.habbo.moderation
{
   ...
   public class IssueListView
   {
      ...
      private var var_2353:BitmapData;
      
      private var var_584:IssueBrowser;
      
      private var var_1505:IWindowContainer;
      ...
      public function IssueListView(param1:IssueManager, param2:IssueBrowser, param3:IItemListWindow, param4:String)
      {
         ...
         var_59 = param3;
         var_1186 = param4;
         var_1505 = var_584.createWindow(param4) as IWindowContainer;
      }
      ...
      public function update(param1:Array) : void
      {
         ...
         for each(_loc5_ in param1)
         {
            ...
            if(_loc5_ == null || var_1505 == null)
            {
               return;
            }
            _loc2_ = var_1505.clone() as IWindowContainer;
            if(_loc2_ == null)
            {
               return;
            }
            _loc2_.width = var_59.width;
            ...
            if(_loc7_ != null)
            {
               ...
               _loc9_ = var_584.assets.getAssetByName(_loc8_) as BitmapDataAsset;
