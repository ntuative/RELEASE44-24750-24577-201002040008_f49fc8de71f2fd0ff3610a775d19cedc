package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      {
         var_890 = IWindowContainer(var_58.getXmlWindow("chatlog_roomheader"));
         var_889 = IWindowContainer(var_58.getXmlWindow("chatlog_chatline"));
         var_513 = new Timer(300,1);
         var_513.addEventListener(TimerEvent.TIMER,onResizeTimer);
         var_62 = IFrameWindow(var_58.getXmlWindow("chatlog_frame"));
         var_59 = IItemListWindow(var_62.findChildByName("chatline_list"));
         var_62.procedure = onWindow;
         var _loc1_:IWindow = var_62.findChildByTag("close");
         _loc1_.procedure = onClose;
         var_58.connection.send(var_1426);
         var_58.messageHandler.addChatlogListener(this);
      }
      ...
      public function onChatlog(param1:String, param2:int, param3:int, param4:Array, param5:Dictionary) : void
      {
         ...
         var_58.messageHandler.removeChatlogListener(this);
         var_62.caption = param1;
         var_111 = param4;
         var_1316 = param5;
         populate();
         onResizeTimer(null);
      ...
      {
         var _loc5_:* = null;
         var _loc2_:IWindowContainer = IWindowContainer(var_890.clone());
         var _loc3_:ITextWindow = ITextWindow(_loc2_.findChildByName("room_name_txt"));
         if(param1.roomId > 0)
         {
            _loc3_.caption = param1.roomName;
            new OpenRoomTool(var_62,var_58,_loc3_,param1.isPublic,param1.roomId);
         }
         else
         {
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         _loc4_.color = var_1316[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            new OpenUserInfo(var_62,var_58,_loc6_,param2.chatterId);
         }
