package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_764:int = 31536000;
      ...
      public static function formatTime(param1:int) : String
      {
         ...
         return Math.round(param1 / const_764) + " years ago";
      }
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_58.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(_data.userId),var_58,WindowTracker.const_962,_data.userId),_callerFrame,var_998,false,true);
      }
      ...
      private function prepare() : IWindowContainer
      {
         ...
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(var_58.getXmlWindow("user_info"));
            var_825.addChild(_loc1_);
            var_58.disableButton(var_58.initMsg.chatlogsPermission,_loc1_,"chatlog_but");
            var_58.disableButton(var_58.initMsg.alertPermission,_loc1_,"message_but");
            var_58.disableButton(var_58.initMsg.alertPermission || var_58.initMsg.kickPermission || var_58.initMsg.banPermission,_loc1_,"modaction_but");
         }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_58.windowTracker.show(new ModActionCtrl(var_58,_data.userId,_data.userName,var_1227),_callerFrame,var_998,false,true);
      }
      ...
      private function onHabboInfoToolButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_58.openHkPage("habboinfotool.url",_data.userName);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_58.windowTracker.show(new RoomVisitsCtrl(var_58,_data.userId),_callerFrame,var_998,false,true);
      }
      ...
      {
         var_58.openHkPage("moderatoractionlog.url",_data.userName);
      }
      ...
      public function load(param1:IWindowContainer, param2:int) : void
      {
         ...
         _data = null;
         refresh();
         var_58.messageHandler.addUserInfoListener(this);
         var_58.connection.send(new GetModeratorUserInfoMessageComposer(param2));
      }
      ...
      public function dispose() : void
      {
         ...
         _disposed = true;
         var_58.messageHandler.removeUserInfoListener(this);
         _callerFrame = null;
         var_58 = null;
         _data = null;
         var_825 = null;
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_58.windowTracker.show(new SendMsgsCtrl(var_58,_data.userId,_data.userName,var_1227),_callerFrame,var_998,false,true);
      }
