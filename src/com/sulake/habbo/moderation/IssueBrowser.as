package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private var var_1386:IIssueBrowserView;
      
      private const const_1593:String = "open_issues";
      
      private var _window:IFrameWindow;
      
      private const const_1594:String = "picked_issues";
      
      private var _assets:IAssetLibrary;
      
      private var var_1385:IIssueBrowserView;
      
      private const const_1620:String = "closed_issues";
      ...
      private var var_1387:PickedIssuesView;
      
      private var var_331:IIssueBrowserView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         var_331.view.width = var_220.container.width;
         var_331.view.height = var_220.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case const_1595:
               if(var_1385 == null)
               {
                  var_1385 = new MyIssuesView(issueManager,this,var_220.container);
               }
               return var_1385;
            case const_1593:
               if(var_1386 == null)
               {
                  var_1386 = new OpenIssuesView(issueManager,this,var_220.container);
               }
               return var_1386;
            case const_1594:
               if(var_1387 == null)
               {
                  var_1387 = new PickedIssuesView(issueManager,this,var_220.container);
               }
               return var_1387;
            default:
               return null;
