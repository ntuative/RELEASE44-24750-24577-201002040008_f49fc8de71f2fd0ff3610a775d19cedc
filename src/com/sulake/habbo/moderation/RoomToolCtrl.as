package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_617:ICheckBoxWindow;
      
      private var var_62:IFrameWindow;
      
      private var var_912:ICheckBoxWindow;
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_58.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,_data.flatId),var_58,WindowTracker.const_572,_data.flatId),var_62,false,false,true);
      }
      ...
      private function setSendButtonState(param1:String) : void
      {
         ...
         var _loc3_:IButtonWindow = IButtonWindow(var_62.findChildByName(param1));
      ...
      {
         var _loc3_:ITextWindow = ITextWindow(var_62.findChildByName(param1));
         _loc3_.text = param2;
      }
      
      public function onRoomInfo(param1:RoomModerationData) : void
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + var_382);
         if(param1.flatId != var_382)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + var_382);
            return;
         }
         _data = param1;
         populate();
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_58.windowTracker.show(new UserInfoFrameCtrl(var_58,_data.ownerId),var_62,false,false,true);
      }
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var _loc2_:int = determineAction(param1,var_617.isSelected);
         var_58.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1281,_loc2_,var_403.text,"",""));
         if(false)
         {
            var_58.connection.send(new ModerateRoomMessageComposer(_data.flatId,var_911.isSelected,var_912.isSelected,var_617.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1152);
         }
      ...
      {
         var_59 = IItemListWindow(var_62.findChildByName("list_cont"));
         ...
         var_617 = ICheckBoxWindow(var_62.findChildByName("kick_check"));
         var_911 = ICheckBoxWindow(var_62.findChildByName("lock_check"));
         var_912 = ICheckBoxWindow(var_62.findChildByName("changename_check"));
         ...
         var_62.findChildByName("enter_room_but").procedure = onEnterRoom;
         var_62.findChildByName("chatlog_but").procedure = onChatlog;
         var_62.findChildByName("edit_in_hk_but").procedure = onEditInHk;
         var_62.findChildByName("bobba_filter_but").procedure = onBobbaFilter;
         var_62.findChildByName("send_caution_but").procedure = onSendCaution;
         var_62.findChildByName("send_message_but").procedure = onSendMessage;
         var_58.disableButton(var_58.initMsg.bobbaFilterPermission,var_62,"bobba_filter_but");
         var_58.disableButton(var_58.initMsg.chatlogsPermission,var_62,"chatlog_but");
         if(!var_58.initMsg.roomKickPermission)
         {
            var_617.disable();
         }
         var_62.findChildByName("owner_name_txt").procedure = onOwnerName;
         this.onRoomChange();
      }
      ...
      {
         var_62 = IFrameWindow(var_58.getXmlWindow("roomtool_frame"));
         var_58.messageHandler.addRoomInfoListener(this);
         var_58.connection.send(new GetModeratorRoomInfoMessageComposer(var_382));
         Logger.log("BEGINNING TO SHOW: " + var_382);
      }
   }
}
