package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_759:int = 100;
       
      
      private var var_1899:IScrollbarWindow;
      
      private var var_135:HabboMessenger;
      
      private var var_1456:IContainerButtonWindow;
      
      private var var_467:Conversation;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         var_135 = param1;
         var_1456 = initButton("follow_friend",onFollowButtonClick,param2);
         var_59 = IItemListWindow(param2.findChildByName("msg_list"));
         var_1899 = IScrollbarWindow(param2.findChildByName("scroller"));
      ...
      private function findAddIndex() : int
      {
         ...
         {
            _loc2_ = var_59.getListItemAt(_loc1_);
            if(!_loc2_.visible)
            {
               return _loc1_;
            }
      ...
      {
         if(param1 == Message.const_622)
         {
            return 4285887861;
         }
         if(param1 == Message.const_709)
         {
            return 4285887861;
         }
         return 4278190080;
      ...
      {
         var _loc4_:ITextWindow = var_59.getListItemAt(param2) as ITextWindow;
         if(_loc4_ == null)
         {
            if(!param1)
            {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_714 || param3.type == Message.const_619 ? param3.time + ": " : "";
      ...
      private function refreshList() : void
      {
         ...
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,var_467.messages.length - const_759);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < var_467.messages.length)
         {
            refreshEntry(true,_loc1_,var_467.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      public function refresh() : void
      {
         ...
         if(var_467 == null || _loc1_.id != var_467.id)
         {
            var_467 = _loc1_;
            refreshList();
            afterResize();
      ...
      private function refreshListDims() : void
      {
         ...
         while(_loc1_ < var_59.numListItems)
         {
            _loc2_ = ITextWindow(var_59.getListItemAt(_loc1_));
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_759 + const_1072)
         {
            refreshList();
            afterResize();
         }
      ...
      private function onCloseButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_135.messengerView.refresh(true);
      }
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_135.send(new FollowFriendMessageComposer(var_467.id));
      }
