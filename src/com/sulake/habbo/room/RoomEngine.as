package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, ICoreUpdateReceiver
   {
      ...
      private static const const_483:String = "room";
      
      private static const const_749:int = -2;
      
      private static const const_484:String = "temporary_room";
      
      private static const const_271:String = "object_icon_sprite";
      
      private static const const_750:int = -3;
      
      private static const const_748:String = "overlay";
      
      private static const OBJECT_TYPE_SELECTION_ARROW:String = "selection_arrow";
      
      private static const const_1051:String = "tile_cursor";
      
      private static const const_272:int = -1;
       
      
      private var var_391:IRoomObjectVisualizationFactory = null;
      ...
      private var var_489:IAdManager = null;
      
      private var var_547:NumberBank;
      ...
      private var var_644:RoomMessageHandler = null;
      ...
      public function RoomEngine(param1:IContext, param2:uint = 0)
      {
         super(param1,param2);
         var_292 = new Map();
         var_547 = new NumberBank(1000);
         var_973 = new Map();
         var_291 = new Map();
         var_73 = new RoomObjectEventHandler(this);
         var_644 = new RoomMessageHandler(this);
      ...
      public function deleteRoomObject(param1:int, param2:int) : Boolean
      {
         if(var_73 != null)
         {
            ...
            {
               return var_73.deleteWallItem(var_119,var_120,param1);
            }
         }
         return false;
      }
      ...
      private function getRoomCanvas(param1:int, param2:int, param3:int) : IRoomRenderingCanvas
      {
         ...
         var _loc5_:IRoomInstance = var_51.getRoom(_loc4_);
         if(_loc5_ == null)
         {
            return null;
         }
      ...
      private function updateRoomCameras(param1:uint) : void
      {
         ...
         var _loc49_:* = null;
         var _loc2_:int = 0;
         for(; _loc2_ < var_292.length; _loc2_++)
         {
            _loc3_ = var_292.getWithIndex(_loc2_) as RoomInstanceData;
            _loc4_ = null;
            _loc5_ = 0;
            _loc6_ = 0;
            if(_loc3_ != null)
               ...
               if(_loc8_ != null)
               {
                  ...
                  if(_loc11_ != null)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc15_ != null)
                        {
                           _loc16_ = _loc15_.getNumber(RoomVariableEnum.const_677) - 0.5;
                           _loc17_ = _loc15_.getNumber(RoomVariableEnum.const_637) - 0.5;
                           _loc18_ = _loc15_.getNumber(RoomVariableEnum.const_666) + 0.5;
                           _loc19_ = _loc15_.getNumber(RoomVariableEnum.const_726) + 0.5;
      ...
      public function selectRoomObject(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         var_73.setSelectedObject(param1,param2,param3,param4);
      }
      ...
      public function modifyRoomObjectData(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_73 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_28)
            {
               return var_73.modifyWallItemData(var_119,var_120,param1,param3);
            }
         }
         return false;
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_391 != null)
         {
            var_391.release(new IIDRoomObjectVisualizationFactory());
            var_391 = null;
         }
         if(var_51 != null)
         {
            var_51.release(new IIDRoomManager());
            var_51 = null;
         }
         ...
         if(var_292 != null)
         {
            ...
            {
               _loc2_ = var_292.getWithIndex(_loc1_) as RoomInstanceData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         var _loc8_:IRoomInstance = var_51.getRoom(_loc7_);
         if(_loc8_ == null)
         {
            return null;
         }
         ...
         _loc9_.roomObjectVariableAccurateZ = RoomObjectVariableEnum.const_817;
         ...
         if(_loc10_.geometry != null)
         {
            ...
            _loc10_.geometry.z_scale = _loc8_.getNumber(RoomVariableEnum.const_705);
         }
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_522);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_727);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_834);
      ...
      {
         var _loc4_:IRoomInstance = var_51.getRoom(param1);
         if(_loc4_ == null)
         {
            return null;
         }
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_890) > 0)
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_828);
                  _loc10_ = _loc7_.getLocation();
                  if(param4)
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_370,_loc5_,_loc9_,_loc10_);
                  }
                  else
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_678,_loc5_);
                  }
               }
            }
         }
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_684,var_119,var_120,param2,param3));
            }
         }
      }
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_73 != null)
         {
            return var_73.modifyRoomObject(var_119,var_120,param1,param2,param3);
         }
         return false;
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         ...
         if(_loc6_ == null)
         {
            ...
            _loc9_ = var_291.getValue(_loc8_);
            if(_loc9_ == null)
            {
               _loc9_ = new RoomData(param1,param2,null);
               var_291.add(_loc8_,_loc9_);
            }
            if(param3 != null)
            {
         ...
         if(param3 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_496,param3);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param4 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_631,param4);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param5 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_612,param5);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         return true;
      }
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_51 = param2 as IRoomManager;
         if(var_51 != null)
         {
            var_51.addObjectUpdateCategory(RoomObjectCategoryEnum.const_30);
            var_51.addObjectUpdateCategory(RoomObjectCategoryEnum.const_28);
            var_51.addObjectUpdateCategory(RoomObjectCategoryEnum.const_35);
            var_51.addObjectUpdateCategory(RoomObjectCategoryEnum.const_260);
            var_51.addObjectUpdateCategory(RoomObjectCategoryEnum.const_58);
            var_51.setContentLoader(var_26);
         }
      ...
      private function roomObjectEventHandler(param1:RoomObjectEvent) : void
      {
         if(var_73 != null)
         {
            var_73.handleRoomObjectEvent(param1,var_119,var_120);
         }
      }
      ...
      public function addObjectFurniture(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Number = NaN, param10:int = -1) : Boolean
      {
         ...
         {
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_196,_loc12_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_311,param4,true);
            _loc14_.getModelController().setString(RoomObjectVariableEnum.const_296,_loc13_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_883,1,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_838,param10);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_996,getTimer());
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_261,param1,param2,param3,RoomObjectCategoryEnum.const_30));
         }
         return true;
      }
      ...
      {
         if(_roomObjectFactory == null || var_391 == null || var_51 == null || _roomRendererFactory == null || _communication == null || _habboConfiguration == null || !var_1803)
         {
            return;
         }
         var_51.initialize(<nothing/>,this);
      }
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_272,RoomObjectCategoryEnum.const_58);
      }
      ...
      public function addObjectFurnitureByName(param1:int, param2:int, param3:int, param4:String, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Number = NaN) : Boolean
      {
         ...
         if(isPublicRoomWorldType(_loc10_) && var_26 != null)
         {
            _loc12_ = var_26.getPublicRoomContentType(_loc10_) + "_";
      ...
      public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean) : Boolean
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1273,param3,param4,param5);
         _loc6_.getEventHandler().processUpdateMessage(_loc7_);
      ...
      public function update(param1:uint) : void
      {
         if(var_51 != null)
         {
            var_51.update(param1);
         }
         updateRoomCameras(param1);
         var _loc2_:IRoomInstance = var_51.getRoom(getRoomIdentifier(var_119,var_120));
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_750,RoomObjectCategoryEnum.const_260);
      }
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = getRoomCanvas(var_119,var_120,var_1181);
         if(_loc2_ != null)
         {
            _loc3_ = getOverlaySprite(_loc2_);
            _loc4_ = getOverlayIconSprite(_loc3_,const_271);
            if(_loc4_ != null)
            {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = getRoomCanvas(var_119,var_120,var_1181);
         if(_loc1_ != null)
         {
            _loc2_ = getOverlaySprite(_loc1_);
            removeOverlayIconSprite(_loc2_,const_271);
         }
      }
      ...
      private function onVisualizationFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_391 = param2 as IRoomObjectVisualizationFactory;
         if(var_26 != null)
         {
            var_26.visualizationFactory = var_391;
         }
         initializeRoomManager();
      }
      ...
      private function initializeObjectEvents() : void
      {
         if(_roomObjectFactory != null)
         {
            if(false)
            {
               ...
               _roomObjectFactory.events.addEventListener(RoomObjectMouseEvent.const_368,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectMouseEvent.const_477,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectStateChangeEvent.const_246,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectStateChangeEvent.const_618,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectWidgetRequestEvent.const_115,roomObjectEventHandler);
               ...
               _roomObjectFactory.events.addEventListener(RoomObjectWidgetRequestEvent.const_119,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectWidgetRequestEvent.const_124,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectWidgetRequestEvent.const_87,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectFurnitureActionEvent.const_382,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectFurnitureActionEvent.const_354,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectFurnitureActionEvent.const_428,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectFurnitureActionEvent.const_350,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectFurnitureActionEvent.const_443,roomObjectEventHandler);
               ...
               _roomObjectFactory.events.addEventListener(RoomObjectFurnitureActionEvent.const_361,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectFurnitureActionEvent.const_393,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectFurnitureActionEvent.const_437,roomObjectEventHandler);
               ...
               _roomObjectFactory.events.addEventListener(RoomObjectMoveEvent.const_476,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectMoveEvent.const_366,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectRoomAdEvent.const_244,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectRoomAdEvent.const_418,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectRoomAdEvent.const_285,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectRoomAdEvent.const_300,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectRoomActionEvent.const_432,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectRoomActionEvent.const_985,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectRoomActionEvent.const_427,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(AvatarWalkWarpingWarningEvent.const_447,warningEventHandler);
            }
         }
      }
      ...
      public function getRoomObjectCategory(param1:String) : int
      {
         ...
         return RoomObjectCategoryEnum.const_194;
      }
      ...
      public function initializeRoomObjectInsert(param1:int, param2:int, param3:int, param4:String = null) : Boolean
      {
         ...
         if(_loc5_ == null || _loc5_.getNumber(RoomVariableEnum.const_658) != 0)
         {
            return false;
         }
         if(var_73 != null)
         {
            return var_73.initializeRoomObjectInsert(var_119,var_120,param1,param2,param3,param4);
         }
         return false;
      }
      ...
      public function roomManagerInitialized(param1:Boolean = true) : void
      {
         ...
         if(param1)
         {
            ...
            {
               _loc3_ = var_291.getWithIndex(_loc2_) as RoomData;
               if(_loc3_ != null)
               {
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_261,param1,param2,param3,RoomObjectCategoryEnum.const_35));
         }
         return true;
      }
      ...
      {
         return var_51.isContentAvailable(param1);
      }
      ...
      {
         if(var_26.insertObjectContent(param1,param2,param3))
         {
            return true;
         }
         return false;
      ...
      public function getRoomObjectImage(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:int, param7:IGetImageListener, param8:uint = 0) : ImageResult
      {
         ...
         var _loc13_:IRoomInstance = var_51.getRoom(_loc12_);
         if(_loc13_ != null)
         {
            ...
            if(_loc14_ != null && _loc14_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_28:
                     _loc10_ = String(_loc14_.getModel().getNumber(RoomObjectVariableEnum.const_196));
                     _loc11_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_391);
                     break;
                  case RoomObjectCategoryEnum.const_35:
                     _loc10_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_172);
               }
            }
         }
      ...
      public function updateObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:IVector3d = null, param7:Number = NaN) : Boolean
      {
         ...
         if(isNaN(param7))
         {
            param7 = _loc8_.getModel().getNumber(RoomObjectVariableEnum.const_309);
         }
      ...
      public function addObjectWallItem(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String) : Boolean
      {
         ...
         {
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_196,_loc10_,false);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_311,param4,true);
            _loc12_.getModelController().setString(RoomObjectVariableEnum.const_296,_loc11_,true);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_817,1,true);
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_261,param1,param2,param3,RoomObjectCategoryEnum.const_28));
         }
         return true;
      }
      ...
      {
         var _loc5_:IRoomInstance = var_51.getRoom(param1);
         if(_loc5_ == null)
         {
            return null;
         }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_489.events.addEventListener(AdEvent.const_416,showRoomAd);
      }
      ...
      private function getOverlaySprite(param1:IRoomRenderingCanvas) : Sprite
      {
         ...
         return _loc2_.getChildByName(const_748) as Sprite;
      }
      ...
      public function selectAvatar(param1:int, param2:int, param3:int, param4:Boolean) : void
      {
         if(var_73 != null)
         {
            var_73.setSelectedAvatar(param1,param2,param3,param4);
         }
      }
      ...
      public function getFurnitureImage(param1:int, param2:IVector3d, param3:int, param4:IGetImageListener, param5:String = null, param6:uint = 0) : ImageResult
      {
         ...
         if(var_26 != null)
         {
            _loc7_ = var_26.getActiveObjectType(param1);
            _loc8_ = String(var_26.getActiveObjectColorIndex(param1));
         }
      ...
      public function getSelectedAvatarId() : int
      {
         if(var_73 != null)
         {
            return var_73.getSelectedAvatarId();
         }
         return -1;
      }
      ...
      {
         var _loc3_:String = getRoomIdentifier(param1,param2);
         var_51.disposeRoom(_loc3_);
         var _loc4_:RoomInstanceData = var_292.remove(_loc3_);
         if(_loc4_ != null)
         {
            _loc4_.dispose();
         }
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_561,param1,param2));
      }
      ...
      public function getRoomObjectWithIndex(param1:int, param2:int, param3:int, param4:int) : IRoomObject
      {
         ...
         var _loc6_:IRoomInstance = var_51.getRoom(_loc5_);
         if(_loc6_ == null)
         {
            return null;
         }
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:String = null, param7:uint = 0, param8:String = null) : ImageResult
      {
         ...
         _loc9_.id = -1;
         if(!var_455 || param1 == null)
         {
            return _loc9_;
         }
         var _loc10_:IRoomInstance = var_51.getRoom(const_484);
         if(_loc10_ == null)
         {
            _loc10_ = var_51.createRoom(const_484,null);
            if(_loc10_ == null)
            {
               return _loc9_;
            }
         }
         var _loc11_:int = var_547.reserveNumber();
         ...
         switch(_loc12_)
         {
            case RoomObjectCategoryEnum.const_30:
            case RoomObjectCategoryEnum.const_28:
               _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_196,int(param2));
               _loc13_.getModelController().setString(RoomObjectVariableEnum.const_391,param8);
               break;
            case RoomObjectCategoryEnum.const_35:
               _loc13_.getModelController().setString(RoomObjectVariableEnum.const_172,param2);
               break;
            case RoomObjectCategoryEnum.const_58:
               if(param2 != null)
               {
                  ...
                  if(_loc17_.length >= 3)
                  {
                     ...
                     _loc21_.addPlane(RoomPlaneData.const_144,new Vector3d(0,0,0),new Vector3d(0,10,0),new Vector3d(0,0,10));
                     _loc21_.addPlane(RoomPlaneData.const_144,new Vector3d(10,0,0),new Vector3d(-10,0,0),new Vector3d(0,0,10));
                     _loc21_.addPlane(RoomPlaneData.const_228,new Vector3d(10,0,0),new Vector3d(-10,0,0),new Vector3d(0,0,10));
                     _loc22_ = _loc21_.getXML();
                     _loc13_.getEventHandler().initialize(_loc22_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_597,_loc18_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_556,_loc19_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_695,_loc20_);
                     if(param6 != null)
                     {
                        _loc23_ = null;
                        _loc24_ = "undefined_" + _loc11_;
                        _loc23_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_370,_loc24_,param6,new Vector3d(2,0,1.75));
         ...
         {
            var_973.add(String(_loc11_),param5);
            _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_927,param4,true);
         }
         else
         {
            _loc10_.disposeObject(_loc11_,_loc12_);
            var_547.freeNumber(_loc11_ - 1);
            _loc9_.id = 0;
         }
         _loc15_.dispose();
         return _loc9_;
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_749,RoomObjectCategoryEnum.const_260);
      }
      ...
      public function handleRoomCanvasMouseEvent(param1:int, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean) : void
      {
         ...
         if(_loc9_ != null)
         {
            ...
            _loc11_ = getOverlayIconSprite(_loc10_,const_271);
            if(_loc11_ != null)
            {
               _loc12_ = _loc11_.getRect(_loc11_);
               _loc11_.x = var_1422 - _loc12_.width / 2;
               _loc11_.y = var_1421 - _loc12_.height / 2;
            }
            if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
            {
               ...
               if(param4 == MouseEvent.CLICK)
               {
                  if(events != null)
                  {
                     events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_352,var_119,var_120,-1,RoomObjectCategoryEnum.const_194));
                  }
                  _loc13_ = "null";
               }
               ...
               if(var_73 != null)
               {
                  _loc14_ = new RoomObjectMouseEvent(_loc13_,const_272,const_483);
                  var_73.handleRoomObjectEvent(_loc14_,var_119,var_120);
               }
            }
         }
      }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         var _loc7_:IRoomRenderingCanvas = getRoomCanvas(var_119,var_120,var_1181);
         if(_loc7_ != null)
         {
            _loc10_ = getOverlaySprite(_loc7_);
            removeOverlayIconSprite(_loc10_,const_271);
            _loc11_ = addOverlayIconSprite(_loc10_,const_271,_loc6_.data);
            if(_loc11_ != null)
            {
               _loc11_.x = var_1422 - _loc6_.data.width / 2;
               _loc11_.y = var_1421 - _loc6_.data.height / 2;
            }
         }
      }
      
      public function removeContentLibrary(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         return var_26.removeObjectContent(param1,param2,param3);
      }
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(var_26 != null)
         {
            ...
            var_26.addGraphicAsset(var_26.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_324,param1.image,true);
            var_26.addGraphicAsset(var_26.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_867,param1.adWarningL,true);
            var_26.addGraphicAsset(var_26.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_982,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_877,RoomObjectVariableEnum.const_324,param1.clickUrl);
      ...
      {
         var _loc3_:String = getRoomIdentifier(param1,param2);
         var _loc4_:RoomInstanceData = var_292.getValue(_loc3_) as RoomInstanceData;
         if(_loc4_ == null)
         {
            _loc4_ = new RoomInstanceData(param1,param2);
            var_292.add(_loc3_,_loc4_);
         }
         return _loc4_;
      }
      ...
      private function onHabboConfigurationInit(param1:Event) : void
      {
         if(var_26 != null)
         {
            _events.addEventListener(RoomContentLoader.const_676,onContentLoaderReady);
      ...
      public function cancelRoomObjectInsert() : void
      {
         if(var_73 != null)
         {
            var_73.cancelRoomObjectInsert(var_119,var_120);
         }
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = var_51.getRoom(const_484);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_927);
               ...
               var_547.freeNumber(_loc10_ - 1);
               _loc13_ = var_973.remove(String(_loc10_)) as IGetImageListener;
      ...
      {
         return getRoomObjectBoundingRectangle(var_119,var_120,const_272,RoomObjectCategoryEnum.const_58,param1);
      }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         var _loc7_:IRoomInstance = var_51.createRoom(param1,param2);
         if(_loc7_ == null)
         {
            return null;
         }
         var _loc8_:int = _loc8_ = RoomObjectCategoryEnum.const_58;
         var _loc9_:* = null;
         var _loc10_:* = 1;
         if(isPublicRoomWorldType(param6))
         {
            ...
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_789,param6,true);
            _loc7_.setNumber(RoomVariableEnum.const_658,1,true);
            _loc13_ = parseInt(_habboConfiguration.getKey("ads.billboard.displayDelayMillis","1000"));
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_859,_loc13_,true);
            if(var_26 != null)
            {
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_272,const_483,_loc8_) as IRoomObjectController;
            _loc7_.setNumber(RoomVariableEnum.const_658,0,true);
         }
         _loc7_.setNumber(RoomVariableEnum.const_705,_loc10_,true);
         if(param2 != null)
         {
            _loc14_ = 0;
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_677,_loc16_);
               _loc7_.setNumber(RoomVariableEnum.const_666,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.const_637,_loc18_);
               _loc7_.setNumber(RoomVariableEnum.const_726,_loc19_);
               _loc14_ += _loc16_ * 423 + _loc17_ * 671 + _loc18_ * 913 + _loc19_ * 7509;
               if(_loc9_ != null && _loc9_.getModelController() != null)
               {
                  _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_864,_loc14_,true);
               }
            }
         }
         if(_loc9_ != null && _loc9_.getEventHandler() != null)
         ...
         if(param3 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_496,param3);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param4 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_631,param4);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param5 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_612,param5);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param2 != null)
         {
            if(param2.doors.door.length() > 0)
            {
               ...
               while(_loc23_ < _loc20_.length())
               {
                  ...
                  if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                  {
                     ...
                     _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_370,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_214);
                     _loc9_.getEventHandler().processUpdateMessage(_loc22_);
                     if(_loc28_ == 90 || _loc28_ == 180)
                     {
                        if(_loc28_ == 90)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_522,_loc25_ - 0.5,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_727,_loc26_,true);
                        }
                        if(_loc28_ == 180)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_522,_loc25_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_727,_loc26_ - 0.5,true);
                        }
                        _loc7_.setNumber(RoomObjectVariableEnum.const_834,_loc27_,true);
         ...
         _loc7_.createRoomObject(const_749,const_1051,RoomObjectCategoryEnum.const_260);
         _loc7_.createRoomObject(const_750,OBJECT_TYPE_SELECTION_ARROW,RoomObjectCategoryEnum.const_260);
         return _loc7_;
      }
