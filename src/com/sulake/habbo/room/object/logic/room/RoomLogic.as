package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1433:int = 255;
      
      private var var_1434:int = 255;
      
      private var var_1192:uint = 16777215;
      
      private var var_976:uint = 16777215;
      
      protected var var_85:RoomPlaneParser = null;
      
      private var var_803:int = 0;
      
      private var var_1229:int = 255;
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomUpdateMessage.const_496:
                  _loc2_.setString(RoomObjectVariableEnum.const_597,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_631:
                  _loc2_.setString(RoomObjectVariableEnum.const_556,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_612:
                  _loc2_.setString(RoomObjectVariableEnum.const_695,_loc3_.value);
            }
            return;
         }
         ...
         if(_loc4_ != null)
         {
            ...
            switch(_loc4_.type)
            {
               case RoomObjectRoomMaskUpdateMessage.const_370:
                  _loc8_ = "null";
                  if(_loc4_.maskCategory == RoomObjectRoomMaskUpdateMessage.const_214)
                  {
                     _loc8_ = "null";
                  }
                  var_380.addMask(_loc4_.maskId,_loc4_.maskType,_loc4_.maskLocation,_loc8_);
                  _loc7_ = true;
                  break;
               case RoomObjectRoomMaskUpdateMessage.const_678:
                  _loc7_ = var_380.removeMask(_loc4_.maskId);
            }
            if(_loc7_)
            {
               _loc9_ = var_380.getXML();
               _loc10_ = _loc9_.toXMLString();
               _loc2_.setString(RoomObjectVariableEnum.const_833,_loc10_);
            }
            return;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_995,int(_loc5_.bgOnly));
            var_1192 = _color;
            var_1433 = var_1229;
            var_976 = _loc11_;
            var_1434 = _loc12_;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_621,16777215);
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1169,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1276,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1347,_loc22_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc13_ == RoomPlaneData.const_144 || _loc13_ == RoomPlaneData.const_228)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(var_803)
         {
            ...
            {
               _loc7_ = var_1192 >> 16 & 255;
               _loc8_ = var_1192 >> 8 & 255;
               _loc9_ = var_1192 & 255;
               _loc10_ = var_976 >> 16 & 255;
               _loc11_ = var_976 >> 8 & 255;
               _loc12_ = var_976 & 255;
               _loc13_ = (_loc2_ - var_803) / var_1432;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = var_1433 + (var_1434 - var_1433) * _loc13_;
               _color = _loc3_;
               var_1229 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_621,_loc3_);
         }
      }
   }
}
