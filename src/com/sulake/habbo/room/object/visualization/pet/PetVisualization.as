package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class PetVisualization extends RoomObjectSpriteVisualization
   {
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         var _loc10_:* = 0;
         var _loc12_:Number = _loc4_.getNumber(RoomObjectVariableEnum.const_958);
         if(_loc12_ > 0)
         {
            _loc17_ = getTimer() - _loc12_;
            if(_loc17_ < AvatarAction.const_790)
            {
               _loc10_ = uint(int(Math.sin(Number(_loc17_) / 0 * 0) * 255));
               _loc11_ = _loc4_.getNumber(RoomObjectVariableEnum.const_781);
               var_437 = const_1017;
            }
         }
         var _loc13_:Boolean = false;
         var _loc14_:String = _loc4_.getString(RoomObjectVariableEnum.const_266);
         switch(_loc14_)
         {
         ...
         var _loc15_:Boolean = var_285 != _loc3_.getUpdateID() || var_212 != param1.scale || var_166 != _loc4_.getUpdateID();
         var _loc16_:Boolean = _isAnimating || var_437 > 0 || _loc13_;
         if(_loc15_ || _loc16_)
         {
            _loc18_ = getTimer();
            --var_437;
            if(var_532 != _loc7_)
            {
               for each(_loc36_ in var_422.getKeys())
               {
                  var_422.remove(_loc36_);
               }
               _loc6_ = null;
            }
            if(_loc6_ == null)
            ...
            _loc20_ = _loc4_.getNumber(RoomObjectVariableEnum.const_309);
            if(isNaN(_loc20_))
            {
               _loc20_ = _loc19_;
            }
            ...
            _loc21_ = _loc4_.getString(RoomObjectVariableEnum.const_266);
            _loc22_ = _loc4_.getString(RoomObjectVariableEnum.const_498);
            _loc6_.appendAction(AvatarAction.const_723,_loc21_,_loc22_);
            _loc23_ = false;
            if(_loc21_ == "lay")
            {
            ...
            _loc24_ = _loc4_.getString(RoomObjectVariableEnum.const_380);
            if(_loc24_ != null && _loc24_ != "")
            {
               ...
               {
                  _loc6_.appendAction(AvatarAction.const_307,_loc24_);
               }
            }
            _loc25_ = _loc4_.getNumber(RoomObjectVariableEnum.const_472) > 0;
            if(_loc25_)
            {
            ...
            _loc30_ = _loc6_.getSprites().length + const_1018;
            ...
            _loc31_ = getSprite(const_1382);
            if(_loc31_ != null)
            {
               _loc31_.asset = _loc29_;
            ...
            _loc31_ = getSprite(const_1589);
            if(_loc10_ > 0)
            {
               _loc29_ = null;
               _loc29_ = var_738.getAvatarRendererAsset("pet_experience_bubble_png") as BitmapDataAsset;
               if(_loc29_ != null)
               {
            ...
            var_737.push(getTimer() - _loc18_);
            if(false)
            {
               _loc56_ = 0;
               _loc57_ = "[";
               for each(_loc58_ in var_737)
               {
                  _loc56_ += _loc58_;
                  _loc57_ += "," + _loc58_;
               }
      ...
      {
         var_738 = param1 as PetVisualizationData;
         createSprites(4);
         return true;
      }
