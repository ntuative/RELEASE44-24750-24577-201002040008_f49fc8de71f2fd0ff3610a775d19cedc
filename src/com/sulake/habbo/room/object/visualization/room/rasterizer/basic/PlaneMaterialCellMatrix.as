package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_1356:int = const_282;
      
      public static const const_207:int = 2;
      
      public static const const_209:int = 3;
      ...
      public static const const_250:int = const_98;
      ...
      public function PlaneMaterialCellMatrix(param1:int, param2:int = 1, param3:int = 1, param4:Number = -1, param5:Number = 1, param6:Number = -1, param7:Number = 1)
      {
         ...
         var_2012 = param6;
         var_2010 = param7;
         var_835 = new Vector3d();
         if(var_1489 == const_581)
         {
            var_1252 = false;
         }
      }
      ...
      {
         if(param1 == null || var_40 == null || param1 == var_40)
         {
            return;
         }
         if(!param4)
         ...
         var _loc5_:* = null;
         if(var_1490 == const_98)
         {
            _loc5_ = new Rectangle(0,0,var_40.width,var_493);
         }
         else
         {
            _loc5_ = new Rectangle(0,0 - var_493,var_40.width,var_493);
         }
         param1.copyPixels(var_40,_loc5_,new Point(0,param3),null,null,true);
      }
      ...
      public function render(param1:BitmapData, param2:int, param3:int, param4:IVector3d, param5:Boolean, param6:int, param7:Boolean) : BitmapData
      {
         ...
         if(isStatic)
         {
            if(var_40 != null)
            {
               if(var_40.width == param2 && var_40.height == param3 && Vector3d.isEqual(var_835,param4))
               {
                  if(param1 != null)
                  {
                     copyCachedBitmapOnCanvas(param1,var_493,param6,param7);
                     return param1;
                  }
                  return var_40;
               }
         ...
         {
            if(var_40.width == param2 && var_40.height == param3)
            {
               var_40.fillRect(var_40.rect,16777215);
            }
            else
            {
               var_40.dispose();
         ...
         var_835.assign(param4);
         if(!param5)
         {
            var_493 = param3;
            if(var_40 == null)
            {
               var_40 = new BitmapData(param2,param3,true,4294967295);
            }
            else
            {
               var_40.fillRect(var_40.rect,4294967295);
            }
            if(param1 != null)
            {
         ...
         {
            var_493 = param3;
            var_40 = new BitmapData(param2,param3,true,16777215);
         }
         var _loc8_:* = [];
         var _loc9_:int = 0;
         ...
         {
            case const_198:
               _loc10_ = renderRepeatBorders(var_40,_loc8_);
               break;
            case const_209:
               _loc10_ = renderRepeatCenter(var_40,_loc8_);
               break;
            case const_223:
               _loc10_ = renderRepeatFirst(var_40,_loc8_);
               break;
            case const_206:
               _loc10_ = renderRepeatLast(var_40,_loc8_);
               break;
            case const_581:
               _loc10_ = renderRepeatRandom(var_40,_loc8_);
               break;
            default:
               _loc10_ = renderRepeatAll(var_40,_loc8_);
         }
         var_493 = _loc10_;
         if(param1 != null)
         {
