         ...
         if(var_465 != null)
         {
            ...
            if(_loc2_ != null)
            {
               if(!isStatic)
               {
                  if(var_40 != null)
                  {
                     if(var_40.width != _loc2_.width || var_40.height != _loc2_.height)
                     {
                        var_40.dispose();
                        var_40 = null;
                     }
                     ...
                     {
                        var_40.copyPixels(_loc2_,_loc2_.rect,new Point(0,0));
                     }
                  }
                  if(var_40 == null)
                  {
                  ...
                  _loc3_ = Math.min(var_986,_extraItemOffsets.length);
                  _loc4_ = Math.max(var_986,_extraItemOffsets.length);
                  _loc5_ = Randomizer.getArray(var_986,_loc4_);
                  _loc6_ = 0;
                  while(_loc6_ < _loc3_)
                  {
                     _loc7_ = _extraItemOffsets[_loc5_[_loc6_]] as Point;
                     _loc8_ = var_661[_loc6_ % 0] as IGraphicAsset;
