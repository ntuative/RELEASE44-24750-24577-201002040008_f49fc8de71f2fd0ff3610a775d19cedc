package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class Plane
   {
      ...
      protected function getPlaneVisualization(param1:int) : PlaneVisualization
      {
         ...
         {
            var_655 = var_396.getValue(String(_sizes[_loc2_])) as PlaneVisualization;
         }
         else
         {
            var_655 = null;
      ...
      public function dispose() : void
      {
         ...
         if(var_396 != null)
         {
            _loc1_ = null;
            _loc2_ = 0;
            while(_loc2_ < var_396.length)
            {
               _loc1_ = var_396.getWithIndex(_loc2_) as PlaneVisualization;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
