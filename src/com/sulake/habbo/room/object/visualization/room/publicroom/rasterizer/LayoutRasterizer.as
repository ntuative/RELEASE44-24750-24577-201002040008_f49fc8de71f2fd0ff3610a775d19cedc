package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_1050:Point = null;
      
      private var var_508:Array;
      
      private var var_1049:LayoutRasterizerData = null;
      ...
      private var var_2196:Vector3d;
      
      private var var_72:Map = null;
      ...
      {
         var_507 = true;
         var _loc3_:int = var_356.indexOf(param1);
         if(_loc3_ < 0)
         {
            var_356.push(param1);
            var_506.push(param2);
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc11_:* = null;
         var_1051 = param1;
         var _loc3_:LayoutRasterizerData = var_72.getValue(var_716);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              var_1301 = RoomObjectVariableEnum.const_867;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              var_1301 = RoomObjectVariableEnum.const_982;
                           }
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(var_1051 + _adBgIndex);
                              if(_loc5_ != null)
                              {
                        ...
                        if(_loc10_ == "billboard_img")
                        {
                           ...
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(var_1051 + _adImgIndex);
                              if(_loc5_ != null)
                              {
                                 _loc5_.visible = false;
                                 _loc5_.alpha = 0;
      ...
      public function showAd(param1:IRoomObjectSpriteVisualization, param2:String = "", param3:Boolean = false) : void
      {
         ...
         if(param1 != null)
         {
            _loc4_ = param1.getSprite(var_1051 + _adBgIndex);
            _loc5_ = param1.getSprite(var_1051 + _adImgIndex);
         }
         ...
         {
            exchangeElementGraphics("billboard_img",var_1301);
         }
         ...
         if(param3)
         {
            ...
            _loc5_.tag = RoomObjectVariableEnum.const_374;
         }
         if(param2 != "")
         {
            _loc4_.visible = true;
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         var _loc3_:Point = param1.getScreenPoint(var_2196);
         _loc3_.x -= _loc2_.x;
         _loc3_.y -= _loc2_.y;
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_72.length)
            {
               _loc2_ = var_72.getWithIndex(_loc1_) as LayoutRasterizerData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function set layout(param1:String) : void
      {
         if(param1 != var_716)
         {
            ...
            _adBgIndex = -1;
            _adImgIndex = -1;
            var_1049 = var_72.getValue(var_716);
         }
      }
      ...
      {
         var _loc1_:LayoutRasterizerData = var_72.getValue(var_716);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         var _loc5_:XMLList = var_1049.elementList;
         if(_loc5_ == null)
         {
            return;
         }
         ...
         param2.offsetX = int(_loc8_.@x) + _loc9_.offsetX + var_1050.x;
         param2.offsetY = int(_loc8_.@y) + _loc9_.offsetY + var_1050.y;
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(var_356.indexOf(_loc10_) >= 0 && var_507)
            {
               param1 = var_356.indexOf(_loc10_);
               if(true)
               {
                  _loc9_ = _assetCollection.getAsset(var_506[param1]);
                  if(_loc9_ != null)
                  {
                     param2.asset = _loc9_.asset;
                  }
               ...
               if(true)
               {
                  param2.alpha = var_508[param1];
               }
               var_356.splice(param1,1);
               var_506.splice(param1,1);
               var_508.splice(param1,1);
               if(false)
               {
                  var_507 = false;
               }
