package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_1567:int = 16777216;
      
      public static const const_1439:int = 1;
       
      
      private var var_2316:int = 69069;
      
      private var var_1203:int = 1;
      
      private var var_2317:int = 5;
      
      private var var_1455:int = 16777216;
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / var_1455 * param2);
      }
      ...
      {
         var _loc1_:int = var_2316 * var_1203 + var_2317;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
