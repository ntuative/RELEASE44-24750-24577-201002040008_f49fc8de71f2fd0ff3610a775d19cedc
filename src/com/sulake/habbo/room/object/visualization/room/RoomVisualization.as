package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private static const const_1041:int = 16777215;
      
      public static const const_1220:int = 10066329;
      
      private static const const_1040:int = 13421772;
      
      public static const const_1351:int = 16777215;
      
      private static const const_1397:int = 0;
      
      public static const const_1268:int = 16777215;
      
      private static const const_1043:int = 10066329;
      
      private static const const_1042:int = 10066329;
      ...
      private var var_1755:int = -1000;
      
      private var var_955:uint = 16777215;
      
      private var var_1753:Boolean = true;
      ...
      private var var_543:Rectangle = null;
      
      private var var_1758:int = 255;
      
      private var var_1759:Boolean = false;
      
      private var var_1757:int = 255;
      
      private var var_1754:String = null;
      
      private const const_1597:int = 250;
      ...
      private var var_380:RoomPlaneBitmapMaskParser = null;
      ...
      public function RoomVisualization()
      {
         ...
         var_380 = new RoomPlaneBitmapMaskParser();
      ...
      private function getLandscapeHeight() : Number
      {
         ...
         while(_loc2_ < var_85.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_228)
            {
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_864);
         var _loc7_:int = 0;
         while(_loc7_ < var_85.planeCount)
         {
            ...
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_259,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
                  _loc13_.hasTexture = false;
               }
            ...
            else if(_loc12_ == RoomPlaneData.const_228)
            {
      ...
      override public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_112.length)
            {
               _loc2_ = var_112[_loc1_] as RoomPlane;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      protected function defineSprites() : void
      {
         ...
         while(_loc2_ < _loc1_)
         {
            ...
            {
               if(_loc3_.type == RoomPlane.const_259 && (_loc3_.leftSide.length < 1 || _loc3_.rightSide.length < 1))
               {
      ...
      override public function get boundingRectangle() : Rectangle
      {
         if(var_543 == null)
         {
            var_543 = super.boundingRectangle;
         }
         return new Rectangle(var_543.x,var_543.y,var_543.width,var_543.height);
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         var_380.initialize(_loc2_);
         var _loc3_:* = null;
         var _loc4_:int = 0;
         while(_loc4_ < var_112.length)
         {
            _loc3_ = var_112[_loc4_] as RoomPlane;
            if(_loc3_ != null)
            {
         ...
         var _loc5_:int = 0;
         while(_loc5_ < var_380.maskCount)
         {
            _loc6_ = var_380.getMaskType(_loc5_);
            _loc7_ = var_380.getMaskLocation(_loc5_);
            _loc8_ = var_380.getMaskCategory(_loc5_);
            if(_loc7_ != null)
            {
               _loc9_ = 0;
               while(_loc9_ < var_112.length)
               {
                  _loc3_ = var_112[_loc9_] as RoomPlane;
                  if(_loc3_.type == RoomPlane.const_259 || _loc3_.type == RoomPlane.const_182 && _loc8_ == RoomPlaneBitmapMaskData.const_214)
                  {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc13_.visible)
                  {
                     if(_loc11_)
                     {
                        ...
                        _loc13_.asset = _loc10_;
                        _loc13_.assetName = _loc14_ + "_" + var_1408;
                        if(var_85.getPlaneType(_loc9_) == RoomPlaneData.const_143)
                        {
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         if(param1.updateId != var_1122)
         {
            ...
            if(_loc9_ != null && (_loc9_.x != var_933 || _loc9_.y != var_1674 || _loc9_.z != var_1672 || param1.scale != var_1673))
            {
               var_933 = _loc9_.x;
               var_1674 = _loc9_.y;
               var_1672 = _loc9_.z;
         ...
         {
            _loc10_ = _loc6_.getString(RoomObjectVariableEnum.const_833);
            if(_loc10_ != var_1754)
            {
            ...
            _loc11_ = uint(_loc6_.getNumber(RoomObjectVariableEnum.const_621));
            if(_loc11_ != var_955)
            {
               var_955 = _loc11_;
               var_1757 = var_955 & 255;
               var_1758 = var_955 >> 8 & 255;
               var_1756 = var_955 >> 16 & 255;
               _loc5_ = true;
            }
         }
         var _loc7_:int = param2;
         if(_loc7_ < var_1755 + const_1597 && !_loc4_ && !_loc5_)
         {
            return;
         }
         var_1755 = _loc7_;
         if(var_166 != _loc6_.getUpdateID())
         {
            _loc12_ = _loc6_.getString(RoomObjectVariableEnum.const_556);
            _loc13_ = _loc6_.getString(RoomObjectVariableEnum.const_597);
            _loc14_ = _loc6_.getString(RoomObjectVariableEnum.const_695);
            updatePlaneTextureTypes(_loc13_,_loc12_,_loc14_);
            var_1753 = Boolean(_loc6_.getNumber(RoomObjectVariableEnum.const_995));
            var_166 = _loc6_.getUpdateID();
         }
         updatePlanes(param1,_loc4_,param2);
         var _loc8_:int = 0;
         while(_loc8_ < var_381.length)
         {
            _loc15_ = 0;
            _loc16_ = getSprite(_loc15_);
            _loc17_ = var_381[_loc8_] as RoomPlane;
            if(_loc16_ != null && _loc17_ != null && _loc17_.type != RoomPlane.const_182)
            {
               if(var_1753)
               {
                  _loc18_ = uint(_loc17_.color);
                  _loc19_ = uint((_loc18_ & 255) * var_1757 / 255);
                  _loc20_ = uint((_loc18_ >> 8 & 255) * var_1758 / 255);
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         while(_loc4_ < var_112.length)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               else if(_loc5_.type == RoomPlane.const_259 && param2 != null)
               {
                  _loc5_.id = param2;
               }
