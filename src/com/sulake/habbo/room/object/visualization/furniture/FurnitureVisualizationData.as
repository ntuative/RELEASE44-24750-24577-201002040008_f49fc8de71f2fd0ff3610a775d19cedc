package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualizationData implements IRoomObjectVisualizationData
   {
      ...
      private var var_512:SizeData = null;
      ...
      protected function getSizeData(param1:int) : SizeData
      {
         ...
         {
            var_512 = var_283.getValue(String(_sizes[_loc2_])) as SizeData;
         }
         else
         {
            var_512 = null;
      ...
      public function dispose() : void
      {
         ...
         if(var_283 != null)
         {
            _loc1_ = null;
            _loc2_ = 0;
            while(_loc2_ < var_283.length)
            {
               _loc1_ = var_283.getWithIndex(_loc2_) as SizeData;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      protected function defineVisualizations(param1:XML) : Boolean
      {
         ...
         while(_loc4_ < _loc2_.length())
         {
            ...
            if(var_283.getValue(String(_loc6_)) != null)
            {
               return false;
            }
            ...
            var_283.add(String(_loc6_),_loc9_);
            _sizes.push(_loc6_);
