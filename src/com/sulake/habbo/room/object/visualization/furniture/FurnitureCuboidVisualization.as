   ...
   public class FurnitureCuboidVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:int) : void
      {
         ...
         while(_loc5_ < var_112.length)
         {
            ...
            _loc9_ = var_112[_loc5_] as FurniturePlane;
            if(_loc9_ != null)
            {
            ...
            if(_loc10_ != null)
            {
               ...
               _loc10_.asset = _loc8_;
               if(_loc6_)
               {
                  _loc10_.assetName = _loc7_ + "_" + _loc3_.getInstanceId() + "_" + var_1408;
               }
      ...
      override public function dispose() : void
      {
         ...
         if(var_112 != null)
         {
            ...
            {
               _loc2_ = var_112[_loc1_] as FurniturePlane;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      protected function initializePlanes() : void
      {
         ...
         var _loc4_:Number = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_376);
         var _loc5_:Number = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_592);
