package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private function getNewPoint(param1:int, param2:Number) : Point
      {
         ...
         var_959[param1] = _loc3_;
         if(int(_loc9_) == 0)
         {
            var_957[param1] = getRandomAmplitudeFactor();
         }
      ...
      private function initItems(param1:Number) : void
      {
         ...
         var_959 = new Array();
         var_959.push(Math.random() * _loc2_ * 1.5);
         var_959.push(Math.random() * _loc2_ * 1.5);
         var_956 = new Array();
         var_956.push(1);
         var_956.push(-1);
         var_958 = new Array();
         var_958.push(const_1044);
         var_958.push(const_1045);
         var_957 = new Array();
         var_957.push(getRandomAmplitudeFactor());
         var_957.push(getRandomAmplitudeFactor());
      }
