package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualizationPlanetObject
   {
      ...
      private static const const_1039:Number = 30;
      ...
      private var var_639:Vector3d;
      
      private var var_1173:Number;
      ...
      {
         var_639 = new Vector3d(0,0,0);
         _children = new Array();
         super();
         _name = param1;
         _index = param2;
         var_1173 = param3;
         var_1750 = param4 * 0 * 2 / 360;
         var_1406 = param5 * 0 * 2 / 360;
         _height = param6;
         var_787 = 0;
      }
      ...
      {
         var _loc3_:Number = var_1173 * Math.cos(var_787 + var_1406);
         var _loc4_:Number = var_1173 * Math.sin(var_787 + var_1406);
         var _loc5_:Number = _height;
         var_639.x = (_loc3_ - _loc4_) * (param2 / 2);
         var_639.y = (_loc4_ + _loc3_) * (param2 / 2) * 0.5 - _height * (param2 / 2);
         var_639.z = -int(4 * (_loc3_ + _loc4_) - 0.7);
         if(param1 != null)
         {
            var_639.add(param1);
         }
