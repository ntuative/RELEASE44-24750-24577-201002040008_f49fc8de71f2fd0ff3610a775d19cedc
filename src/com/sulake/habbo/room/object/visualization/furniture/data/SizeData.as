package com.sulake.habbo.room.object.visualization.furniture.data
{
   ...
   public class SizeData
   {
      ...
      public static const const_280:int = 1000;
      ...
      private var var_1271:int = 360;
      
      private var var_2075:int = 0;
      
      private var var_700:DirectionData = null;
      ...
      public function getDirectionValue(param1:int) : int
      {
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc2_:int = (param1 % 360 + 360 + var_1271 / 2) % 360 / var_1271;
         if(var_232.getValue(String(_loc2_)) != null)
         {
            return _loc2_;
         }
         ...
         var _loc4_:int = -1;
         var _loc5_:int = 0;
         while(_loc5_ < var_232.length)
         {
            _loc6_ = int(var_232.getKey(_loc5_)) * var_1271;
         ...
         if(_loc4_ >= 0)
         {
            return int(var_232.getKey(_loc4_));
         }
         return const_1217;
      }
      ...
      private function defineDirection(param1:DirectionData, param2:XMLList) : Boolean
      {
         ...
         },_loc5_++)
         {
            ...
            {
               case "ADD":
                  param1.setInk(_loc7_,LayerData.const_825);
                  break;
               case "SUBTRACT":
      ...
      private function getDirectionData(param1:int) : DirectionData
      {
         ...
         var _loc2_:* = null;
         _loc2_ = var_232.getValue(String(param1)) as DirectionData;
         if(_loc2_ == null)
         {
      ...
      public function dispose() : void
      {
         ...
         if(var_232 != null)
         {
            ...
            {
               _loc2_ = var_232.getWithIndex(_loc1_) as DirectionData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function defineDirections(param1:XML) : Boolean
      {
         ...
         while(_loc5_ < _loc4_.length())
         {
            ...
            _loc7_ = int(_loc6_.@id);
            _loc8_ = _loc6_.layer;
            if(var_232.getValue(String(_loc7_)) != null)
            {
               return false;
            }
            ...
            var_232.add(String(_loc7_),_loc3_);
            var_1272 = -1;
            var_700 = null;
            _loc5_++;
         }
