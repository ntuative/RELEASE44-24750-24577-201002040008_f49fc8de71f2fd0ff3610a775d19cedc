package com.sulake.habbo.room.object.visualization.avatar
{
   ...
   public class AvatarVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private const const_1382:int = 0;
      
      private var var_532:String;
      
      private var var_614:int = 0;
      
      private const const_1588:int = 1;
      ...
      private const const_1017:int = 3;
      
      private const const_1589:int = 2;
      
      private var var_738:AvatarVisualizationData = null;
      
      private const const_1018:int = 3;
      ...
      {
         var_738 = param1 as AvatarVisualizationData;
         createSprites(const_1018);
         return true;
      }
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         var _loc6_:* = var_422.getValue(_loc5_) as IAvatarImage;
         ...
         var _loc11_:Number = _loc4_.getNumber(RoomObjectVariableEnum.const_700);
         ...
         var _loc14_:Number = _loc8_ - var_1088;
         ...
         var _loc16_:Number = _loc4_.getNumber(RoomObjectVariableEnum.const_276);
         if(_loc16_ > 0)
         {
         ...
         var _loc20_:Boolean = var_285 != _loc3_.getUpdateID() || var_212 != param1.scale || var_166 != _loc4_.getUpdateID();
         var _loc21_:Boolean = _isAnimating || var_437 > 0;
         if(_loc20_ || _loc21_)
         {
            --var_437;
            _loc23_ = getTimer();
            if(var_532 != _loc7_)
            {
               for each(_loc49_ in var_422.getKeys())
               {
                  var_422.remove(_loc49_);
               }
               _loc6_ = null;
            }
            if(_loc6_ == null)
            {
               _loc6_ = var_738.getAvatar(_loc7_,param1.scale);
               if(_loc6_ == null)
               {
                  return;
               }
               var_422.remove(_loc5_);
               var_422.add(_loc5_,_loc6_);
               var_532 = _loc7_;
            }
            ...
            _loc25_ = _loc4_.getNumber(RoomObjectVariableEnum.const_309);
            if(isNaN(_loc25_) || _loc4_.getString(RoomObjectVariableEnum.const_266) == "float")
            {
               _loc25_ = _loc24_;
            }
            else
            ...
            _loc26_ = _loc4_.getString(RoomObjectVariableEnum.const_266);
            _loc27_ = _loc4_.getString(RoomObjectVariableEnum.const_498);
            _loc6_.appendAction(AvatarAction.const_723,_loc26_,_loc27_);
            _loc28_ = false;
            if(_loc26_ == "lay")
            {
            ...
            if(_loc29_ > 0 && _loc6_.getScale() == AvatarScaleType.const_51)
            {
               ...
               {
                  _loc6_.appendAction(AvatarAction.const_307,AvatarAction.const_1317[_loc29_]);
               }
            }
            _loc30_ = _loc4_.getNumber(RoomObjectVariableEnum.const_881);
            if(_loc30_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_865,_loc30_);
            }
            _loc31_ = _loc4_.getNumber(RoomObjectVariableEnum.const_882);
            if(_loc31_ > 0)
            {
               _loc54_ = _loc4_.getNumber(RoomObjectVariableEnum.const_841);
               _loc55_ = 5;
               _loc56_ = _loc8_ - _loc54_;
               if(_loc56_ < _loc55_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_806,_loc31_);
               }
            }
            _loc32_ = _loc4_.getNumber(RoomObjectVariableEnum.const_593);
            _loc33_ = 0;
            if(_loc32_ > 0)
            {
               _loc57_ = _loc4_.getNumber(RoomObjectVariableEnum.const_590);
               _loc58_ = 100;
               _loc59_ = _loc8_ - _loc57_;
               if(_loc59_ < _loc58_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_823,_loc32_);
                  _loc60_ = 1;
                  while(_loc60_ < 10)
                  {
            ...
            _loc34_ = _loc4_.getNumber(RoomObjectVariableEnum.const_949);
            if(_loc33_ > 0)
            {
               _loc34_ = _loc33_;
            }
            if(_loc34_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_893,_loc34_);
            }
            if(_loc9_)
            {
               _loc6_.appendAction(AvatarAction.const_399);
            }
            _loc35_ = _loc4_.getNumber(RoomObjectVariableEnum.const_472) > 0;
            if(_loc35_ || _loc13_)
            {
               _loc6_.appendAction(AvatarAction.const_613);
            }
            if(_loc15_)
            {
               _loc6_.appendAction(AvatarAction.const_417);
            }
            _loc36_ = _loc4_.getNumber(RoomObjectVariableEnum.const_830);
            if(_loc36_ > 0)
            {
            ...
            _loc43_ = getSprite(const_1382);
            if(_loc43_ != null)
            {
               _loc43_.asset = _loc40_;
            ...
            _loc43_ = getSprite(const_1589);
            if(_loc4_.getNumber(RoomObjectVariableEnum.const_909))
            {
               _loc43_.visible = true;
               _loc40_ = null;
               _loc39_ = null;
               ...
               if(_loc39_ != null)
               {
                  _loc40_ = var_738.getAvatarRendererAsset(_loc39_) as BitmapDataAsset;
               }
               if(_loc40_ != null)
               {
                  _loc43_.asset = _loc40_;
            ...
            var_166 = _loc4_.getUpdateID();
            var_212 = param1.scale;
            var_737.push(getTimer() - _loc23_);
            if(false)
            {
               _loc77_ = 0;
               _loc78_ = "[";
               for each(_loc79_ in var_737)
               {
                  _loc77_ += _loc79_;
                  _loc78_ += "," + _loc79_;
               }
      ...
      override public function dispose() : void
      {
         ...
         if(var_422 != null)
         {
            _loc1_ = var_422.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_422.getValue(_loc2_) as IAvatarImage;
               _loc3_.dispose();
            }
         }
