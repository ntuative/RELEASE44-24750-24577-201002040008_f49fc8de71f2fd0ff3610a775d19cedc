package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IDisposable
   {
      ...
      private static const const_754:String = "tile_cursor";
      
      private static const const_273:String = "RCL_PUBLICROOM_";
      
      private static const const_485:String = "wall_place_holder";
      
      private static const const_1053:int = 2;
      
      private static const const_333:String = "place_holder";
      
      private static const const_1052:String = const_333;
      ...
      private var var_974:IEventDispatcher = null;
      
      private var var_1185:Map = null;
      ...
      public function RoomContentLoader()
      {
         ...
         var_1809 = ["room_public","room_public_park","room_public_pool"];
         super();
         var_389 = new Map();
         _events = new Map();
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               _loc6_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_313,_loc4_);
      ...
      private function extractPublicRoomFromXML(param1:String, param2:XML) : PublicRoomData
      {
         ...
         while(_loc5_ < _loc3_.length())
         {
            ...
            _loc7_ = const_273 + String(_loc6_.@name);
            _loc8_ = 32;
            _loc9_ = 1;
      ...
      {
         if(var_174 != null && var_174.hasWorldType(const_273 + param1))
         {
            return var_174.type;
         }
         return param1;
                  ...
                  for each(_loc8_ in _loc7_)
                  {
                     ...
                     if(_loc8_.length > 0)
                     {
                        ...
                        if(_loc9_.length >= 3)
                        {
                           ...
                           {
                              var_387.add(_loc10_,_loc11_);
                              if(var_457.indexOf(_loc14_) < 0)
                              {
                                 var_457.push(_loc14_);
                              }
                           }
      ...
      public function dispose() : void
      {
         ...
         if(var_257 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc4_ = var_257.getWithIndex(_loc2_) as IGraphicAssetCollection;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         if(_loc3_ == null)
         {
            _loc4_ = var_551.getValue(_loc2_);
            if(_loc4_ != null)
            {
      ...
      {
         return [const_333,const_485,ROOM_CONTENT,const_754,const_752];
      }
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_154 && _loc5_ != RoomObjectLogicEnum.const_114)
         {
            _loc6_ = "@shadow";
      ...
      public function removeObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(false)
         {
            var_257.remove(_loc5_);
         }
         switch(param2)
         {
            case RoomObjectCategoryEnum.const_30:
               var_387.remove(param1);
               break;
            case RoomObjectCategoryEnum.const_28:
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         {
            _loc5_ = method_3(_loc4_);
            if(_loc5_.length > 0 && _loc5_[0] == _loc2_.url)
            {
               Core.crash("Failed to load asset: " + _loc2_.url,CoreComponent.const_1283);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(var_1809.indexOf(getVisualizationType(_loc5_)) >= 0)
            {
               _loc7_ = getVisualizationXML(_loc5_);
               _loc8_ = extractPublicRoomFromXML(_loc5_,_loc7_);
               var_1185.add(_loc5_,_loc8_);
               var_174 = _loc8_;
               extractPublicRoomFurnitures(_loc5_,_loc2_);
            }
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_313,_loc5_);
         }
         else
         {
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         {
            return RoomObjectCategoryEnum.const_260;
         }
         return RoomObjectCategoryEnum.const_194;
      }
      ...
      {
         if(var_550.getValue(param1) != null)
         {
            return var_550.getValue(param1);
         }
         return "";
      }
      ...
      private function continueInitilization() : void
      {
         if(var_1808)
         {
            ...
            if(var_974 != null)
            {
               var_974.dispatchEvent(new Event(const_676));
            }
         }
      }
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         if(var_174 != null)
         {
            return var_174.getWorldHeightScale(const_273 + param1);
         }
         return 1;
      }
      ...
      private function method_3(param1:String) : Array
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc4_:* = null;
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         if(_assetLibrary != null && param2 != null)
         {
            ...
            var_974 = param1;
            var_1810 = param2.getKey("flash.dynamic.download.url","furniture/");
            var_1813 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
            var_1811 = param2.getKey("public.room.dynamic.download.url","");
      ...
      {
         var _loc2_:String = getContentType(param1);
         return var_257.getValue(_loc2_) as IGraphicAssetCollection;
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         if(var_388 != null)
         {
            var_388.remove(param1);
            var_388.add(param1,param2);
         }
         if(var_390 != null)
         {
            var_390.remove(param2);
            var_390.add(param2,param1);
         }
      }
      ...
      public function getVisualizationType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectVisualizationEnum.const_154 && _loc5_ != RoomObjectVisualizationEnum.const_114)
         {
            _loc6_ = "@shadow";
            if(param1.indexOf(_loc6_) > -1)
            {
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = var_391.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
            _loc3_.assetLibrary = param2;
            var_257.add(param1,_loc3_);
         }
         return _loc3_;
      }
      ...
      {
         if(getObjectCategory(const_273 + param1) == RoomObjectCategoryEnum.const_58)
         {
            return true;
         }
         return false;
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(var_1185.getValue(param1) != null)
         {
            var_174 = var_1185.getValue(param1) as PublicRoomData;
         }
         ...
         if(_loc3_ != null)
         {
            _loc5_ = method_3(_loc3_);
         }
         else
         {
            _loc5_ = method_3(param1);
         }
         if(_loc5_ != null && _loc5_.length > 0)
         {
            _loc4_.addEventListener(AssetLibrary.const_384,onContentLoaded);
            _loc6_ = 0;
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(var_174 != null)
         {
            return var_174.getWorldScale(const_273 + param1);
         }
         return 32;
      }
