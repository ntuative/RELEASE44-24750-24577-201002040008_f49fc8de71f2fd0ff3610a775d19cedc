package com.sulake.habbo.room
{
   ...
   public class RoomMessageHandler
   {
      ...
      private var var_969:int = -1000000000;
      ...
      private function onParkBusDoor(param1:IMessageEvent) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.setNumber(RoomObjectVariableEnum.const_988,_loc3_.status);
         }
      }
      ...
      private function addActiveObject(param1:int, param2:int, param3:ObjectMessageData) : void
      {
         ...
         {
            var_24.addObjectFurnitureByName(param1,param2,param3.id,param3.staticClass,_loc4_,_loc5_,param3.state,param3.data,param3.extra);
         }
         else
         {
            var_24.addObjectFurniture(param1,param2,param3.id,param3.type,_loc4_,_loc5_,param3.state,param3.data,param3.extra,param3.expiryTime);
         }
      }
      ...
      private function onUserUpdate(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:Number = _loc6_.getNumber(RoomVariableEnum.const_705);
         var _loc8_:int = 0;
      ...
      private function onFloorHeightMap(param1:IMessageEvent) : void
      {
         ...
         var_85.initializeTileMap(_loc7_,_loc8_);
         var _loc9_:* = -1;
         var _loc10_:* = -1;
         var _loc11_:* = 0;
         var _loc12_:* = 0;
         ...
         while(_loc15_ < _loc8_)
         {
            ...
            while(_loc20_ < _loc7_)
            {
               ...
               var_85.setTileHeight(_loc20_,_loc15_,_loc21_);
               _loc20_++;
            }
            _loc15_++;
         }
         if(!_loc13_)
         {
            var_85.setTileHeight(Math.floor(_loc9_),Math.floor(_loc10_),_loc11_);
         }
         ...
         var_85.initializeFromTileData(_loc16_);
         if(!_loc13_)
         {
            var_85.setTileHeight(Math.floor(_loc9_),Math.floor(_loc10_),_loc11_ + var_85.wallHeight);
         }
         _loc6_.scale = _loc3_.scale;
         _loc6_.initialize(_loc7_,_loc8_,var_85.floorHeight);
         ...
         while(_loc17_ >= 0)
         {
            ...
            while(_loc23_ >= 0)
            {
               _loc6_.setTileHeight(_loc23_,_loc17_,var_85.getTileHeight(_loc23_,_loc17_));
               _loc23_--;
            }
            _loc17_--;
         }
         var _loc18_:XML = var_85.getXML();
         var _loc19_:XML = <dimensions minX="{var_85.minX}" maxX="{var_85.maxX}" minY="{var_85.minY}" maxY="{var_85.maxY}"/>;
      ...
      private function onObjectUpdate(param1:IMessageEvent) : void
      {
         ...
         if(_loc6_ != null)
         {
            ...
            var_24.updateObjectFurniture(_loc4_,_loc5_,_loc6_.id,_loc7_,_loc8_,_loc6_.state,_loc6_.data,_loc6_.extra);
         }
      }
      ...
      private function onSlideUpdate(param1:IMessageEvent) : void
      {
         ...
         if(param1 is SlideObjectBundleMessageEvent)
         {
            ...
            if(_loc2_.avatar != null)
            {
               ...
               {
                  case SlideObjectMessageData.const_967:
                     _loc10_ = "mv";
                     break;
                  case SlideObjectMessageData.const_878:
                     _loc10_ = "std";
               }
