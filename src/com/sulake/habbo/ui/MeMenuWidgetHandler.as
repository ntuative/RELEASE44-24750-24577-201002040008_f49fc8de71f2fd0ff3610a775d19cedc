   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function setMeMenuToolbarIcon(param1:Boolean) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            Logger.log("MeMenuWidgetHandler: set toolbar icon: " + var_191 + " " + _loc6_);
            if(var_191 != null && _loc6_ != null)
            {
               _loc8_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_778,HabboToolbarIconEnum.MEMENU);
               _loc8_.bitmapData = _loc6_;
               var_191.events.dispatchEvent(_loc8_);
            }
         }
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_651,onFigureUpdate);
            }
            if(false)
            {
            ...
            if(false)
            {
               _container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_426,onHelpTutorialEvent);
         ...
         if(_container != null && false)
         {
            _container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_651,onFigureUpdate);
            _container.sessionDataManager.events.addEventListener(SessionCreditBalanceEvent.const_159,onCreditBalance);
         }
         ...
         if(var_25 != null)
         {
            ...
            (var_25 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_599,onHabboClubSubscriptionChanged);
         }
         ...
         if(false)
         {
            _container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_426,onHelpTutorialEvent);
            _container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_94,onHelpTutorialEvent);
         }
         var_94 = _container.catalog;
      }
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_94:
               ...
               break;
            case HabboHelpTutorialEvent.const_426:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_495);
         _loc1_.push(RoomWidgetDanceMessage.const_693);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_539);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_524);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_605);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_548);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_510);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_628);
         _loc1_.push(RoomWidgetStopEffectMessage.const_534);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1336);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_868);
         _loc1_.push(RoomWidgetToolbarMessage.const_600);
         _loc1_.push(RoomWidgetToolbarMessage.const_499);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_692);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1232);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1002);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_656);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_549);
         _loc1_.push(RoomWidgetRedeemClubPromoMessage.const_506);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_685);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1236);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_642);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_647);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_675);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_549:
               ...
               break;
            case RoomWidgetWaveMessage.const_495:
               if(_container != null && false)
               {
            ...
            case RoomWidgetDanceMessage.const_693:
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_539:
               if(var_25 != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_605:
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_628:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(var_94 != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.CATALOG_CLUB)
               {
                  var_94.openCatalogPage(CatalogPageName.const_301,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_510:
               ...
               if(var_25 != null)
               {
                  ...
                  switch(_loc3_.inventoryType)
                  {
                     case RoomWidgetOpenInventoryMessage.const_917:
                        var_94.openCatalogPage(CatalogPageName.const_1234,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_895:
                     ...
                     case RoomWidgetOpenInventoryMessage.const_1358:
                        ...
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1172:
                        break;
                     default:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_548:
            case RoomWidgetStopEffectMessage.const_534:
               ...
               break;
            case RoomWidgetSetToolbarIconMessage.const_866:
               _loc4_ = param1 as RoomWidgetSetToolbarIconMessage;
               switch(_loc4_.widgetType)
               {
                  case RoomWidgetSetToolbarIconMessage.const_1193:
                     break;
                  default:
            ...
            case RoomWidgetNavigateToRoomMessage.const_868:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_656:
               if(_container != null)
               {
            ...
            case RoomWidgetToolbarMessage.const_600:
               ...
               if(var_191)
               {
                  var_191.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_46,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(var_25 != null)
                  {
                     _loc14_ = false;
                     if(_container != null && false)
                  ...
                  if(var_94 != null && var_94.getPurse() != null)
                  {
                     _container.events.dispatchEvent(new RoomWidgetCreditBalanceUpdateEvent(var_94.getPurse().credits));
                  }
               }
               ...
               break;
            case RoomWidgetToolbarMessage.const_499:
               ...
               if(var_191 && false)
               {
                  var_191.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_404,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_692:
               ...
               if(_container)
               {
                  ...
                  if(false && !_loc23_)
                  {
                     ...
                     if(_loc25_ && false)
                     {
                        _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_357,_loc24_,RoomWidgetAvatarEditorUpdateEvent.const_784));
                     }
                     _loc26_ = int(_container.config.getKey("avatar.editor.trial.promo")) > 0;
                     if(_loc26_ && true)
                     {
                        _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_357,_loc24_,RoomWidgetAvatarEditorUpdateEvent.const_1215));
                     }
                  }
                  if(false && _container.habboHelp.events)
                  {
                     _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_713));
                  }
               }
               break;
            case RoomWidgetRedeemClubPromoMessage.const_506:
               ...
               break;
            case RoomWidgetGetSettingsMessage.const_685:
            ...
            case RoomWidgetStoreSettingsMessage.const_642:
               ...
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_290,_container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_647:
               _container.soundManager.previewVolume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_290,_container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_675:
               if(false && _container.habboHelp.events)
               {
