   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            ...
            if(false)
            {
               _container.roomSessionManager.events.removeEventListener(RoomSessionUserFigureUpdateEvent.const_153,onFigureUpdate);
               _container.roomSessionManager.events.removeEventListener(RoomSessionPetInfoUpdateEvent.const_138,onPetInfo);
               _container.roomSessionManager.events.removeEventListener(RoomSessionPetCommandsUpdateEvent.const_149,onPetCommands);
            }
         }
         _container = param1;
         if(param1 == null)
         ...
         if(false)
         {
            _container.roomSessionManager.events.addEventListener(RoomSessionUserFigureUpdateEvent.const_153,onFigureUpdate);
            _container.roomSessionManager.events.addEventListener(RoomSessionPetInfoUpdateEvent.const_138,onPetInfo);
            _container.roomSessionManager.events.addEventListener(RoomSessionPetCommandsUpdateEvent.const_149,onPetCommands);
         }
      }
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_28:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_664);
               _loc6_.id = param1.id;
               ...
               {
                  _loc22_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_311);
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_838);
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_996);
            ...
            case RoomObjectCategoryEnum.const_35:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_317)
               {
                  _container.roomSession.userDataManager.requestPetInfo(_loc11_.webID);
                  return null;
               }
               if(_loc11_.type == RoomObjectTypeEnum.const_369)
               {
                  _loc12_ = "null";
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_876)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc16_ != null)
               {
                  _loc13_.carryItem = _loc16_.getModel().getNumber(RoomObjectVariableEnum.const_593);
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_221)
               {
                  _loc13_.realName = _container.sessionDataManager.realName;
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_210)
               {
                  ...
                  if(_loc16_ != null)
                  {
                     _loc30_ = _loc16_.getModel().getString(RoomObjectVariableEnum.const_494);
                  ...
                  _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1122;
                  if(!_loc25_)
                  {
                  ...
                  if(!_loc26_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_941;
                  }
                  if(!_loc27_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_782;
                  }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1284);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc5_:IAvatarImage = var_556.getValue(_loc2_.petId) as IAvatarImage;
         if(_loc5_ == null)
         {
            _loc5_ = _container.avatarRenderManager.createPetImage(_loc4_,AvatarScaleType.const_51);
            var_556.add(_loc2_.petId,_loc5_);
         }
         ...
         if(_container != null && false)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_494);
      ...
      {
         return [RoomSessionUserBadgesEvent.const_127];
      }
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_364);
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_233);
         _loc1_.push(RoomWidgetFurniActionMessage.const_639);
         _loc1_.push(RoomWidgetFurniActionMessage.const_655);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_712);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_652);
         _loc1_.push(RoomWidgetUserActionMessage.const_430);
         _loc1_.push(RoomWidgetUserActionMessage.const_668);
         _loc1_.push(RoomWidgetUserActionMessage.const_531);
         _loc1_.push(RoomWidgetUserActionMessage.const_1146);
         _loc1_.push(RoomWidgetPetCommandMessage.const_644);
         _loc1_.push(RoomWidgetPetCommandMessage.const_575);
         _loc1_.push(RoomWidgetUserActionMessage.const_717);
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionUserBadgesEvent.const_127:
      ...
      public function dispose() : void
      {
         ...
         if(var_556 != null)
         {
            _loc1_ = var_556.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_556.getValue(_loc2_);
               if(_loc3_)
               {
                  _loc3_.dispose();
               }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_430)
            {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetUserActionMessage.const_538:
               ...
               break;
            case RoomWidgetUserActionMessage.const_717:
               _container.sessionDataManager.givePetRespect(_loc2_);
               break;
            case RoomWidgetUserActionMessage.const_603:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_874,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_550:
               ...
               break;
            case RoomWidgetUserActionMessage.const_364:
            ...
            case RoomWidgetUserActionMessage.const_386:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_712:
            ...
            case RoomWidgetGetBadgeDetailsMessage.const_652:
               ...
               break;
            case RoomWidgetUserActionMessage.const_430:
            ...
            case RoomWidgetUserActionMessage.const_668:
               ...
               break;
            case RoomWidgetPetCommandMessage.const_575:
