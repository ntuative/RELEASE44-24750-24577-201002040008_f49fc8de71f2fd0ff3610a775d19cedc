   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function dispose() : void
      {
         ...
         if(var_448 != null)
         {
            ...
            {
               _loc2_ = var_448.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           _loc13_ = var_448.getValue(_loc15_) as BitmapData;
                           _loc12_ = uint(var_640.getValue(_loc15_));
                           if(_loc13_ == null)
                           {
                              if(false)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_317:
                                 ...
                                 if(_loc13_ != null)
                                 {
                                    var_448.add(_loc15_,_loc13_);
                                 }
                                 if(_loc12_ != 0)
                                 {
                                    var_640.add(_loc15_,_loc12_);
                                 }
                                 if(_loc16_ != null)
                                 {
                                    _loc16_.dispose();
      ...
      {
         return [RoomWidgetChatMessage.const_543,RoomWidgetChatSelectAvatarMessage.const_537];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_543:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_140,_container.roomSession,0,"Version 24750-24577-201002032340");
                           ...
                           case ":chooser":
                              ...
                              {
                                 _loc4_ = new RoomWidgetRequestWidgetMessage(RoomWidgetRequestWidgetMessage.const_275);
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_537:
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_788 > 0)
            {
               _loc5_ = Number(_loc4_.scale / var_788);
            }
            if(var_449 == null)
            {
               var_447.x = 0;
               var_447.y = 0;
               var_447.z = 0;
               var_449 = _loc4_.getScreenPoint(var_447);
               var_788 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            var_447.x = 0;
            var_447.y = 0;
            var_447.z = 0;
            _loc8_ = _loc4_.getScreenPoint(var_447);
            if(_loc8_ != null)
            {
               if(_loc8_.x != var_449.x || _loc8_.y != var_449.y)
               {
                  _loc9_ = PointMath.sub(_loc8_,PointMath.mul(var_449,_loc5_));
