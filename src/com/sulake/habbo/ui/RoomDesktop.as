package com.sulake.habbo.ui
{
   ...
   public class RoomDesktop implements IRoomDesktop, IRoomWidgetMessageListener, IRoomWidgetHandlerContainer
   {
      ...
      private var var_239:DesktopLayoutManager;
      
      private var _events:EventDispatcher;
      
      private var var_191:IHabboToolbar = null;
      
      private var var_9:Boolean = true;
      
      private var var_49:IRoomSession = null;
      
      private var _config:IHabboConfigurationManager;
      
      private var var_1295:Boolean = true;
      
      private var _widgets:Map;
      
      private var var_1994:IHabboHelp = null;
      ...
      private var var_1207:IAvatarRenderManager = null;
      ...
      private var var_185:IToolTipWindow;
      
      private var var_526:ISessionDataManager = null;
      
      private var var_2148:uint = 16777215;
      
      private var var_94:IHabboCatalog = null;
      ...
      public function RoomDesktop(param1:IRoomSession, param2:IAssetLibrary, param3:IConnection)
      {
         ...
         _widgets = new Map();
         var_238 = new Map();
         var_239 = new DesktopLayoutManager();
      }
      ...
      public function set roomEngine(param1:IRoomEngine) : void
      {
         ...
         {
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_313,onRoomContentLoaded);
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_405,onRoomContentLoaded);
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_665,onRoomContentLoaded);
         }
      }
      ...
      {
         var_191 = param1;
         var_191.events.addEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,onToolbarRepositionEvent);
         var_191.events.addEventListener(HabboToolbarEvent.const_62,onHabboToolbarEvent);
      }
      
      public function init() : void
      {
         if(_roomEngine != null && var_49 != null)
         {
            var_708 = _roomEngine.loadRoomResources(var_49.roomResources);
            if(false)
            {
               var_9 = false;
         ...
         if(var_489 != null && true)
         {
            var_1295 = !var_489.showInterstitial();
         }
         checkInterrupts();
      }
      ...
      private function onRoomViewResized(param1:WindowEvent) : void
      {
         ...
         _roomEngine.modifyRoomCanvas(var_49.roomId,var_49.roomCategory,var_280[0],_loc2_.width,_loc2_.height);
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_238.length)
            {
               _loc5_ = var_238.getWithIndex(_loc1_) as IRoomWidgetHandler;
               if(_loc5_ != null)
               {
                  _loc5_.dispose();
               }
         ...
         if(_roomEngine != null && false)
         {
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_313,onRoomContentLoaded);
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_405,onRoomContentLoaded);
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_665,onRoomContentLoaded);
         }
         _roomEngine = null;
         var_34 = null;
         var_843 = null;
      ...
      private function resizeColorizer(param1:WindowEvent) : void
      {
         ...
         _loc3_.graphics.beginFill(var_2148);
      ...
      private function updateHandlers() : void
      {
         ...
         while(_loc1_ < var_238.length)
         {
            _loc2_ = var_238.getWithIndex(_loc1_) as IRoomWidgetHandler;
            if(_loc2_ != null)
            {
               _loc2_.update();
            }
      ...
      {
         var_239.setLayout(param1,_windowManager);
         if(var_191 != null)
         {
            var_239.toolbarSize = var_191.size;
            var_239.toolbarOrientation = var_191.orientation;
         }
      }
      ...
      public function canvasMouseHandler(param1:Event) : void
      {
         ...
         if(_loc4_ == _loc2_.target)
         {
            ...
            _roomEngine.setActiveRoom(var_49.roomId,var_49.roomCategory);
         ...
         if(_loc3_ == MouseEvent.MOUSE_MOVE && var_185 != null)
         {
            _loc8_ = new Point(_loc2_.stageX,_loc2_.stageY);
            _loc8_.offset(0,15);
            var_185.setGlobalPosition(_loc8_);
         }
      }
      ...
      public function createWidget(param1:String) : void
      {
         ...
         var_239.addWidgetWindow(_loc2_.mainWindow);
         ...
         if(_loc3_ != null)
         {
            ...
            if(!var_238.add(param1,_loc3_))
            {
               _loc3_.dispose();
            }
         }
         param1 = "null";
         var _loc4_:RoomWidgetRoomViewUpdateEvent = new RoomWidgetRoomViewUpdateEvent(param1,var_239.roomViewRect);
      ...
      private function onToolbarRepositionEvent(param1:HabboToolbarEvent) : void
      {
         if(var_239 != null)
         {
            var_239.toolbarOrientation = param1.orientation;
         }
      }
      ...
      public function roomObjectEventHandler(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_660:
               _loc4_ = new RoomWidgetRoomObjectUpdateEvent(RoomWidgetRoomObjectUpdateEvent.const_286,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               if(var_1486 != null && _loc3_ == RoomObjectCategoryEnum.const_35)
               {
                  _loc7_ = var_49.userDataManager.getUserDataByIndex(_loc2_);
                  if(_loc7_ != null && _loc7_.type == RoomObjectTypeEnum.const_369)
                  {
                     var_1486.userSelected(_loc7_.webID,_loc7_.name);
                  }
               }
               break;
            case RoomEngineObjectEvent.const_261:
               ...
               break;
            case RoomEngineObjectEvent.const_684:
               switch(_loc3_)
               {
                  case RoomObjectCategoryEnum.const_30:
                  case RoomObjectCategoryEnum.const_28:
            ...
            case RoomEngineObjectEvent.const_352:
               _loc4_ = new RoomWidgetRoomObjectUpdateEvent(RoomWidgetRoomObjectUpdateEvent.const_205,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               break;
            ...
            case RoomEngineObjectEvent.const_126:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_546,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
            ...
            case RoomEngineObjectEvent.const_113:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_497,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               processWidgetMessage(_loc5_);
               break;
            ...
            case RoomEngineObjectEvent.const_124:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_505,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               processWidgetMessage(_loc5_);
               break;
            ...
            case RoomEngineObjectEvent.const_460:
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         while(_loc2_ >= 0)
         {
            _loc3_ = var_238.getWithIndex(_loc2_) as IRoomWidgetHandler;
            if(_loc3_ != null)
            {
      ...
      public function createRoomView(param1:int) : void
      {
         ...
         var _loc20_:* = null;
         var _loc2_:Rectangle = var_239.roomViewRect;
         ...
         if(var_49 == null || _windowManager == null || _roomEngine == null)
         {
            return;
         }
         var _loc6_:DisplayObject = _roomEngine.createRoomCanvas(var_49.roomId,var_49.roomCategory,param1,_loc3_,_loc4_,_loc5_);
         if(_loc6_ == null)
         {
            return;
         }
         var _loc7_:RoomGeometry = _roomEngine.getRoomCanvasGeometry(var_49.roomId,var_49.roomCategory,param1) as RoomGeometry;
         if(_loc7_ != null)
         {
            _loc12_ = _roomEngine.getRoomNumberValue(var_49.roomId,var_49.roomCategory,RoomVariableEnum.const_677);
            _loc13_ = _roomEngine.getRoomNumberValue(var_49.roomId,var_49.roomCategory,RoomVariableEnum.const_666);
            _loc14_ = _roomEngine.getRoomNumberValue(var_49.roomId,var_49.roomCategory,RoomVariableEnum.const_637);
            _loc15_ = _roomEngine.getRoomNumberValue(var_49.roomId,var_49.roomCategory,RoomVariableEnum.const_726);
         ...
         _loc10_.addEventListener(WindowMouseEvent.const_256,canvasMouseHandler);
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         if(param1.iconId == HabboToolbarIconEnum.ZOOM)
         {
            if(var_49 != null)
            {
               _loc2_ = _roomEngine.getRoomCanvasGeometry(var_49.roomId,var_49.roomCategory,getFirstCanvasId());
               if(_loc2_ != null)
               {
                  _loc2_.performZoom();
                  ...
                  {
                     _loc3_.iconState = "2";
                     var_191.events.dispatchEvent(_loc3_);
                  }
                  else
                  {
                     _loc3_.iconState = "0";
      ...
      private function handleRoomAdClick(param1:RoomEngineObjectEvent) : void
      {
         ...
         var _loc4_:String = _loc3_.getString(RoomObjectVariableEnum.const_296);
      ...
      private function handleRoomAdTooltip(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_444:
               ...
               var_185 = _windowManager.createWindow("room_ad_tooltip",_loc3_,WindowType.WINDOW_TYPE_TOOLTIP,WindowStyle.const_249,WindowParam.const_85) as IToolTipWindow;
               var_185.setParamFlag(WindowParam.const_48,false);
      ...
      {
         if(var_34 != null && var_49 != null && var_1295 && var_9)
         {
            var_34.startSession(var_49);
            processEvent(new RoomWidgetLoadingBarUpdateEvent(RoomWidgetLoadingBarUpdateEvent.const_253));
         }
      }
      ...
      {
         var _loc3_:IWindowContainer = var_239.getRoomView() as IWindowContainer;
         if(_loc3_ == null)
         {
            return;
         }
