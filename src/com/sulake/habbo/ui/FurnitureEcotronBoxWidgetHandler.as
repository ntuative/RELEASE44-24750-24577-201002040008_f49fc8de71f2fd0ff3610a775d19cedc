package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_568,RoomWidgetEcotronBoxOpenMessage.const_541,RoomWidgetEcotronBoxOpenedMessage.const_1287];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_568:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_541:
