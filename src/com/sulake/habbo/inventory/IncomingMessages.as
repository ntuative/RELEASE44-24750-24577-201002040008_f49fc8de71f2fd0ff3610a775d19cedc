package com.sulake.habbo.inventory
{
   ...
   public class IncomingMessages
   {
      ...
      private var var_38:IHabboCommunicationManager;
      ...
      public function IncomingMessages(param1:HabboInventory)
      {
         super();
         var_25 = param1;
         var_38 = var_25.communication;
         var_38.addHabboConnectionMessageEvent(new FurniListEvent(onFurniList));
         var_38.addHabboConnectionMessageEvent(new FurniListInsertEvent(onFurniListInsert));
         var_38.addHabboConnectionMessageEvent(new FurniListRemoveEvent(onFurniListRemove));
         var_38.addHabboConnectionMessageEvent(new FurniListUpdateEvent(onFurniListUpdate));
         var_38.addHabboConnectionMessageEvent(new PostItPlacedEvent(onPostItPlaced));
         var_38.addHabboConnectionMessageEvent(new AvatarEffectsMessageEvent(onAvatarEffects));
         var_38.addHabboConnectionMessageEvent(new AvatarEffectActivatedMessageEvent(onAvatarEffectActivated));
         var_38.addHabboConnectionMessageEvent(new AvatarEffectAddedMessageEvent(onAvatarEffectAdded));
         var_38.addHabboConnectionMessageEvent(new AvatarEffectExpiredMessageEvent(onAvatarEffectExpired));
         var_38.addHabboConnectionMessageEvent(new HabboActivityPointNotificationMessageEvent(onPixelBalance));
         var_38.addHabboConnectionMessageEvent(new CreditBalanceEvent(onCreditsBalance));
         var_38.addHabboConnectionMessageEvent(new ScrSendUserInfoEvent(onClubStatus));
         var_38.addHabboConnectionMessageEvent(new BadgesEvent(onBadges));
         var_38.addHabboConnectionMessageEvent(new HabboUserBadgesMessageEvent(onUserBadges));
         var_38.addHabboConnectionMessageEvent(new HabboAchievementNotificationMessageEvent(onAchievementReceived));
         var_38.addHabboConnectionMessageEvent(new AchievementsEvent(onAchievements));
         var_38.addHabboConnectionMessageEvent(new TradingAcceptEvent(onTradingAccepted,TradingAcceptParser));
         var_38.addHabboConnectionMessageEvent(new TradingConfirmationEvent(onTradingConfirmation,TradingConfirmationParser));
         var_38.addHabboConnectionMessageEvent(new TradingAlreadyOpenEvent(onTradingAlreadyOpen,TradingAlreadyOpenParser));
         var_38.addHabboConnectionMessageEvent(new TradingCloseEvent(onTradingClose,TradingCloseParser));
         var_38.addHabboConnectionMessageEvent(new TradingCompletedEvent(onTradingCompleted,TradingCompletedParser));
         var_38.addHabboConnectionMessageEvent(new TradingItemListEvent(onTradingItemList,TradingItemListParser));
         var_38.addHabboConnectionMessageEvent(new TradingNotOpenEvent(onTradingNotOpen,TradingNotOpenParser));
         var_38.addHabboConnectionMessageEvent(new TradingOpenEvent(onTradingOpen,TradingOpenParser));
         var_38.addHabboConnectionMessageEvent(new TradingOtherNotAllowedEvent(onTradingOtherNotAllowed,TradingOtherNotAllowedParser));
         var_38.addHabboConnectionMessageEvent(new TradingYouAreNotAllowedEvent(onTradingYouAreNotAllowed,TradingYouAreNotAllowedParser));
         var_38.addHabboConnectionMessageEvent(new OpenConnectionMessageEvent(onRoomClosed));
         var_38.addHabboConnectionMessageEvent(new CloseConnectionMessageEvent(onRoomClosed));
         var_38.addHabboConnectionMessageEvent(new FlatAccessDeniedMessageEvent(onRoomClosed));
         var_38.addHabboConnectionMessageEvent(new PetInventoryEvent(onPets));
         var_38.addHabboConnectionMessageEvent(new PetAddedToInventoryEvent(onPetAdded));
         var_38.addHabboConnectionMessageEvent(new PetRemovedFromInventoryEvent(onPetRemoved));
         var_38.addHabboConnectionMessageEvent(new PetInventoryUpdatedEvent(onPetInventoryUpdated));
         var_38.addHabboConnectionMessageEvent(new MarketplaceConfigurationEvent(onMarketplaceConfiguration));
         var_38.addHabboConnectionMessageEvent(new MarketplaceCanMakeOfferResult(onMarketplaceCanMakeOfferResult));
         var_38.addHabboConnectionMessageEvent(new MarketplaceMakeOfferResult(onMarketplaceMakeOfferResult));
         var_38.addHabboConnectionMessageEvent(new MarketplaceItemStatsEvent(onMarketplaceItemStats));
         var_38.addHabboConnectionMessageEvent(new NotEnoughBalanceMessageEvent(onNotEnoughCredits));
      }
      ...
      public function onFurniListUpdate(param1:IMessageEvent) : void
      {
         ...
         var_25.setInventoryCategoryInit(InventoryCategory.const_69,false);
      }
      ...
      public function onAvatarEffects(param1:IMessageEvent) : void
      {
         ...
         var_25.setInventoryCategoryInit(InventoryCategory.const_703);
         _loc2_.refreshViews();
         var_25.notifyChangedEffects();
      }
      ...
      private function onTradingItemList(param1:IMessageEvent) : void
      {
         ...
         while(_loc10_ < _loc5_)
         {
            ...
            if(_loc9_.category == FurniCategory.const_167)
            {
      ...
      private function getConnection() : IConnection
      {
         ...
         return var_38.getHabboMainConnection(null);
      }
      ...
      private function onPets(param1:PetInventoryEvent) : void
      {
         ...
         var_25.setInventoryCategoryInit(InventoryCategory.const_155);
      }
      ...
      public function onAchievements(param1:IMessageEvent) : void
      {
         ...
         _loc4_.refreshViews();
         var_25.setInventoryCategoryInit(InventoryCategory.const_330);
      }
      ...
      public function onFurniList(param1:IMessageEvent) : void
      {
         ...
         var_25.setInventoryCategoryInit(InventoryCategory.const_69);
      ...
      private function onTradingOpen(param1:IMessageEvent) : void
      {
         ...
         var_25.toggleInventorySubPage(InventorySubCategory.const_268);
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         var_25.setInventoryCategoryInit(InventoryCategory.const_423);
         var _loc4_:FurniModel = var_25.furniModel;
         if(_loc4_ != null)
         {
            _loc4_.updateView();
      ...
      private function onNotEnoughCredits(param1:NotEnoughBalanceMessageEvent) : void
      {
         ...
         var _loc2_:MarketplaceModel = var_25.marketplaceModel;
         if(_loc2_ == null)
         {
            return;
         }
