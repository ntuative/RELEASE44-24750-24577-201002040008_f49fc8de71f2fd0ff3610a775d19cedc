package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsGridItem
   {
      ...
      private function method_9(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowMouseEvent.const_50:
               var_1034.setSelectedGridItem(this);
               var_873 = true;
               break;
            ...
            case WindowMouseEvent.const_29:
               ...
               {
                  var_873 = false;
                  var_1034.placePetToRoom(var_1180.id,true);
               }
         }
      }
      ...
      public function setSelected(param1:Boolean) : void
      {
         ...
         _window.color = !!_isSelected ? uint(const_1603) : uint(const_1604);
      }
