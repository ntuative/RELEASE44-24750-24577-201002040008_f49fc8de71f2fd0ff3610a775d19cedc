package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_2253:BitmapData;
      
      protected var var_906:Boolean;
      ...
      protected var var_364:BitmapData;
      
      private const const_1412:Number = 0.2;
      
      protected var var_1338:Boolean;
      
      private const const_1411:Number = 1;
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(category == FurniCategory.const_650)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < _items.length)
      ...
      public function initImage() : void
      {
         ...
         if(_mainCategory == FurniModel.const_41)
         {
            _loc1_ = _roomEngine.getFurnitureIcon(_type,this,String(var_1473));
         }
         else
         {
            _loc1_ = _roomEngine.getWallItemIcon(_type,this,var_1337);
         }
         if(_loc1_.id > 0)
         {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               _window.blend = const_1412;
               _loc1_.blend = const_1412;
            }
            else
            {
               _window.blend = const_1411;
               _loc1_.blend = const_1411;
            }
         }
         if(isSelected)
         {
         ...
         if(_loc5_)
         {
            if(var_1338 && getRecyclableCount() > 0)
            {
               _loc5_.bitmap = var_2253;
               _loc5_.visible = true;
            }
            else
            {
