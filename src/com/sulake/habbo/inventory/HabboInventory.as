package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      override public function dispose() : void
      {
         ...
         if(var_34 != null)
         {
            var_34.events.removeEventListener(RoomSessionEvent.const_91,roomSessionEventHandler);
            var_34.events.removeEventListener(RoomSessionEvent.const_99,roomSessionEventHandler);
            var_34.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_469,roomSessionEventHandler);
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_99:
               _roomSession = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_469:
               petsModel.updatePetsAllowed();
         }
      }
      ...
      {
         return EffectsModel(var_56.getValue(InventoryCategory.const_703));
      }
      
      public function get furniModel() : FurniModel
      {
         return FurniModel(var_56.getValue(InventoryCategory.const_69));
      }
      ...
      {
         var_206.clubPeriods = param1;
         var_206.clubDays = param2;
         var_206.clubHasEverBeenMember = param3;
      ...
      {
         return PetsModel(var_56.getValue(InventoryCategory.const_155));
      }
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(const_1600);
         }
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(var_56.getValue(InventoryCategory.const_330));
      }
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = var_800.indexOf(param1);
            if(_loc3_ >= 0)
            {
               var_800.splice(_loc3_,1);
            }
         }
      }
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         switch(param1)
         {
            case InventorySubCategory.const_268:
      ...
      {
         return TradingModel(var_56.getValue(InventorySubCategory.const_268));
      }
      
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         var_526 = ISessionDataManager(param2);
         queueInterface(new IIDHabboConfigurationManager(),onConfigurationManagerReady);
      }
      
      public function isInventoryCategoryInit(param1:String) : Boolean
      {
         if(var_800.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      {
         return var_206.creditBalance;
      }
      
      public function get marketplaceModel() : MarketplaceModel
      {
         return var_56.getValue(InventoryCategory.const_423) as MarketplaceModel;
      }
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1429 = new IncomingMessages(this);
      ...
      {
         return var_206.clubHasEverBeenMember;
      }
      
      public function get clubPastPeriods() : int
      {
         return var_206.clubPastPeriods;
      }
      ...
      {
         return BadgesModel(var_56.getValue(InventoryCategory.const_242));
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_34.events.addEventListener(RoomSessionEvent.const_91,roomSessionEventHandler);
         var_34.events.addEventListener(RoomSessionEvent.const_99,roomSessionEventHandler);
         var_34.events.addEventListener(RoomSessionPropertyUpdateEvent.const_469,roomSessionEventHandler);
         ...
         var_56.add(InventoryCategory.const_423,_loc3_);
         ...
         var_56.add(InventoryCategory.const_69,_loc4_);
         var _loc5_:BadgesModel = new BadgesModel(this,_windowManager,_communication,_assetLibrary,_localization,var_526);
         var_56.add(InventoryCategory.const_242,_loc5_);
         var _loc6_:EffectsModel = new EffectsModel(this,_windowManager,_communication,_assetLibrary,_localization);
         var_56.add(InventoryCategory.const_703,_loc6_);
         var _loc7_:AchievementsModel = new AchievementsModel(this,_windowManager,_communication,_assetLibrary,_localization,var_526);
         var_56.add(InventoryCategory.const_330,_loc7_);
         var _loc8_:TradingModel = new TradingModel(this,_windowManager,_communication,_assetLibrary,_roomEngine,_localization);
         var_56.add(InventorySubCategory.const_268,_loc8_);
         var _loc9_:RecyclerModel = new RecyclerModel(this,_windowManager,_communication,_assetLibrary,_roomEngine,_localization);
         var_56.add(InventorySubCategory.RECYCLER,_loc9_);
         ...
         var_56.add(InventoryCategory.const_155,_loc10_);
