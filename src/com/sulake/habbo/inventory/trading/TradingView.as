package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_740:uint = 4284532064;
      
      private static const const_741:uint = 2577770;
      
      public static const const_809:int = 0;
      ...
      private var var_37:TradingModel;
               ...
               case "button_accept":
                  switch(var_37.state)
                  {
                     case TradingModel.const_170:
                        if(var_37.otherUserItems.length == 0 && true)
                        {
                           alertPopup(const_809);
                        }
                        if(false)
                        {
                           var_37.requestUnacceptTrading();
                        }
                        else
                        {
                           var_37.requestAcceptTrading();
                        }
                        break;
                     case TradingModel.const_243:
                        param2.disable();
                        var_37.requestConfirmAcceptTrading();
                  }
                  break;
               case "button_cancel":
                  switch(var_37.state)
                  {
                     case TradingModel.const_170:
                        var_37.requestCancelTrading();
                        break;
                     case TradingModel.const_243:
                        var_37.requestConfirmDeclineTrading();
                  }
            }
         }
      }
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            var_37.requestRemoveItemFromTrading(param2.id);
         }
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            _loc3_ = var_37.ownUserItems.getWithIndex(param2.id);
            if(!_loc3_)
            {
               return;
            }
            _loc4_ = _loc3_.peek();
            _loc5_ = var_37.getItemImage(_loc4_);
            _loc6_ = "${roomItem.name." + _loc4_.type + "}";
            if(_loc4_.category == FurniCategory.const_167)
            {
               _loc6_ = "${poster_" + _loc4_.stuffData + "_name}";
            }
            if(_loc4_.category == FurniCategory.const_999)
            {
            ...
            var_332.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_377);
            var_332.show();
         }
      ...
      {
         var _loc2_:ITextWindow = var_70.findChildByName("info_text_1") as ITextWindow;
         _loc2_.text = param1;
         _loc2_.visible = true;
         var _loc3_:IItemGridWindow = var_70.findChildByName("item_grid_1") as IItemGridWindow;
         if(_loc3_)
         {
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         if(_loc6_)
         {
            updateItemList(var_37.ownUserId);
         }
         _loc5_ = var_37.otherUserItems;
         _loc6_ = false;
         _loc3_ = 0;
         while(_loc3_ < _loc5_.length)
         {
         ...
         if(_loc6_)
         {
            updateItemList(var_37.otherUserId);
         }
      }
      ...
      private function othersThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            _loc3_ = var_37.otherUserItems.getWithIndex(param2.id);
            if(_loc3_ == null)
            {
               return;
            }
      ...
      {
         return var_70.findChildByTag("OWN_USER_GRID") as IItemGridWindow;
      }
      ...
      public function updateItemList(param1:int) : void
      {
         ...
         var _loc4_:* = null;
         var _loc2_:int = 0;
         var _loc9_:* = param1 == var_37.otherUserId;
         var _loc10_:Map = !!_loc9_ ? var_37.otherUserItems : var_37.ownUserItems;
      ...
      {
         var _loc2_:ITextWindow = var_70.findChildByName("info_text_0") as ITextWindow;
         _loc2_.text = param1;
         _loc2_.visible = true;
         var _loc3_:IItemGridWindow = var_70.findChildByName("item_grid_0") as IItemGridWindow;
         if(_loc3_)
         {
            _loc3_.visible = false;
         }
      ...
      public function getWindowContainer() : IWindowContainer
      {
         if(var_70 == null)
         {
            var_70 = createNormalWindow();
         }
         if(var_1388 == null)
         {
            var_1388 = createMinimizedWindow();
         }
         if(!var_1718)
         {
            return var_70;
      ...
      {
         var _loc2_:ITextWindow = var_70.findChildByName("help_text") as ITextWindow;
         _loc2_.text = param1;
         _loc2_.visible = true;
      }
      ...
      {
         var _loc2_:* = null;
         if(param1 < var_37.ownUserItems.length)
         {
            _loc2_ = var_37.ownUserItems.getWithIndex(param1) as GroupItem;
            setSelection(_loc2_);
            if(_loc2_)
            {
               var_37.getFurniInventoryModel().displayItemInfo(_loc2_);
            }
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(param1 < var_37.otherUserItems.length)
         {
            _loc2_ = var_37.otherUserItems.getWithIndex(param1) as GroupItem;
            setSelection(_loc2_);
            if(_loc2_)
            {
               var_37.getFurniInventoryModel().displayItemInfo(_loc2_);
      ...
      {
         var _loc1_:ITextWindow = var_70.findChildByName("info_text_0") as ITextWindow;
         _loc1_.visible = false;
         var _loc2_:IItemGridWindow = var_70.findChildByName("item_grid_0") as IItemGridWindow;
         if(_loc2_)
         {
            _loc2_.visible = true;
         }
      ...
      {
         var _loc1_:ITextWindow = var_70.findChildByName("info_text_1") as ITextWindow;
         _loc1_.visible = false;
         var _loc2_:IItemGridWindow = var_70.findChildByName("item_grid_1") as IItemGridWindow;
         if(_loc2_)
         {
            _loc2_.visible = true;
         }
      ...
      public function updateUserInterface() : void
      {
         ...
         {
            updateActionState();
            _loc2_ = var_70.findChildByTag("OTHER_USER_NAME") as ITextWindow;
            if(_loc2_)
            {
               _loc2_.text = var_37.otherUserName;
            }
            _loc1_ = var_70.findChildByTag("OWN_USER_BORDER");
            if(_loc1_)
            {
               _loc1_.color = !true ? uint(const_740) : uint(const_741);
            }
            _loc3_ = var_70.findChildByTag("OWN_USER_LOCK") as IBitmapWrapperWindow;
            if(_loc3_)
            {
            ...
            _loc1_ = var_70.findChildByTag("OTHER_USER_BORDER");
            if(_loc1_)
            {
               _loc1_.color = !true ? uint(const_740) : uint(const_741);
            }
            _loc3_ = var_70.findChildByTag("OTHER_USER_LOCK") as IBitmapWrapperWindow;
            if(_loc3_)
            {
               if(_loc3_.bitmap == null)
               {
      ...
      {
         return var_70.findChildByTag("OTHER_USER_GRID") as IItemGridWindow;
      }
      ...
      public function updateActionState() : void
      {
         ...
         if(var_70)
         {
            _loc1_ = var_70.findChildByName("button_accept");
            if(!_loc1_)
            {
               return;
            }
            switch(var_37.state)
            {
               case TradingModel.const_164:
                  if(var_37.otherUserItems.length > 0 || var_37.ownUserItems.length > 0)
                  {
                     _loc1_.enable();
                  }
                  else
               ...
               case TradingModel.const_243:
                  ...
                  showInfoMessage("${inventory.trading.info.confirm}");
                  break;
               case TradingModel.const_449:
                  _loc1_.disable();
                  showInfoMessage("${inventory.trading.info.waiting}");
                  break;
               case TradingModel.const_212:
                  _loc1_.disable();
                  _loc1_.caption = "${inventory.trading.accept}";
                  showInfoMessage("${inventory.trading.info.confirm}");
                  break;
