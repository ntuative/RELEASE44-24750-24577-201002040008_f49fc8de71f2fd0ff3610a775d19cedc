package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceView implements IGetImageListener
   {
      ...
      public function showMakeOffer(param1:IItem) : void
      {
         ...
         var_2101 = _localization.getKey("roomItem.name." + param1.type);
      ...
      {
         _localization.registerParameter("inventory.marketplace.confirm_offer.info","furniname",var_2101);
         _localization.registerParameter("inventory.marketplace.confirm_offer.info","price",var_1509.toString());
      ...
      public function updateAveragePrice(param1:int, param2:int) : void
      {
         ...
         var _loc4_:int = Math.max(Math.ceil(param1 / (1 - param1)),1);
         var _loc5_:int = Math.max(param1 - _loc4_,0);
         _localization.registerParameter("inventory.marketplace.make_offer.average_price","days",param2.toString());
         var _loc6_:String = param1 == 0 ? " - " : param1.toString();
         _localization.registerParameter("inventory.marketplace.make_offer.average_price","price",_loc6_);
         var _loc7_:String = _loc5_ == 0 ? " - " : _loc5_.toString();
         _localization.registerParameter("inventory.marketplace.make_offer.average_price","price_no_commission",_loc7_);
         _loc3_.visible = true;
      }
      ...
      private function clickHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowEvent.const_152)
         {
