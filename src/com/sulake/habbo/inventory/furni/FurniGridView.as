package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniGridView
   {
      ...
      private var var_499:IItemGridWindow;
      ...
      public function FurniGridView(param1:FurniModel, param2:String, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine)
      {
         ...
         if(_view != null)
         {
            var_499 = _view.findChildByName("item_grid") as IItemGridWindow;
         }
      }
      
      public function updateItem(param1:int, param2:IWindowContainer) : void
      {
         var _loc3_:IWindow = var_499.getGridItemAt(param1);
         if(_loc3_)
         {
            _loc3_ = param2;
         }
      ...
      public function initFromList() : void
      {
         ...
         while(_loc2_ < _loc1_.length)
         {
            ...
            var_499.addGridItem(_loc3_.window);
            _loc2_++;
         }
      }
      ...
      {
         var_499.addGridItemAt(param1,param2);
         param1.procedure = method_6;
      }
      ...
      private function method_6(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_50)
         {
            ...
            _model.toggleItemSelection(_category,var_499.getGridItemIndex(param1.window));
            var_347 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_29 && var_347 != null && var_347 == param2 && true)
         {
         ...
         else if(param1.type == WindowMouseEvent.const_101)
         {
            var_347 == null;
         }
         ...
         else if(param1.type == WindowMouseEvent.const_235)
         {
