package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      private static const const_1082:int = 100;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboLocalizationManager, param8:IHabboConfigurationManager)
      {
         ...
         var_469 = new Timer(const_1082,1);
         var_469.addEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
      ...
      {
         return _controller.getSubCategoryViewId() == InventorySubCategory.const_268;
      }
      ...
      public function getAllStripIds(param1:Array) : void
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc2_:Array = var_399.getKeys();
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_.length)
         {
            _loc4_ = var_399.getValue(_loc2_[_loc3_]) as Array;
            if(_loc4_ != null)
            {
               _loc5_ = 0;
               while(_loc5_ < _loc4_.length)
               {
                  ...
                  if(_loc6_.category == FurniCategory.const_650)
                  {
                     _loc7_ = 1;
                  }
                  _loc8_ = 0;
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(var_469 != null)
            {
               var_469.removeEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
               var_469.stop();
               var_469 = null;
            }
            if(var_137 != null)
            {
               var_137.removeEventListener(TimerEvent.TIMER_COMPLETE,initTimeout);
               var_137.stop();
               var_137 = null;
            }
            if(var_668 != null)
      ...
      private function requestSelectedFurniToMover(param1:IItem) : void
      {
         ...
         if(param1.category == FurniCategory.const_167)
         {
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = null;
         if(param3 == FurniCategory.const_308)
         {
         ...
         else if(param3 == FurniCategory.const_322)
         {
         ...
         if(var_668 == null)
         {
            var_668 = _windowManager.buildFromXML(_groupItemWindowBase) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = var_668.clone() as IWindowContainer;
      ...
      public function requestInitialization(param1:int = 0) : void
      {
         if(param1 > 0)
         {
            ...
            var_137 = new Timer(param1,1);
            var_137.addEventListener(TimerEvent.TIMER_COMPLETE,initTimeout);
            var_137.start();
         }
         else
         {
      ...
      {
         _controller.checkCategoryInitilization(InventoryCategory.const_423);
         ...
         if(param1 == InventoryCategory.const_69 && false)
         {
            switch(_view.visibleCategoryId)
            {
               ...
               case const_42:
                  ...
                  break;
               case const_278:
                  _controller.toggleInventoryPage(InventoryCategory.const_155);
            }
         }
      }
      ...
      {
         if(var_823 && param1.type == RoomEngineObjectEvent.const_220)
         {
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_322 || _loc3_.category == FurniCategory.const_308 || _loc3_.category == FurniCategory.const_326)
         {
            if(param1)
            {
               return false;
      ...
      {
         return var_399.getValue(param1);
      }
      
      public function clearFurniList() : void
      {
         var_399 = new Map();
         var_399.add(const_41,new Array());
         var_399.add(const_42,new Array());
         if(_view != null)
         {
            _view.clearViews();
         }
