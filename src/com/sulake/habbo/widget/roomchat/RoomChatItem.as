package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_332:int = 10;
      
      private static const const_1022:Number = 18;
      
      private static const const_1387:Number = 10;
      
      private static const const_1386:Number = 8;
       
      
      private var var_1119:Number;
      ...
      {
         _widget.onItemMouseOut(var_927,var_928,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_927,var_928,_roomId,_roomCategory,param1);
      }
      ...
      {
         var_1118 = param1.chatType;
         var_927 = param1.userId;
         var_751 = param1.userName;
         var_928 = param1.userCategory;
         _message = param1.text;
         var_1119 = param1.userX;
         var_193 = param1.userImage;
         var_926 = param1.userColor;
      ...
      {
         var _loc5_:Rectangle = new Rectangle(var_93,_y,width,_height);
      ...
      private function addEventListenerToChild(param1:IWindow) : void
      {
         if(param1 != null)
         {
            ...
            param1.addEventListener(WindowMouseEvent.const_101,onBubbleMouseUp);
         }
      }
      ...
      public function renderView() : void
      {
         ...
         switch(var_1118)
         {
            ...
            case RoomWidgetChatUpdateEvent.const_120:
               ...
               break;
            case RoomWidgetChatUpdateEvent.const_97:
               _loc1_ = "bubble_shout";
               break;
            case RoomWidgetChatUpdateEvent.const_248:
               _loc1_ = "bubble_generic";
               _loc2_ = true;
               break;
            case RoomWidgetChatUpdateEvent.const_245:
               _loc1_ = "bubble_generic";
               _loc2_ = true;
         }
         ...
         if(var_193 != null)
         {
            ...
            _loc16_ = Math.max(_loc16_,var_193.height);
         }
         ...
         var_106 = _window as IRegionWindow;
         var_106.background = true;
         var_106.alphaTreshold = 0;
         enableTooltip();
         addEventListenerToChild(var_106);
         ...
         if(var_193 != null && !_loc2_)
         {
            ...
            if(_loc28_ != null)
            {
               _loc28_.width = var_193.width;
               _loc28_.height = var_193.height;
               _loc28_.bitmap = new BitmapData(var_193.width,var_193.height,true,0);
               _loc28_.bitmap.copyPixels(var_193,var_193.rect,new Point(0,0));
               _loc28_.x = _loc26_;
               _loc28_.y = _loc27_;
               var_370 = Math.max(0,(0 - _loc5_.height) / 2);
               _width += var_193.width;
            }
         }
         if(_loc18_ != null)
         {
            ...
            if(var_926 != 0)
            {
               _loc30_ = uint(var_926 >> 16 & 255);
               _loc31_ = uint(var_926 >> 8 & 255);
               _loc32_ = uint(var_926 >> 0 & 255);
            }
         ...
         if(_loc19_ != null)
         {
            if(_loc2_)
            {
               _width += _loc19_.textWidth + const_332;
            }
            else
            {
               _loc19_.text = var_751 + ":";
               _loc19_.y += var_370;
               _loc19_.width = _loc19_.textWidth + const_332;
               _width += _loc19_.textWidth + const_332;
            }
         }
         if(_loc20_ != null)
         {
            if(var_1118 == RoomWidgetChatUpdateEvent.const_248)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_751);
            }
            else if(var_1118 == RoomWidgetChatUpdateEvent.const_245)
            {
         ...
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_332 + _loc20_.textWidth + const_481;
            _loc37_ = new Matrix();
      ...
      {
         _widget.onItemMouseDown(var_927,var_928,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_927,var_928,_roomId,_roomCategory,param1);
      }
