package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_1177:XML;
      
      private var var_427:int;
      
      private var var_453:DimmerViewColorGrid;
      
      private var _window:IWindowContainer;
      
      private var var_1783:int;
      
      private var var_334:DimmerViewAlphaSlider;
      ...
      private function createWindow() : void
      {
         ...
         _window = _widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_55,HabboWindowStyle.const_37,0 | 0,new Rectangle(const_1047,const_1048,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               var_453 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,_widget.windowManager,_widget.assets);
            }
         }
         _loc1_ = _window.findChildByName("brightness_container");
         if(_loc1_ != null)
         {
            var_334 = new DimmerViewAlphaSlider(this,_loc1_ as IWindowContainer,_widget.assets);
         }
         ...
         while(_loc2_ < var_220.numTabItems)
         {
            ...
            _loc6_.setParamFlag(HabboWindowParam.const_39,true);
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(var_453 != null)
         {
            var_453.setSelectedColorIndex(param1);
         }
         _widget.previewCurrentSetting();
      }
      ...
      public function set selectedType(param1:int) : void
      {
         ...
         if(var_334 != null)
         {
            var_334.min = _widget.minLights[param1 - 1];
         }
      }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         selectTab(param1);
         var_971 = _loc2_.light;
         if(var_334 != null)
         {
            var_334.setValue(var_971);
         }
         var_427 = colors.indexOf(_loc2_.color);
         if(var_453 != null)
         {
            var_453.setSelectedColorIndex(var_427);
         }
