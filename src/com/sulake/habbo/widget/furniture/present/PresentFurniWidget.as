package com.sulake.habbo.widget.furniture.present
{
   ...
   public class PresentFurniWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_353,onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_466,onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_448,onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_348,onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_353,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_466,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_448,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_348,onObjectUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetPresentDataUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetPresentDataUpdateEvent.const_57:
               ...
               showInterface();
               break;
            case RoomWidgetPresentDataUpdateEvent.const_466:
               if(!var_240)
               {
                  return;
               }
            ...
            case RoomWidgetPresentDataUpdateEvent.const_448:
               ...
               break;
            case RoomWidgetPresentDataUpdateEvent.const_348:
               if(!var_240)
               {
                  return;
               }
               ...
               break;
            case RoomWidgetPresentDataUpdateEvent.const_353:
               if(!var_240)
               {
                  return;
               }
      ...
      {
         var _loc1_:* = null;
         if(var_240 || var_161 == -1 || !_controller)
         {
            return;
         }
         var_240 = true;
         ...
         {
            _loc1_ = new RoomWidgetPresentOpenMessage(RoomWidgetPresentOpenMessage.const_641,var_161);
      ...
      private function showInterface() : void
      {
         ...
         _window = windowManager.createWindow("presentcardui_container","",HabboWindowType.const_55,HabboWindowStyle.const_37,0 | 0,new Rectangle(const_1047,const_1048,2,2),null,0) as IWindowContainer;
         ...
         if(_loc4_ != null && var_209 != null)
         {
            _loc4_.caption = var_209;
         }
