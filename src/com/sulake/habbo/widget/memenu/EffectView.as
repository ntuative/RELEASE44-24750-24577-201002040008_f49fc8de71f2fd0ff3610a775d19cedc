   ...
   public class EffectView
   {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            var_871 = _window.findChildByName("effect_hilite");
            var_871.visible = false;
         }
         var_870 = _window.findChildByName("time_left") as ITextWindow;
         setTimeLeft();
         var_869 = _window.findChildByName("loader_bar");
         if(var_869 != null)
         {
            var_394 = var_869.width;
            var_172.start();
            onUpdate();
         }
         if(false)
