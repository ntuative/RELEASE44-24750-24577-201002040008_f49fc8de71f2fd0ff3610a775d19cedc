package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1611:uint = 6710886;
      
      private var _window:IItemListWindow;
      
      private const const_1615:String = "level";
      ...
      private const const_1612:String = "nutrition";
      
      private var var_69:IItemListWindow;
      
      private const const_1608:uint = 3355443;
      
      private var var_241:IBorderWindow;
      
      private const const_1609:int = 158;
      
      private const const_1610:int = 16;
      
      private var _widget:InfostandWidget;
      
      private var var_265:PetCommandTool;
      
      private const const_1607:uint = 11184810;
      
      private const const_1614:String = "experience";
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var _loc3_:IWindow = var_241.findChildByTag("close");
         if(_loc3_ != null)
         {
         ...
         var _loc6_:IBitmapWrapperWindow = var_241.findChildByName("petrespect_icon") as IBitmapWrapperWindow;
         if(_loc6_ != null)
         {
      ...
      private function updateStateElement(param1:String, param2:int, param3:int) : void
      {
         ...
         var _loc4_:IWindowContainer = var_116.getListItemByName("status_container") as IWindowContainer;
         if(_loc4_ == null)
         {
            return;
         }
      ...
      private function set ageText(param1:int) : void
      {
         ...
         var _loc2_:ITextWindow = var_116.getListItemByName("age_text") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function openTrainView() : void
      {
         if(var_265 == null)
         {
            var_265 = new PetCommandTool(_widget);
         }
         var _loc1_:InfoStandPetData = var_1180.getValue(var_628) as InfoStandPetData;
         if(_loc1_ != null)
         {
            var_265.showWindow(true);
            var_265.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      private function set image(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = var_116.getListItemByName("image_container") as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function set raceText(param1:String) : void
      {
         ...
         var _loc2_:ITextWindow = var_116.getListItemByName("race_text") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         ageText = param1.age;
         updateStateElement(const_1615,param1.level,param1.levelMax);
         updateStateElement(const_1614,param1.experience,param1.experienceMax);
         updateStateElement(const_1613,param1.energy,param1.energyMax);
         updateStateElement(const_1612,param1.nutrition,param1.nutritionMax);
         ...
         updateWindow();
         var_628 = param1.id;
         var_1180.remove(param1.id);
         var_1180.add(param1.id,param1);
         if(var_265 && var_265.isVisible() && param1.isOwnPet)
         {
            var_265.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      private function set petRespect(param1:int) : void
      {
         ...
         var _loc2_:IWindowContainer = var_116.getListItemByName("petrespect_container") as IWindowContainer;
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:Array) : void
      {
         ...
         var_265.setEnabledCommands(param1,param2);
      }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_364,_widget.petData.ownerId);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1609,const_1610,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),const_1607);
         var _loc6_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc5_.fillRect(_loc6_,const_1608);
         var _loc7_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc7_.width = _loc3_ * _loc7_.width;
         _loc5_.fillRect(_loc7_,const_1611);
         return _loc5_;
      }
