package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      private var var_116:IItemListWindow;
      
      private var var_1046:TagListRenderer;
      
      protected var var_69:IItemListWindow;
      
      private var var_241:IBorderWindow;
      
      protected var _widget:InfostandWidget;
      
      private var var_126:IBorderWindow;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         var_1046 = new TagListRenderer(param1,onTagSelected);
      }
      ...
      protected function createWindow(param1:String, param2:Boolean) : void
      {
         ...
         var_241 = _window.getListItemByName("info_border") as IBorderWindow;
         var_69 = _window.getListItemByName("button_list") as IItemListWindow;
         var _loc4_:* = [];
         var_69.groupListItemsWithTag("CMD_BUTTON",_loc4_,true);
         ...
         if(var_241 != null)
         {
            var_116 = var_241.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
         var _loc6_:IBitmapWrapperWindow = var_241.findChildByName("home_icon") as IBitmapWrapperWindow;
         ...
         var _loc7_:IWindow = var_241.findChildByTag("close");
         if(_loc7_ != null)
         {
         ...
         {
            _loc8_ = 0;
            while(_loc8_ < var_69.numListItems)
            {
               _loc13_ = var_69.getListItemAt(_loc8_) as IRegionWindow;
               if(_loc13_ != null)
               {
         ...
         while(_loc8_ < 5)
         {
            _loc10_ = var_241.findChildByName("badge_" + _loc8_);
            if(_loc10_ != null)
            {
         ...
         _loc10_ = var_241.findChildByName("badge_group");
      ...
      private function showGroupBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         _loc3_ = var_126.getChildByName("name") as ITextWindow;
         if(_loc3_ != null)
         {
            _loc3_.text = "Group Info";
         }
         _loc4_ = var_126.getChildByName("description") as ITextWindow;
         if(_loc4_ != null)
         {
         ...
         var_126.x = _loc5_.left - 0;
         var_126.y = _loc5_.top + (_loc5_.height - 0) / 2;
      }
      
      public function clearGroupBadge() : void
      {
         var _loc1_:IWindowContainer = var_116.getListItemByName("image_and_badges_container") as IWindowContainer;
      ...
      {
         var _loc2_:ITextWindow = var_116.getListItemByName("realname_text") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:IWindowContainer = var_116.getListItemByName("image_and_badges_container") as IWindowContainer;
      ...
      {
         if(var_116 == null || var_241 == null || var_69 == null)
         {
            return;
         }
         var_69.width = var_69.scrollableRegion.width;
         var_116.height = var_116.scrollableRegion.height;
         var_241.height = NaN;
         _window.width = Math.max(var_241.width,var_69.width);
      ...
      {
         var _loc2_:ITextWindow = var_116.getListItemByName("motto_text") as ITextWindow;
         var _loc3_:IWindowContainer = var_116.getListItemByName("motto_spacer") as IWindowContainer;
      ...
      {
         var _loc3_:IWindowContainer = var_116.getListItemByName("tags_container") as IWindowContainer;
         var _loc4_:IWindowContainer = var_116.getListItemByName("tags_spacer") as IWindowContainer;
         ...
         if(param1.length != 0)
         {
            _loc3_.height = var_1046.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      {
         var _loc4_:* = null;
         var _loc2_:ITextWindow = var_116.getListItemByName("handitem_txt") as ITextWindow;
         var _loc3_:IWindowContainer = var_116.getListItemByName("handitem_spacer") as IWindowContainer;
         if(_loc2_ == null || _loc3_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:ITextWindow = var_116.getListItemByName("name_text") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function enableButton(param1:String, param2:Boolean = true) : void
      {
         ...
         var _loc3_:IRegionWindow = var_69.getListItemByName(param1) as IRegionWindow;
      ...
      private function createBadgeDetails() : void
      {
         ...
         var_126 = _widget.windowManager.buildFromXML(_loc1_.content as XML) as IBorderWindow;
         if(var_126 == null)
         {
            throw new Error("Failed to construct window from XML!");
         }
      ...
      private function updateRespectButton() : void
      {
         ...
         var _loc1_:IWindow = var_69.getListItemByName("respect");
         if(_loc1_ == null)
         {
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            case RoomWidgetUserInfoUpdateEvent.TRADE_REASON_NO_OWN_RIGHT:
               ...
               break;
            case RoomWidgetUserInfoUpdateEvent.const_941:
               _loc2_ = "${infostand.button.trade.tooltip.shutdown}";
               break;
            case RoomWidgetUserInfoUpdateEvent.const_782:
      ...
      private function showBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         createBadgeDetails();
         _loc6_ = var_126.getChildByName("name") as ITextWindow;
         if(_loc6_ != null)
         {
            _loc6_.text = "${badge_name_" + _loc5_ + "}";
         }
         _loc6_ = var_126.getChildByName("description") as ITextWindow;
         if(_loc6_ != null)
         {
         ...
         var_126.x = _loc7_.left - 0;
         var_126.y = _loc7_.top + (_loc7_.height - 0) / 2;
      }
      ...
      {
         var _loc2_:ITextWindow = var_116.getListItemByName("xp_text") as ITextWindow;
         var _loc3_:IWindowContainer = var_116.getListItemByName("xp_spacer") as IWindowContainer;
         if(_loc2_ == null || _loc3_ == null)
         {
            return;
         }
      ...
      protected function updateButtons(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetUserInfoUpdateEvent.const_221:
               var_69.visible = false;
               break;
            case RoomWidgetUserInfoUpdateEvent.const_210:
      ...
      {
         var _loc3_:IWindowContainer = var_116.getListItemByName("image_and_badges_container") as IWindowContainer;
