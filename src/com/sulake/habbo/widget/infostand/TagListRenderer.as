package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_1590:int = 5;
      
      private const const_1591:int = 5;
      ...
      {
         var _loc2_:* = null;
         if(var_1126 != null && var_1126.indexOf(param1) != -1)
         {
         ...
         _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,var_121);
      ...
      private function fit(param1:Rectangle) : Boolean
      {
         ...
         if(var_756 + param1.height > _rect.height)
         {
            return false;
         }
         ...
         {
            _offsetX = 0;
            var_756 += param1.height + const_1591;
            return fit(param1);
         }
         param1.offset(_offsetX,var_756);
         _offsetX += param1.width + const_1590;
         return true;
      }
