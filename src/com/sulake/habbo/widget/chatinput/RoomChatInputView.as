package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1407:int = 5;
      
      private static const const_481:int = 16;
      
      private static const const_1069:int = 20;
      
      private static const const_332:int = 10;
      
      private static const const_1070:int = 40;
      ...
      private var var_394:Number = 600;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_991 = _localization.getKey("widgets.chatinput.mode.whisper",":tell");
         var_1896 = _localization.getKey("widgets.chatinput.mode.shout",":shout");
         var_1895 = _localization.getKey("widgets.chatinput.mode.speak",":speak");
         var_665 = new Timer(1000,1);
         var_665.addEventListener(TimerEvent.TIMER_COMPLETE,onTypingTimerComplete);
         var_817 = new Timer(5000,1);
         var_817.addEventListener(TimerEvent.TIMER_COMPLETE,onIdleTimerComplete);
         createWindow();
         refreshView();
      }
      ...
      private function createWindow() : void
      {
         ...
         _loc4_.addEventListener(WindowKeyboardEvent.const_151,windowKeyEventProcessor);
         _loc4_.addEventListener(WindowEvent.const_44,onInputFieldResized);
         _loc4_.addEventListener(WindowEvent.const_152,onInputChanged);
         _window.addEventListener(WindowEvent.const_440,onWindowMoved);
         var_1201 = true;
         var_136 = "";
      }
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         var_1897 = _loc2_.width + const_481 + _loc6_.width + const_1069;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1070,_loc8_.width) + const_481);
            _loc8_.x = _loc12_;
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == var_991 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  var_136 = "";
               }
      ...
      public function setMaxWidth(param1:Number) : void
      {
         ...
         {
            _loc3_ = Math.min(int(_loc2_.textWidth),var_394);
         }
         else
         {
            _loc3_ = Math.min(_loc3_,var_394);
         }
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(var_466);
