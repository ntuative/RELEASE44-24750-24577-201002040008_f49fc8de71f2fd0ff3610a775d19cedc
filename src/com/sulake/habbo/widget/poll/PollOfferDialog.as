package com.sulake.habbo.widget.poll
{
   ...
   public class PollOfferDialog implements IPollDialog
   {
      ...
      public static const const_699:String = "POLL_OFFER_STATE_CANCEL";
      
      public static const const_1184:String = "POLL_OFFER_STATE_OK";
      ...
      private var var_47:String = "POLL_OFFER_STATE_UNKNOWN";
            ...
            if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
            {
               switch(param2.name)
               {
                  case "poll_offer_button_ok":
                     var_47 = const_1184;
                     _widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_577,_id));
                     break;
                  case "poll_offer_button_cancel":
                     var_47 = const_699;
                     _widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_401,_id));
