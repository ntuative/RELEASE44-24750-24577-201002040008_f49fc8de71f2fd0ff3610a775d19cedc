package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, ICoreUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_1097:uint = 1;
      ...
      private var var_1261:ProfilerAgentTask;
      
      private var var_1260:IEventDispatcher;
      
      private var var_2348:uint = 0;
      
      private var var_1262:ProfilerAgentTask;
      
      private var var_1259:ProfilerOutput;
      
      private var var_694:IWindowRenderer;
      ...
      public function HabboWindowManagerComponent(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         {
            var_200 = CoreComponent(param1).root.stage;
            _instance = this;
            var_1260 = Component(param1).events;
            var_862 = new Array();
      ...
      {
         return var_305[param2].getDesktopWindow().getChildByName(param1);
      }
      ...
      {
         return var_305[param9].create(param1,param2,param3,param4,param5,param6,param7,null,param8,null,null);
      }
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         var_694 = new WindowRenderer(_loc4_);
         var_305 = new Array(const_340);
         var _loc6_:int = 0;
         while(_loc6_ < const_340)
         {
            _loc5_ = new WindowContext("layer_" + _loc6_,var_694,this,_localization,var_200,new Rectangle(0,0,var_200.stageWidth,var_200.stageHeight),this);
            var_305[_loc6_] = _loc5_;
            _loc6_++;
         }
         var_408 = var_305[const_1097];
         registerUpdateReceiver(this,0);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         var_408.getMouseCursor().defineCustomCursorType(MouseCursorType.const_316,_loc7_);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         var_408.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1361,_loc7_);
      }
      
      public function removeWindow(param1:String, param2:uint = 1) : void
      {
         var _loc3_:IDesktopWindow = var_305[param2].getDesktopWindow();
      ...
      override public function dispose() : void
      {
         if(!_isDisposed)
         {
            ...
            while(false)
            {
               IDisposable(var_305.pop()).dispose();
            }
            if(_localization)
            {
      ...
      {
         return var_305[param1].getDesktopWindow().getChildAt(var_408.getDesktopWindow().numChildren - 1);
      }
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(var_1259 == null)
         {
            ...
            if(_loc3_ != null)
            {
               var_1259 = new ProfilerOutput(_loc3_,this,var_694);
               var_1261 = new ProfilerAgentTask("Update","Event processing");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1261);
               var_1262 = new ProfilerAgentTask("Redraw","Window rasterizer");
      ...
      {
         return var_408.getWindowParser().windowToXMLString(param1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_894.length > 0)
         {
            var_1260.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_340 - 1;
            while(_loc2_ >= 0)
            {
               var_305[_loc2_].update(param1);
               _loc2_--;
            }
         }
         if(var_1029)
         ...
         var_1260.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_340)
         {
            var_305[_loc2_].render(param1);
            _loc2_++;
         }
         if(var_1029)
         {
         ...
         if(WindowContext.var_894.length > 0)
         {
            WindowContext.var_894.flush();
         }
         if(WindowContext.var_1324.length > 0)
         {
            WindowContext.var_1324.flush();
         }
         var_1260.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      
      public function getLayoutByType(param1:uint, param2:uint) : XML
      {
         var _loc3_:Dictionary = var_862[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? var_862[0][param1] as XML : _loc4_;
      }
      ...
      {
         return var_408.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1324,new Date().getTime().toString());
            ...
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ...
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1166,param2.name + ": " + param2.toString());
            }
         }
      }
   }
