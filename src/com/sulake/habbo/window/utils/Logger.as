package com.sulake.habbo.window.utils
{
   ...
   public class Logger extends Component implements ILogger
   {
      ...
      private var var_1518:ICoreWindowManager;
      ...
      {
         var_1518 = param2 as ICoreWindowManager;
         _window = var_1518.create("Logger::Output",HabboWindowType.const_356,WindowStyle.const_249,0 | 0 | 0 | 0,new Rectangle(0,0,180,240),loggerEventProc,"Logger") as IFrameWindow;
         var_354 = var_1518.create("Logger::Output::Text",HabboWindowType.const_1181,WindowStyle.const_249,0 | 0 | 0,new Rectangle(0,0,_window.content.width,_window.content.height),null,"") as ITextWindow;
