package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1118:Number = 90;
      
      private static const const_769:int = 50;
      
      private static const const_1088:Number = 25;
      
      private static const const_1089:int = 50;
      
      private static const const_184:Boolean = true;
       
      
      private var var_572:Timer;
      
      private var var_1010:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         var_1010 = param2;
         var_572 = new Timer(const_1088);
         var_572.addEventListener(TimerEvent.TIMER,animationUpdate);
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         if(_loc3_ > -1)
         {
            ...
            var_476.splice(_loc3_,1);
         }
         var_476.push(param1.name);
         var_475.push(param2);
         param1.addEventListener(WindowEvent.const_440,windowEventListener);
         param1.addEventListener(WindowEvent.const_219,windowEventListener);
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return var_475[var_476.indexOf(param1)];
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = var_1010.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      public function removeItem(param1:String) : void
      {
         if(var_301.indexOf(param1) > -1)
         {
            ...
            else
            {
               ...
               var_301.splice(var_301.indexOf(param1),1);
            }
         }
      }
      ...
      {
         var _loc2_:Point = var_1010.getIconLoc(param1.iconId);
      ...
      {
         return var_476[var_475.indexOf(param1)];
      }
      ...
      public function refresh() : void
      {
         ...
         {
            repositionWindow(var_301[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(true)
            {
               var_571[_loc3_] = new Array();
            }
            if(var_571[_loc3_].indexOf(param1) < 0)
            {
               var_571[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_769 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_769 || param1.desktop.height - param1.y < const_1089;
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         {
            if(var_476[_loc2_] == param1.window.name)
            {
               _loc3_ = "null";
               if(false)
               {
                  _loc4_ = 0;
                  while(_loc4_ < var_571[_loc3_].length)
                  {
                     repositionWindow(var_571[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
