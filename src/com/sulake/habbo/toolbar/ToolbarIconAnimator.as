package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconAnimator
   {
      ...
      public function ToolbarIconAnimator(param1:StateItem, param2:IAssetLibrary, param3:IBitmapWrapperWindow, param4:Number, param5:Number, param6:BitmapData = null)
      {
         ...
         var_809 = new Array();
         var_47 = param1.id;
         var_1156 = param1.nextState;
         var_1196 = param1.loop;
         if(param1.background != null)
         {
            var_808 = getBitmapDataFromAsset(param1.background,param2);
         }
         ...
         else
         {
            ...
            if(_loc8_ != null)
            {
               var_807.push(new XML());
               var_809.push(_loc8_);
            }
         }
         if(param6 != null)
         {
            var_809[var_62] = param6.clone();
         }
      ...
      {
         if(var_1196 == true || var_657 == 0)
         {
            if(false)
            {
               ++var_62;
               if(var_62 >= var_807.length)
               {
                  var_62 = 0;
                  ++var_657;
               }
      ...
      {
         return var_807.length;
      }
      
      public function hasNextState() : Boolean
      {
         return var_1196 == false && var_657 == 1 && var_1156 != var_47;
      }
      ...
      private function setAsset(param1:IBitmapWrapperWindow, param2:BitmapData) : void
      {
         ...
         if(var_808 != null)
         {
            _loc3_ = new BitmapData(Math.max(param2.width,var_808.width),Math.max(param2.height,var_808.height));
            _loc3_.copyPixels(var_808,var_808.rect,new Point(0,0));
      ...
      {
         var _loc2_:* = null;
         if(var_62 <= var_809.length)
         {
            _loc2_ = var_809[var_62];
