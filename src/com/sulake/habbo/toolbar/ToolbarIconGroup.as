package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconGroup
   {
      ...
      private var var_374:ToolbarBarMenuAnimator;
      ...
      {
         return var_1235.indexOf(param1) > -1;
      }
      ...
      private function alignItems() : void
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:int = 0;
         while(_loc4_ < var_1234.length)
         {
            _loc2_ = var_678.indexOf(var_1234[_loc4_]);
            if(_loc2_ > -1)
            {
               _loc1_ = var_300[_loc2_];
               if(_loc1_.exists)
               {
                  _loc1_.changePosition(var_787 + _loc3_);
                  _loc3_ += var_1233;
               }
            }
            _loc4_++;
      ...
      private function createIconObject(param1:String) : ToolbarIcon
      {
         ...
         _loc2_ = new ToolbarIcon(this,_windowManager,_assetLibrary,param1,_events,var_374);
      ...
      public function getIconById(param1:String) : ToolbarIcon
      {
         ...
         return var_300[var_678.indexOf(param1)];
      }
      ...
      public function getMenuYieldList(param1:String) : Array
      {
         ...
         var _loc3_:XMLList = var_1960.elements("menu");
         var _loc5_:int = 0;
