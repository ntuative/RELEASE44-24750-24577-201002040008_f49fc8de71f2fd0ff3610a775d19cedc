package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_1963:BitmapData = null;
      ...
      private var var_1966:BitmapData = null;
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_416,0,0,_loc4_,var_1479,var_1966,var_1963));
         }
      }
      ...
      private function onConfigurationInit(param1:Event = null) : void
      {
         var _loc6_:* = null;
         var _loc7_:* = null;
         var_1962 = int(_config.getKey("interstitial.interval","30000"));
         var_1965 = int(_config.getKey("interstitial.show.time","5000"));
         var_1478 = int(_config.getKey("interstitial.max.displays.flash","-1"));
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         var_1236 = _loc2_.imageUrl;
         var_1479 = _loc2_.clickUrl;
         if(var_1236 != "" && var_1479 != "")
         {
            _loc3_ = var_1236;
            ...
            _loc4_ = new URLRequest(var_1236);
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         var_1237 = _loc2_.imageUrl;
         var_1964 = _loc2_.clickUrl;
         var_679 = getTimer();
         if(var_1237 != "")
         {
            _loc3_ = var_1237;
            ...
            var_226.start();
            _loc4_ = new URLRequest(var_1237);
            _loc5_ = _assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_362,0,0,param1.bitmapData,var_1964));
            var_679 = getTimer();
         }
         else
         {
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_1963 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(var_1478 > 0 && var_1480 >= var_1478)
         {
            return false;
         }
      ...
      {
         var_586 = param2 as IHabboCommunicationManager;
         if(var_586 == null)
         {
            return;
         }
         _connection = var_586.getHabboMainConnection(onConnectionReady);
         if(_connection != null)
         {
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_1966 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
