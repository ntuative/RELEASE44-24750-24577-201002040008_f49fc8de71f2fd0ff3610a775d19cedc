package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2314:String = "magic.pixels";
      
      private var var_2313:String = "catalog.page.club";
      
      private var var_2338:String = "magic.credits";
      ...
      public function CatalogNavigator(param1:IHabboCatalog, param2:IWindowContainer)
      {
         ...
         _container = param2;
         var_259 = [];
         var_59 = _container.findChildByName("navigationList") as IItemListWindow;
         ...
         if(_scrollBar != null)
         {
            ...
            _scrollBar.addEventListener(WindowEvent.const_653,activateScrollbar);
      ...
      private function openCreditsPage() : void
      {
         ...
         var _loc1_:* = var_94.configuration.getKey("client.credits.embed.enabled","HabboRoomWidgetLib_memenu_fx_pause") == "true";
         if(false && _loc1_)
         {
         ...
         {
            _loc2_ = var_94.configuration.getKey("link.format.credits","/credits");
            var_94.windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,onExternalLink);
      ...
      {
         var_94.openCatalogPage(var_2313,true);
      }
      ...
      public function activateNode(param1:ICatalogNode) : void
      {
         ...
         var_94.loadCatalogPage(param1.pageId);
         var_94.events.dispatchEvent(new CatalogPageOpenedEvent(param1.pageId,param1.localization));
      }
      ...
      public function buildCatalogIndex(param1:NodeData) : void
      {
         ...
         for each(_loc2_ in _index.children)
         {
            ...
            {
               (_loc2_ as CatalogNodeRenderable).addToList(var_59);
            }
         }
      }
      ...
      public function openFrontPage() : void
      {
         ...
         var_94.loadCatalogPage(_loc1_.pageId);
      }
      ...
      public function openPage(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            var_94.loadCatalogPage(_loc2_.pageId);
         }
