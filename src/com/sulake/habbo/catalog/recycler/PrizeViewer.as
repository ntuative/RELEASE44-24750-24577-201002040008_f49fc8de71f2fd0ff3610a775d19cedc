package com.sulake.habbo.catalog.recycler
{
   ...
   public class PrizeViewer implements IGetImageListener
   {
      ...
      private var var_255:IBitmapWrapperWindow;
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         var_255.bitmap = new BitmapData(var_255.width,var_255.height,true,16777215);
         var_255.bitmap.fillRect(var_255.bitmap.rect,16777215);
         var _loc2_:Point = new Point((0 - param1.width) / 2,(0 - param1.height) / 2);
         var_255.bitmap.copyPixels(param1,param1.rect,_loc2_,null,null,true);
      }
      ...
      {
         var _loc8_:* = null;
         var_255 = param2.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         switch(param3)
         {
