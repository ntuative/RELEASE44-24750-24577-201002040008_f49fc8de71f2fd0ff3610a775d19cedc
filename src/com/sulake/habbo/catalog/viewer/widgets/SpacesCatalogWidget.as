package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1256:String = "default";
      
      private var var_1198:Array;
      
      private var var_987:BitmapData = null;
      
      private var var_223:int = 0;
      
      private var var_664:int = 0;
      
      private var var_1258:String = "1.1";
            ...
            for each(_loc2_ in page.offers)
            {
               ...
               switch(_loc4_.furnitureData.name)
               {
                  case "floor":
                     ...
                     {
                        var_812.push(String(_loc9_.@id));
                        var_1198.push(_loc2_);
                     }
                     break;
                  case "wallpaper":
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         if(var_987 != null && var_988 != null)
         {
            setRoomImage(var_987,var_988);
         }
      }
      ...
      private function updateConfiguration() : void
      {
         ...
         for each(_loc1_ in var_170.landscapes.pattern)
         {
            if(_loc1_.@id == _loc7_)
            {
               _loc13_ = _loc1_.children()[var_260];
               if(_loc13_ != null)
               {
                  var_1258 = _loc13_.@id;
               }
      ...
      private function changePattern(param1:String, param2:int) : void
      {
         ...
         switch(param1)
         {
            case const_183:
               ...
               if(var_299 == _activeWallpaperPatterns.length)
               {
                  var_299 = 0;
               }
               var_223 = 0;
               ...
               for each(_loc8_ in var_170.walls.pattern)
               {
                  if(_loc8_.@id == _loc5_)
                  {
                     var_663 = _loc8_.children().length();
                  }
               }
            ...
            case const_181:
               ...
               for each(_loc9_ in var_170.floors.pattern)
               {
                  if(_loc9_.@id == _loc6_)
                  {
                     var_662 = _loc9_.children().length();
                  }
               }
            ...
            case const_182:
               ...
               for each(_loc10_ in var_170.landscapes.pattern)
               {
                  if(_loc10_.@id == _loc7_)
                  {
                     var_664 = _loc10_.children().length();
                  }
               }
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_buy_wall":
               ...
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page,var_1256);
               }
               break;
            ...
            case "ctlg_buy_landscape":
               _loc3_ = var_1197[var_297];
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page,var_1258);
               }
               break;
            default:
      ...
      private function retrieveSpacesPreview() : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:ImageResult = page.viewer.roomEngine.getRoomImage(_floorType,var_1256,var_1258,64,this,"window_romantic_wide");
