package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_968:IButtonWindow;
      
      private var var_967:ITextFieldWindow;
      ...
      override public function dispose() : void
      {
         ...
         if(var_968 != null)
         {
            var_968.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         if(var_967 != null)
         {
            var_967.removeEventListener(WindowKeyboardEvent.const_151,windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         var_968 = _window.findChildByName("redeem") as IButtonWindow;
         if(var_968 != null)
         {
            var_968.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         var_967 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(var_967 != null)
         {
            var_967.addEventListener(WindowKeyboardEvent.const_151,windowKeyEventProcessor);
         }
      }
