package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PetsCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function getPurchaseParameters() : String
      {
         ...
         if(var_427 >= var_313.length)
         {
            return "";
         }
         var petColor:IPetColor = var_313[var_427] as IPetColor;
         var color:uint = petColor.rgb;
         var breed:IBreed = var_604[var_1556] as IBreed;
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var_427 = param1.index;
         if(var_427 < 0 || var_427 > var_313.length)
         {
            var_427 = 0;
         }
         updateImage();
      ...
      private function onApproveNameResult(param1:CatalogWidgetApproveNameResultEvent) : void
      {
         ...
         (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(var_599.getWithIndex(0),page,p);
      }
      ...
      override public function init() : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_152,onTextWindowEvent);
         var_599 = new Map();
         ...
         var_891 = getPetTypeIndexFromProduct(_loc5_.localizationId);
         var_313 = [];
         var_604 = [];
         if(page && false && page.viewer.catalog)
         {
            ...
            {
               _loc11_ = _loc10_.avatarRenderManager.petDataManager.getPetData(var_891);
               if(_loc11_)
               {
         ...
         while(_loc6_ < var_604.length)
         {
            ...
            _loc3_.push(_loc4_.getKey(getRaceLocalizationKey(var_891,_loc12_.id),getRaceLocalizationKey(var_891,_loc12_.id)));
            _loc6_++;
         }
         var_599.add(var_891,_loc5_);
         ...
         events.addEventListener(WidgetEvent.const_785,onApproveNameResult);
         _loc5_ = var_599.getWithIndex(0);
         if(_loc5_ != null)
         {
      ...
      {
         var _loc7_:* = null;
         var _loc1_:Offer = var_599.getWithIndex(0);
         if(_loc1_ == null)
         {
            return;
         }
         ...
         if(var_427 >= 0 && var_427 < var_313.length)
         {
            _loc7_ = var_313[var_427] as IPetColor;
            if(_loc7_ != null)
            {
               _loc2_ = uint(_loc7_.rgb);
            }
         }
         var _loc3_:IBreed = var_604[var_1556] as IBreed;
         var _loc4_:IAvatarImage = (page.viewer.catalog as HabboCatalog).avatarRenderManager.createPetImageNew(var_891,_loc3_.id,_loc2_,AvatarScaleType.const_51);
         if(_loc4_ == null)
         {
            return;
         }
         _loc4_.initActionAppends();
         _loc4_.appendAction(AvatarAction.const_307,AvatarAction.const_662);
