package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private var var_1297:MarketPlaceOfferData;
      
      private const const_1388:int = 1;
      
      private const const_1619:int = 40;
      
      private var var_504:IWindowContainer;
      
      private const const_1389:int = 2;
      ...
      private const const_1618:int = 10;
      ...
      private function updateList(param1:Map) : void
      {
         ...
         if(!var_504)
         {
            ...
            var_504 = _loc4_.buildFromXML(_loc3_) as IWindowContainer;
         }
         if(!var_504)
         {
            return;
         ...
         updateStatusDisplay(const_1389,_loc2_.length);
         if(!var_420)
         {
            var_420 = new Timer(25);
            var_420.addEventListener(TimerEvent.TIMER,onPopulationTimer);
         }
         var_879 = 0;
         populateList();
         var_420.start();
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         if(!marketPlace || !param2 || !_itemList || !var_599)
         {
            return;
         }
         var _loc3_:* = [];
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !_itemList || !var_504 || true)
         {
            return;
         }
         var _loc2_:IWindowContainer = var_504.clone() as IWindowContainer;
      ...
      {
         var _loc5_:* = null;
         updateStatusDisplay(const_1388);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
         ...
         if(_loc6_ && _loc6_.selection >= 0 && _loc6_.selection < var_419.length)
         {
            _loc4_ = 0;
         }
      ...
      override public function dispose() : void
      {
         ...
         if(var_420)
         {
            var_420.removeEventListener(TimerEvent.TIMER,onPopulationTimer);
            var_420 = null;
         }
      }
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(var_879 >= var_599.length)
            {
               return true;
            }
            addListItem(var_599.getWithIndex(var_879));
            ++var_879;
            _loc1_++;
         }
         return false;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  marketPlace.buyOffer(var_1297.offerId);
                  hideDetails();
            }
            return;
         }
      ...
      private function onWidgetEvent(param1:WindowEvent, param2:IWindow = null) : void
      {
         ...
         else if(param1.type == WindowEvent.const_152)
         {
      ...
      private function selectSearchCategory(param1:String) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.populate(getSortKeys(var_419));
            _loc7_.selection = 0;
         }
      }
