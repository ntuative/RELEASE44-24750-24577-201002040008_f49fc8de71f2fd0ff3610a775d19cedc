package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1423:Point;
      
      private var var_1806:Array;
      
      private var var_549:IItemGridWindow;
      
      private var var_90:IBitmapWrapperWindow;
      
      private var var_1146:ITextWindow;
      
      private var var_1183:IScrollbarWindow;
      
      protected var var_1343:XML;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(var_549 != null)
         {
            var_549.visible = false;
            var_549.destroyGridItems();
         }
         if(var_1183 != null)
         {
         ...
         if(_loc3_ != null)
         {
            var_1146.text = "${" + _loc3_.name + "}";
            var_1145.text = "${" + _loc3_.description + "}";
         }
         else
         {
            var_1146.text = "${" + _loc2_.localizationId + "}";
            var_1145.text = "${" + _loc2_.localizationId + "}";
         }
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_373:
                  _loc4_ = var_1184.clone();
                  if(var_549 != null)
                  {
                     var_549.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_549,var_1183,var_1343);
                  }
                  break;
               case Offer.const_347:
               case Offer.const_451:
                  ...
                  switch(_loc6_.productType)
                  {
                     ...
                     case ProductTypeEnum.const_193:
                        ...
                        _loc4_ = new BitmapData(var_90.width,var_90.height,false,_loc10_);
                        _loc11_ = null;
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              ...
                              _loc13_.appendAction(AvatarAction.const_307,AvatarAction.const_649);
      ...
      {
         var_1146 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         var_1145 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_90 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1423 = new Point(var_90.x,var_90.y);
         var_549 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1183 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_549 == null)
         {
            Logger.log("[ProductViewCatalogWidget] Bundle Grid not initialized!");
         }
         var _loc1_:XmlAsset = page.viewer.catalog.assets.getAssetByName("gridItem") as XmlAsset;
         var_1343 = _loc1_.content as XML;
         var _loc2_:BitmapDataAsset = page.viewer.catalog.assets.getAssetByName("ctlg_dyndeal_background") as BitmapDataAsset;
         var_1184 = _loc2_.content as BitmapData;
      ...
      private function addEffectSprites(param1:BitmapData, param2:IAvatarImage, param3:Point, param4:Point, param5:Boolean = true) : void
      {
         ...
         {
            _loc7_ = _window.getChildIndex(var_90);
      ...
      private function setPreviewImage(param1:BitmapData, param2:Point = null) : void
      {
         ...
         if(true)
         {
            var_90.bitmap = new BitmapData(var_90.width,var_90.height,true,16777215);
         }
         var_90.bitmap.fillRect(var_90.bitmap.rect,16777215);
         var _loc3_:Point = new Point((0 - param1.width) / 2,(0 - param1.height) / 2);
         var_90.bitmap.copyPixels(param1,param1.rect,_loc3_,null,null,true);
         var_90.invalidate();
         var_90.x = var_1423.x;
         var_90.y = var_1423.y;
         if(param2 != null)
