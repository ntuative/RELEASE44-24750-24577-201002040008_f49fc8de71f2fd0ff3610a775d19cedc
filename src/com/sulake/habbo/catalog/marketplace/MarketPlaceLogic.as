package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      public const const_1623:int = 3;
      
      public const const_1545:int = 2;
      ...
      private var var_1572:MarketplaceItemStats;
      ...
      private var var_207:MarketplaceConfirmationDialog;
      ...
      {
         if(!var_321 || !var_94 || !var_94.getPurse())
         {
            return;
         }
         var _loc2_:MarketPlaceOfferData = var_321.getValue(param1) as MarketPlaceOfferData;
         if(var_94.getPurse().credits < _loc2_.price)
         {
            var_94.showNotEnoughCreditsAlert("${catalog.alert.notenough.credits.description}");
            return;
         }
         showConfirmation(const_1426,_loc2_);
      }
      ...
      public function requestOffers(param1:int, param2:int, param3:String, param4:int) : void
      {
         ...
         if(var_94)
         {
            var_94.getPublicMarketPlaceOffers(param1,param2,param3,param4);
         }
      }
      
      public function requestOwnItems() : void
      {
         var_94.getOwnMarketPlaceOffers();
      }
      ...
      {
         if(param1.furniCategoryId != var_1575 || param1.furniTypeId != var_1573)
         {
            return;
         }
         var_1572 = param1;
      ...
      {
         var_94.getPublicMarketPlaceOffers(-1,-1,param1,-1);
      }
      ...
      private function getConfiguration() : void
      {
         ...
         var_94.connection.send(new GetMarketplaceConfigurationMessageComposer());
      }
      ...
      public function onBuyResult(param1:IMessageEvent) : void
      {
         ...
         {
            var_321.remove(parser.requestedOfferId);
            _visualization.listUpdatedNotify();
            if(_windowManager != null)
            {
         ...
         {
            updateItem = var_321.getValue(parser.requestedOfferId) as MarketPlaceOfferData;
            if(updateItem)
            {
               updateItem.offerId = parser.offerId;
               updateItem.price = parser.newPrice;
               --updateItem.offerCount;
               var_321.add(parser.offerId,updateItem);
            }
            var_321.remove(parser.requestedOfferId);
            showConfirmation(const_1545,updateItem);
            _visualization.listUpdatedNotify();
         }
      ...
      public function redeemSoldOffers() : void
      {
         var _loc2_:int = 0;
         var _loc3_:* = null;
         var _loc1_:Array = var_615.getKeys();
         for each(_loc2_ in _loc1_)
         {
            _loc3_ = var_615.getValue(_loc2_);
            if(_loc3_.status == MarketPlaceOfferState.const_414)
            {
               var_615.remove(_loc2_);
            }
         }
         var_94.redeemSoldMarketPlaceOffers();
         _visualization.listUpdatedNotify();
      }
      ...
      public function onOwnOffers(param1:IMessageEvent) : void
      {
         ...
         var_1571 = _loc3_.creditsWaiting;
         var_615 = new Map();
         for each(_loc4_ in _loc3_.offers)
         {
            ...
            var_615.add(_loc4_.offerId,_loc5_);
         }
      ...
      {
         var_94.getPublicMarketPlaceOffers(param1,-1,"",-1);
      }
      ...
      private function showConfirmation(param1:int, param2:MarketPlaceOfferData) : void
      {
         if(!var_207)
         {
            var_207 = new MarketplaceConfirmationDialog(this,var_94,_roomEngine);
         }
         var_207.showConfirmation(param1,param2);
      }
      ...
      public function onOffers(param1:IMessageEvent) : void
      {
         ...
         for each(_loc4_ in _loc3_.offers)
         {
            ...
            var_321.add(_loc4_.offerId,_loc6_);
         }
         if(_visualization == null)
         {
            return;
      ...
      {
         requestOffers(var_1576,var_1574,var_1577,var_1578);
      }
      ...
      {
         var_94.redeemExpiredMarketPlaceOffer(param1);
      }
      ...
      public function requestItemStats(param1:int, param2:int) : void
      {
         if(var_94)
         {
            var_1573 = param2;
            var_1575 = param1;
            var_94.getMarketplaceItemStats(param1,param2);
         }
      }
