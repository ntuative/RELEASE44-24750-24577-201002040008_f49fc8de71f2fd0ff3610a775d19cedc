package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog
   {
      ...
      private var var_206:Purse;
      
      private var var_2081:Boolean = true;
      ...
      private var var_207:PurchaseConfirmationDialog;
      
      private var var_844:IHabboSoundManager;
      
      private var var_348:ICatalogViewer;
      
      private var var_2082:Boolean = true;
      
      private var _roomEngine:IRoomEngine;
      
      private var var_414:ICatalogNavigator;
      
      private var var_1207:IAvatarRenderManager;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_95:RecyclerLogic;
      
      private var _mainContainer:IWindowContainer;
      
      private var var_2083:GiftWrappingConfiguration;
      ...
      public function method_12(param1:int) : Boolean
      {
         if(var_25 == null)
         {
            return false;
         }
         return var_25.method_12(param1);
      }
      
      public function getProductData(param1:String) : IProductData
      {
         return var_526.getProductData(param1);
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         var_206.credits = _loc3_.balance;
         method_1();
         if(!var_2081 && var_844 != null)
         {
            var_844.playSound(HabboSoundTypesEnum.const_920);
         }
         var_2081 = false;
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = var_526.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_74)
         {
            _loc3_ = var_526.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      private function onRecyclerStatus(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || var_95 == null)
         {
            return;
         }
         var_95.setSystemStatus(_loc2_.recyclerStatus,_loc2_.recyclerTimeoutSeconds);
      }
      ...
      private function onIsOfferGiftable(param1:IsOfferGiftableMessageEvent) : void
      {
         ...
         {
            this.var_207.onIsOfferGiftable(param1.getParser());
         }
      }
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_91:
               ...
               if(var_95 != null)
               {
                  var_95.setRoomSessionActive(true);
               }
               break;
            case RoomSessionEvent.const_99:
               ...
               if(var_95 != null)
               {
                  var_95.setRoomSessionActive(false);
               }
         }
      }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         var_95.setFinished(_loc2_.recyclerFinishedStatus,_loc2_.prizeId);
      }
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         {
            if(false && "true" == var_170.getKey("client.credits.embed.enabled"))
            {
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         var_2083 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(var_191 != null && _loc2_)
         {
            var_191.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_46,HabboToolbarIconEnum.CATALOGUE,_mainContainer));
         }
         if(false)
         {
            _events.dispatchEvent(new Event(HabboCatalogTrackingEvent.HABBO_CATALOG_TRACKING_EVENT_OPEN));
            if(var_95 != null && getCurrentLayoutCode() == "recycler")
            {
               var_95.activate();
            }
         }
      ...
      private function createMainWindow() : void
      {
         ...
         _loc3_.setParamFlag(WindowParam.const_204,false);
      ...
      private function createCatalogNavigator() : void
      {
         ...
         var_414 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      {
         var_95 = new RecyclerLogic(this,_windowManager);
         getRecyclerPrizes();
      }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         var_206.clubDays = Math.max(0,_loc2_.daysToPeriodEnd);
         var_206.clubPeriods = Math.max(0,_loc2_.periodsSubscribedAhead);
         method_1();
      ...
      public function showPurchaseConfirmation(param1:Offer, param2:ICatalogPage, param3:String = "") : void
      {
         ...
         else
         {
            if(var_207 == null)
            {
               var_207 = new PurchaseConfirmationDialog(_localization);
            }
            _loc7_ = [];
            if(_friendList != null)
            {
            ...
            var_207.showOffer(this,param1,param2,param3,_loc7_);
      ...
      {
         var_191.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_116,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         var_414.buildCatalogIndex(_loc2_);
         if(var_1033 != "")
         {
            var_414.openPage(var_1033);
            var_1033 = "";
         }
         else
         {
            var_414.openFrontPage();
         }
      }
      ...
      {
         if(param1 == null || var_348 == null)
         {
            return;
         }
         var _loc2_:ApproveNameMessageParser = param1.getParser();
         var_348.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result));
      }
      ...
      private function onRecyclerPrizes(param1:IMessageEvent) : void
      {
         ...
         var_95.storePrizeTable(_loc2_.prizeLevels);
      }
      ...
      private function method_1() : void
      {
         ...
         _localization.registerParameter("catalog.purse.creditbalance","balance",String(var_206.credits));
         _localization.registerParameter("catalog.purse.pixelbalance","balance",String(var_206.pixels));
         _localization.registerParameter("catalog.purse.clubdays","days",String(var_206.clubDays));
         _localization.registerParameter("catalog.purse.clubdays","months",String(var_206.clubPeriods));
         if(false)
         {
            return;
         }
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return var_348.getCurrentLayoutCode();
      }
      ...
      private function onPixelsBalance(param1:IMessageEvent) : void
      {
         ...
         var_206.pixels = _loc2_.amount;
         method_1();
         if(!var_2082 && var_844 != null)
         {
            var_844.playSound(HabboSoundTypesEnum.const_984);
         }
         var_2082 = false;
      }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         var_348.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers);
      }
      ...
      private function onRentableBotDefinitions(param1:IMessageEvent) : void
      {
         ...
         var_348.dispatchWidgetEvent(new RentableBotDefinitionWidgetEvent(_loc2_.rentableBots));
      }
      ...
      private function createCatalogViewer() : void
      {
         ...
         var_348 = new CatalogViewer(this,_loc1_,_roomEngine) as ICatalogViewer;
      }
