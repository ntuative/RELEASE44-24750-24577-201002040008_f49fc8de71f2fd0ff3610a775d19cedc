package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      public function AchievementNotification(param1:String, param2:int, param3:IAssetLibrary, param4:IHabboWindowManager, param5:IHabboLocalizationManager, param6:IHabboConfigurationManager, param7:ISessionDataManager)
      {
         ...
         var_209 = param5.getKey("notifications.text.achievement");
         registerBadgeParameters("notifications.text.achievement_facebook");
         var_1634 = param5.getKey("notifications.text.achievement_facebook");
         setText("achievement_info",var_209);
      ...
      public function dispose() : void
      {
         if(var_526 != null)
         {
            var_526.events.removeEventListener(BadgeImageReadyEvent.const_109,onBadgeImageReady);
            var_526 = null;
         }
         if(_window != null)
         {
      ...
      private function method_9(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               if(false)
               {
                  ExternalInterface.call("FlashExternalInterface.postAchievement",var_619,var_1634);
               }
               dispose();
               break;
      ...
      {
         _localizations.registerParameter(param1,"badge_name",_localizations.getKey("badge_name_" + var_619,var_619));
         _localizations.registerParameter(param1,"badge_desc",_localizations.getKey("badge_desc_" + var_619,var_619));
         _localizations.registerParameter(param1,"level",var_1633.toString());
         _localizations.registerParameter(param1,"name",var_526.userName);
         _localizations.registerParameter(param1,"realname",var_526.realName);
      }
   }
}
