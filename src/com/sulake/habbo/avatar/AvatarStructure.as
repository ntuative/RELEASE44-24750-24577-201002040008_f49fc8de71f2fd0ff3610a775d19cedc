package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_397:PartSetsData;
      
      private var var_1903:PartOffsetData;
      
      private var var_821:AvatarActionManager;
      
      private var var_156:IAssetLibrary;
      
      private var var_2285:IAssetLibrary;
      
      private var var_1336:Boolean = false;
      
      private var var_1904:AvatarRenderManager;
      
      private var var_468:FigureData;
      ...
      private var var_1460:AvatarStructureDownloadSet;
      
      private var var_666:AnimationManager;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_156 = param2;
         var_2285 = param3;
         var_468 = new FigureData();
         var_397 = new PartSetsData();
         _animationData = new AnimationData();
         var_1460 = new AvatarStructureDownloadSet();
         var_666 = new AnimationManager();
         var_667 = param4;
         var_1903 = PartOffsetData.getInstance(param3);
         init();
      }
      ...
      {
         return var_821.getActionDefinitionWithState(param1);
      }
      ...
      {
         return var_821.getCanvasOffsets(param1,param2,param3);
      }
      
      public function getActionDefinition(param1:String) : ActionDefinition
      {
         return var_821.getActionDefinition(param1);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = var_666.getAnimation(_loc6_);
            if(_loc7_ != null)
            {
               ...
               if(_loc7_.hasAddData())
               {
                  for each(_loc9_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc12_ = var_397.addPartDefinition(_loc11_);
         ...
         {
            _loc2_ = var_397.getActiveParts(param1.definition);
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1231[param3];
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int) : Array
      {
         ...
         var _loc6_:ActionDefinition = var_821.getDefaultActionType();
         var _loc7_:Array = var_397.getActiveParts(param3.definition);
         if(param3.definition.isAnimation)
         {
            _loc17_ = param3.definition.state + "." + param3.actionParameter;
            _loc8_ = var_666.getAnimation(_loc17_);
            if(_loc8_ != null)
            {
         ...
         for each(_loc14_ in param2.getPartTypeIds())
         {
            ...
            _loc23_ = var_468.getSetType(_loc14_);
            if(_loc23_ != null)
            {
               _loc24_ = var_468.getPalette(_loc23_.paletteID).getColor(_loc22_);
               ...
               if(_loc25_ != null)
               {
                  ...
                  for each(_loc26_ in _loc25_.parts)
                  {
                     if(_loc9_.indexOf(_loc26_.type) > -1)
                     {
                        ...
                        _loc13_ = var_397.getPartDefinition(_loc26_.type);
         ...
         for each(_loc11_ in _loc9_)
         {
            ...
            if(!_loc33_)
            {
               if(_loc7_.indexOf(_loc11_) > -1)
               {
                  ...
                  {
                     _loc13_ = var_397.getPartDefinition(_loc11_);
                     _loc35_ = false;
                     _loc36_ = 1;
      ...
      {
         Logger.log("[AvatarStructure] Structure " + var_667 + " ready to go!");
         if(var_667 == AvatarType.const_89)
         {
            var_397.getPartDefinition("ri").appendToFigure = true;
            var_397.getPartDefinition("li").appendToFigure = true;
         }
         registerAnimations();
      ...
      public function initConfiguration(param1:IHabboConfigurationManager) : void
      {
         ...
         {
            case AvatarType.const_89:
               var_1460.add(new AvatarStructureDownload(var_156,_loc5_,var_468));
               break;
            case AvatarType.PET:
         }
         var_1460.addEventListener(AvatarStructureDownloadSet.DOWNLOAD_SET_DONE,onStructureReady);
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return var_666.getAnimation(param1);
      }
      ...
      {
         var_821 = new AvatarActionManager(var_156,var_667);
      }
      ...
      private function registerAnimations() : void
      {
         ...
         while(var_156.hasAsset("dance" + _loc1_))
         {
            ...
            var_666.registerAnimation(this,_loc2_);
            _loc1_++;
         }
         _loc1_ = 1;
      ...
      public function getPartColor(param1:AvatarFigureContainer, param2:String) : IPartColor
      {
         ...
         var _loc4_:ISetType = var_468.getSetType(param2);
         if(_loc4_ == null)
         {
            return null;
         }
         return var_468.getPalette(_loc4_.paletteID).getColor(_loc3_);
      }
      
      public function sortActions(param1:Array) : Array
      {
         return var_821.sortActions(param1);
      }
   }
}
