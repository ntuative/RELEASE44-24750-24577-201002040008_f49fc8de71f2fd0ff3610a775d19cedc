package com.sulake.habbo.avatar.figuredata
{
   ...
   public class FigureDataView
   {
      ...
      private var var_436:IBitmapWrapperWindow;
      
      private var _window:IWindowContainer;
      
      private var var_1239:BitmapData;
      ...
      public function FigureDataView(param1:IHabboWindowManager, param2:IAssetLibrary)
      {
         ...
         var_1239 = _loc4_.content as BitmapData;
         if(_window != null)
         {
            var_436 = _window.findChildByName("bitmap") as IBitmapWrapperWindow;
         }
      }
      ...
      {
         var_436.bitmap = new BitmapData(var_436.width,var_436.height,true,16777215);
         var_436.bitmap.copyPixels(var_1239,var_1239.rect,new Point(0,0 - 0 - 8));
         var_436.bitmap.copyPixels(param1,param1.rect,new Point(4,0),null,null,true);
      }
   }
}
