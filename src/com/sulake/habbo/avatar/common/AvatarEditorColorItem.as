package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorColorItem
   {
      ...
      private const const_1603:int = 8947848;
      
      private const const_1604:int = 13421772;
      
      private var _isSelected:Boolean = false;
      
      private var var_1381:BitmapData;
      ...
      private var var_770:IPartColor;
      
      private var var_1139:BitmapData;
      
      private var var_945:BitmapData;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(var_707.width,var_707.height,true,0);
            _loc1_.bitmap.copyPixels(var_707,var_707.rect,new Point(0,0));
         }
         var _loc2_:IBitmapWrapperWindow = _window.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(var_1139.width,var_1139.height,true,0);
            _loc4_ = var_1139.clone();
            _loc4_.colorTransform(_loc4_.rect,var_770.colorTransform);
         ...
         if(_loc3_ != null)
         {
            _loc3_.bitmap = new BitmapData(var_945.width,var_945.height,true,16777215);
            _loc3_.bitmap.copyPixels(var_945,var_945.rect,new Point(0,0),null,null,true);
            if(!_isSelected)
            {
         ...
         if(false)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               _loc5_.bitmap.copyPixels(var_1381,var_1381.rect,new Point(0,0),null,null,true);
            }
         }
      }
