package com.sulake.habbo.avatar.common
{
   public class CategoryData
   {
      ...
      public function get currentColour() : AvatarEditorColorItem
      {
         if(var_625 > -1)
         {
            return var_327[var_625] as AvatarEditorColorItem;
         }
         return null;
      }
      ...
      public function selectColour(param1:int) : AvatarEditorColorItem
      {
         ...
         if(var_625 >= 0)
         {
            _loc3_ = var_327[var_625];
            _loc3_.isSelected = false;
         }
         if(var_327.length > param1)
         {
            _loc2_ = var_327[param1] as AvatarEditorColorItem;
            _loc2_.isSelected = true;
         }
         var_625 = param1;
