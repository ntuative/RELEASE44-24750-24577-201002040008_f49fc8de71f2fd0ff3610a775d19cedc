package com.sulake.habbo.avatar.legs
{
   ...
   public class LegsView implements IAvatarEditorCategoryView
   {
      ...
      public function LegsView(param1:LegsModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         var_653["null"] = new AvatarEditorGridView(param1,FigureData.const_132,param2,param3);
         var_653["null"] = new AvatarEditorGridView(param1,FigureData.const_171,param2,param3);
         var_653["null"] = new AvatarEditorGridView(param1,FigureData.const_134,param2,param3);
         attachImages();
