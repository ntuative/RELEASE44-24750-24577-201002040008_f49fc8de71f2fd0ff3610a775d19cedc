package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private var var_408:IWindowContainer;
      ...
      private var var_1027:IFigureData;
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return var_1027.getSetType(param1);
      }
      ...
      private function init() : void
      {
         ...
         if(!var_1026)
         {
            var_692 = new Dictionary();
            var_692["null"] = new FigureData(this);
            var_692["null"] = new FigureData(this);
            _loc1_ = var_692["null"];
            _loc2_ = var_692["null"];
            ...
            _loc2_.loadAvatarData("hr-681-41.hd-620-9.ch-879-90.lg-700-85.sh-735-68",FigureData.const_83);
            var_345 = new Map();
            var_345.add(AvatarEditorCategory.const_912,new GenericModel(this));
            var_345.add(AvatarEditorCategory.const_47,new HeadModel(this));
            var_345.add(AvatarEditorCategory.const_315,new TorsoModel(this));
            var_345.add(AvatarEditorCategory.const_1141,new LegsModel(this));
            var_345.add(AvatarEditorCategory.const_640,new WardrobeModel(this));
            var_1026 = true;
         }
      }
      ...
      private function requestSavedOutfits() : void
      {
         ...
         var _loc1_:WardrobeModel = var_345.getValue(AvatarEditorCategory.const_640);
         if(_loc1_ != null)
         {
         }
      }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return var_345.getValue(AvatarEditorCategory.const_640);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return var_1027.getPalette(param1);
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc7_ != null)
         {
            ...
            for each(_loc13_ in _loc10_.colors)
            {
               ...
               {
                  _loc16_ = new AvatarEditorColorItem(AvatarEditorView.var_1557.clone() as IWindowContainer,param1,_loc13_);
                  _loc4_.push(_loc16_);
                  if(_loc13_.id == _loc12_ && param2 != FigureData.const_56)
                  {
                     _loc11_ = _loc13_;
                  }
               }
            ...
            if(_loc8_)
            {
               ...
               _loc6_ = new AvatarEditorGridItem(AvatarEditorView.var_1325.clone() as IWindowContainer,param1,null,null,false);
               _loc6_.iconImage = _loc18_;
               _loc3_.push(_loc6_);
            }
            _loc14_ = param2 != FigureData.const_56;
            for each(_loc5_ in _loc7_.partSets)
            {
               _loc19_ = false;
               _loc20_ = true;
               if(_loc5_.gender == FigureData.const_1282)
               {
                  _loc19_ = true;
               }
               ...
               {
                  _loc6_ = new AvatarEditorGridItem(AvatarEditorView.var_1325.clone() as IWindowContainer,param1,_loc5_,_loc11_,_loc14_);
                  _loc3_.push(_loc6_);
               }
            }
         }
      ...
      {
         var _loc2_:IAvatarEditorCategoryModel = var_345.getValue(param1) as IAvatarEditorCategoryModel;
         if(_loc2_ != null)
         {
      ...
      public function openEditor(param1:IWindowContainer = null) : Boolean
      {
         ...
         else
         {
            if(var_408 == null)
            {
               var_408 = _windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_55,HabboWindowStyle.const_37,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               var_408.addChild(_view.window);
               var_408.center();
               var_408.visible = false;
            }
            var_408.visible = true;
         }
         _view.show();
         toggleAvatarEditorPage(AvatarEditorCategory.const_912);
         if(var_170 != null)
         {
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (var_1207 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,onAvatarRendererReady);
      }
      ...
      private function onInventoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (var_25 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_599,onHabboClubChanged);
      }
      
      private function onAvatarRendererReady(param1:Event = null) : void
      {
         var_1027 = var_1207.getFigureData(AvatarType.const_89);
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:Boolean = false) : void
      {
         ...
         var_1028 = param3;
         var _loc4_:FigureData = var_692[param2];
         if(_loc4_ == null)
         {
            return;
         }
