package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         _colorTransform = new ColorTransform(var_1552,var_1551,var_1553,_alphaMultiplier);
         var_929 = generatePaletteMapForGrayscale(var_1656,var_1657);
      }
      
      public function get reds() : Array
      {
         return var_929.getValue("reds") as Array;
      }
      ...
      {
         return var_929.getValue("blues") as Array;
      }
      
      public function get greens() : Array
      {
         return var_929.getValue("greens") as Array;
      }
      ...
      {
         return var_929.getValue("alphas") as Array;
      }
