package com.sulake.habbo.avatar.head
{
   ...
   public class HeadView implements IAvatarEditorCategoryView
   {
      ...
      private var var_499:IWindowContainer;
      ...
      public function HeadView(param1:HeadModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         var_653 = new Dictionary();
         var_653["null"] = new AvatarEditorGridView(param1,FigureData.const_128,param2,param3);
         var_653["null"] = new AvatarEditorGridView(param1,FigureData.const_141,param2,param3);
         var_653["null"] = new AvatarEditorGridView(param1,FigureData.const_136,param2,param3);
         var_653["null"] = new AvatarEditorGridView(param1,FigureData.const_142,param2,param3);
         var_653["null"] = new AvatarEditorGridView(param1,FigureData.const_131,param2,param3);
         attachImages();
      ...
      private function setElementImage(param1:IBitmapWrapperWindow, param2:Boolean) : void
      {
         ...
         if(result.length)
         {
            ...
            {
               bmp.bitmap = new BitmapData(bmp.width,bmp.height,false,AvatarEditorView.var_1064);
      ...
      private function changeToCurrentTab() : void
      {
         ...
         var _loc2_:AvatarEditorGridView = var_653[var_1348];
         if(_loc2_ == null)
         {
            return;
         }
