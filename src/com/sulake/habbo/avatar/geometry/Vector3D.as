package com.sulake.habbo.avatar.geometry
{
   public class Vector3D
   {
      ...
      private var var_909:Number;
      
      private var var_93:Number;
      ...
      public function cross(param1:Vector3D) : Vector3D
      {
         ...
         _loc2_.y = var_92 * param1.x - var_93 * param1.z;
         _loc2_.z = var_93 * param1.y - _y * param1.x;
         return _loc2_;
      }
      ...
      {
         return Math.sqrt(var_93 * var_93 + _y * _y + var_92 * var_92);
      }
      ...
      {
         return var_93 * param1.x + _y * param1.y + var_92 * param1.z;
      }
      ...
      {
         return "Vector3D: (" + var_93 + "," + _y + "," + var_92 + "," + var_909 + ")";
      }
