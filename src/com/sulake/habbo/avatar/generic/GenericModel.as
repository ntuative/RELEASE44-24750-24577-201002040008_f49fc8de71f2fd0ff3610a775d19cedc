package com.sulake.habbo.avatar.generic
{
   ...
   public class GenericModel implements IAvatarEditorCategoryModel
   {
      ...
      public function toggleItemSelection(param1:String, param2:int) : void
      {
         ...
         _controller.figureData.savePartData(FigureData.const_56,_loc4_.id,_loc3_.currentColourId,true);
      }
      ...
      private function init() : void
      {
         ...
         var_345["null"] = _controller.generateDataContent(this,FigureData.const_56);
      ...
      public function categorySwitch(param1:String) : void
      {
         ...
         switch(param1)
         {
            case FigureData.const_80:
               _controller.gender = FigureData.const_80;
               break;
            case FigureData.const_83:
               _controller.gender = FigureData.const_83;
         }
      }
      ...
      private function updateCategoryData(param1:String) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         var _loc2_:int = _controller.figureData.getPartSetId(FigureData.const_56);
         var _loc3_:int = _controller.figureData.getColourId(FigureData.const_56);
         ...
         for each(_loc5_ in _loc4_.data)
         {
            ...
            _loc7_ = _controller.avatarRenderManager.createAvatarImage(_loc6_,AvatarScaleType.const_51);
      ...
      public function toggleColourSelection(param1:String, param2:int) : void
      {
         ...
         _controller.figureData.savePartSetColourId(FigureData.const_56,_loc3_.currentColourId,true);
         updateView();
      }
   }
}
