package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class Outfit implements IOutfit
   {
      ...
      {
         var_1394 = _controller.avatarRenderManager.createAvatarImage(figure,AvatarScaleType.const_95);
         var_1394.setDirection(AvatarSetType.const_38,int(FigureData.const_887));
         _image = var_1394.getImage(AvatarSetType.const_38);
         _view.udpate(_image);
      }
