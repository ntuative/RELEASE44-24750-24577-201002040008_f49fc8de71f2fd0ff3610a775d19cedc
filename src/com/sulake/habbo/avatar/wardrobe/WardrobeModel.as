package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeModel implements IAvatarEditorCategoryModel
   {
      ...
      public static const const_1524:String = "hot_looks";
      ...
      public function WardrobeModel(param1:HabboAvatarEditor, param2:String = "")
      {
         ...
         _gender = param2;
         var_158 = new Array();
         var_576 = new Dictionary();
         var_576["null"] = new Array();
         var_576["null"] = new Array();
         var_576["undefined.index"] = 0;
         var_576["undefined.index"] = 0;
         initMyLooks();
         requestHotLooks();
      }
      ...
      private function onHotLooksConfiguration(param1:Event = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            for each(_loc5_ in _loc4_.habbo)
            {
               ...
               (var_576[_loc6_.gender] as Array).push(_loc6_);
            }
         }
         else
         {
