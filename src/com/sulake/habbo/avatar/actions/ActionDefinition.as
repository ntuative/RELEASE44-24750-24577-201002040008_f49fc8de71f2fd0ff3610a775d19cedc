package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         var_47 = String(param1.@state);
         var_2158 = parseInt(param1.@precedence);
         var_2157 = String(param1.@activepartset);
         var_2161 = String(param1.@assetpartdefinition);
         var_2156 = String(param1.@lay);
         var_1083 = String(param1.@geometrytype);
         var_1834 = Boolean(parseInt(param1.@main));
         var_2159 = Boolean(parseInt(param1.@name_1));
         var_2160 = Boolean(parseInt(param1.@animation));
         var _loc2_:String = String(param1.@prevents);
         if(_loc2_ != "")
         {
            var_1147 = _loc2_.split(",");
         }
      ...
      {
         return var_1147.concat(getTypePrevents(param1));
      }
