package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, ICoreUpdateReceiver
   {
      ...
      private static const const_738:uint = 11;
       
      
      private var var_218:LatencyTracker = null;
      
      private var var_219:PerformanceTracker = null;
      
      private var var_489:IAdManager;
      
      private var _roomEngine:IRoomEngine = null;
      
      private var var_373:IHabboHelp;
      
      private var _coreComponent:CoreComponent;
      
      private var var_939:int = -1;
      
      private var var_1135:LagWarningLogger = null;
      
      private var var_764:IHabboWindowManager;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_219 = new PerformanceTracker();
         var_218 = new LatencyTracker();
         var_1135 = new LagWarningLogger();
         var_1136 = new Array(const_738);
         var _loc4_:int = 0;
         while(_loc4_ < const_738)
         {
            var_1136[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1226,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_501,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_824,String(0));
         }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               ...
               break;
            case HabboCommunicationEvent.const_657:
               trackLoginStep(HabboLoginTrackingStep.const_10,String(_communication.port));
               break;
      ...
      {
         var_94 = IHabboCatalog(param2) as IHabboCatalog;
         var_94.events.addEventListener(CatalogPageOpenedEvent.CATALOG_PAGE_OPENED,onCatalogPageOpened);
         var_94.events.addEventListener(HabboCatalogTrackingEvent.HABBO_CATALOG_TRACKING_EVENT_OPEN,onCatalogTrackingEvent);
         var_94.events.addEventListener(HabboCatalogTrackingEvent.HABBO_CATALOG_TRACKING_EVENT_CLOSE,onCatalogTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_328:
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_170)
         {
            Component(var_170).events.addEventListener(HabboConfigurationEvent.const_19,onConfigurationLoaded);
            if(var_218 != null)
            {
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_489.events.addEventListener(AdEvent.const_416,onRoomAdLoad);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_824,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_501,String(true));
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_657,onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_724,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_60,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_470,onHotelViewEvent);
      }
      ...
      private function onLagWarningEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case AvatarWalkWarpingWarningEvent.const_447:
               var_1135.registerWarning(LagWarningLogger.const_901);
         }
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(var_764)
            {
               var_764.release(new IIDHabboWindowManager());
               var_764 = null;
            }
            if(var_489)
            {
               var_489.release(new IIDHabboAdManager());
               var_489 = null;
            }
            if(_navigator)
            {
            ...
            if(var_94)
            {
               if(true)
               {
                  var_94.events.removeEventListener(HabboCatalogTrackingEvent.HABBO_CATALOG_TRACKING_EVENT_CLOSE,onCatalogTrackingEvent);
                  var_94.events.removeEventListener(HabboCatalogTrackingEvent.HABBO_CATALOG_TRACKING_EVENT_OPEN,onCatalogTrackingEvent);
               }
               var_94.release(new IIDHabboCatalog());
               var_94 = null;
            }
            if(var_25)
            {
            ...
            if(var_171)
            {
               if(true)
               {
                  ...
                  Component(var_171).events.removeEventListener(HabboFriendListTrackingEvent.const_328,onFriendlistTrackingEvent);
               }
            ...
            if(var_373)
            {
               if(true)
               {
                  var_373.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
                  var_373.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
               }
               var_373.release(new IIDHabboHelp());
               var_373 = null;
            }
            if(_roomEngine)
            {
               if(true)
               {
                  Component(_roomEngine).events.removeEventListener(AvatarWalkWarpingWarningEvent.const_447,onLagWarningEvent);
               }
            }
      ...
      private function onConfigurationLoaded(param1:Event) : void
      {
         ...
         if(var_170)
         {
            Component(var_170).events.removeEventListener(HabboConfigurationEvent.const_19,onConfigurationLoaded);
         }
      }
      ...
      private function onLocalizationLoaded(param1:Event) : void
      {
         ...
         if(_localization)
         {
            Component(_localization).events.removeEventListener(LocalizationEvent.const_22,onLocalizationLoaded);
         }
      }
      
      private function onHelpReady(param1:IID, param2:IUnknown) : void
      {
         var_373 = param2 as IHabboHelp;
         var_373.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
         var_373.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
      }
      ...
      private function onCoreRunning(param1:Event) : void
      {
         ...
         {
            _coreComponent.events.removeEventListener(HabboLoginTrackingStep.const_15,onCoreRunning);
         }
      }
      ...
      {
         var_764 = IHabboWindowManager(param2);
         if(var_764)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         if(var_939 > -1 && _loc2_ < var_939)
         {
            ++var_1376;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + var_1376);
         }
         if(var_939 > -1 && _loc2_ - var_939 > 15000)
         {
            ++var_1377;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + var_1377);
         }
         var_939 = _loc2_;
         if(var_219 != null)
         {
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(_roomEngine).events.addEventListener(AvatarWalkWarpingWarningEvent.const_447,onLagWarningEvent);
         Component(_roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_244,onRoomAdClick);
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(var_171).events.addEventListener(HabboFriendListTrackingEvent.const_328,onFriendlistTrackingEvent);
      }
         ...
         if(param1.critical && !var_1699)
         {
            ...
            if(var_170)
            {
               if(var_170.keyExists("client.fatal.error.url"))
               {
                  ...
                  if(var_219 != null)
                  {
                     _loc4_["null"] = var_219.flashVersion;
                     _loc4_["null"] = var_219.averageUpdateInterval;
                  }
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(_localization)
         {
            Component(_localization).events.addEventListener(LocalizationEvent.const_22,onLocalizationLoaded);
         }
      }
      
      private function onHotelViewEvent(param1:Event) : void
      {
         if(param1.type == HabboHotelViewEvent.const_724)
         {
            trackLoginStep(HabboLoginTrackingStep.const_9);
         }
         else if(param1.type == HabboHotelViewEvent.const_470)
         {
