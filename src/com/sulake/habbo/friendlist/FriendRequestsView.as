package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1403:String = "no_reqs_info";
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_277 && _loc4_.state != FriendRequest.const_318)
            {
               _loc3_.addAcceptedRequest(_loc4_.requestId);
               _loc4_.state = FriendRequest.const_277;
      ...
      {
         var_1443 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         var_1444 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         var_1444.procedure = onDismissAllButtonClick;
         var_1443.procedure = onAcceptAllButtonClick;
         refreshButtons();
      }
      ...
      public function refreshShading(param1:FriendRequest, param2:Boolean) : void
      {
         ...
         param1.view.color = _friendList.laf.getRowShadingColor(FriendListTab.const_102,param2);
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         else if(param1.state == FriendRequest.const_277)
         {
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_1443,_loc1_);
         setEnabled(var_1444,_loc1_);
      }
      ...
      public function removeRequest(param1:FriendRequest) : void
      {
         ...
         var_59.removeListItem(param1.view);
         refreshButtons();
      }
      ...
      public function addRequest(param1:FriendRequest) : void
      {
         ...
         var_59.addListItem(param1.view);
         _friendList.friendRequests.refreshShading();
         refreshButtons();
      }
