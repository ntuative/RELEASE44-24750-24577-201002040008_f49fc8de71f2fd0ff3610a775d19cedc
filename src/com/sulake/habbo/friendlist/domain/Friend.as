package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_1449:int = "F".charCodeAt(0);
      
      public static const const_1448:int = "M".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         var_1149 = param1.followingAllowed && param1.online;
         var_532 = param1.figure;
         var_1153 = param1.motto;
         var_1151 = param1.lastAccess;
         var_1140 = param1.categoryId;
         var_1152 = param1.realName;
