package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_983:int = 0;
      
      public static const const_413:int = -1;
      
      public static const const_284:int = 100;
      ...
      {
         return Math.ceil(this.var_213.length / const_284);
      }
      ...
      {
         if(this.var_739 >= this.getPageCount())
         {
            this.var_739 = Math.max(0,this.getPageCount() - 1);
         }
      }
      ...
      {
         checkPageIndex();
         return Math.min((this.var_739 + 1) * const_284,this.var_213.length);
      }
