package com.sulake.habbo.friendlist
{
   ...
   public class FriendListTabsView
   {
      ...
      private function onTabClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            _friendList.trackFriendListEvent(HabboFriendListTrackingEvent.const_328);
         }
      }
      ...
      public function refresh(param1:String) : void
      {
         ...
         var_35.width = _friendList.tabs.tabContentWidth;
         var_35.findChildByName("bg").width = _friendList.tabs.tabContentWidth;
         var _loc2_:int = 1;
         for each(_loc3_ in _friendList.tabs.getTabs())
         {
            _loc4_ = var_35.getChildByName("flt_" + _loc3_.id) as IWindowContainer;
         ...
         var_35.height = _loc2_ + 1;
         var_35.findChildByName("bg").height = var_35.height;
