package com.sulake.habbo.friendlist
{
   ...
   public class SearchView implements ITabView, ISearchView
   {
      ...
      {
         var_693 = ITextFieldWindow(param1.findChildByName("search_str"));
         var_693.procedure = onSearchInput;
         var_693.addEventListener(WindowKeyboardEvent.const_151,onSearchStrInput);
      ...
      private function refreshShading() : void
      {
         ...
         {
            var_59.getListItemAt(_loc1_).color = _friendList.laf.getRowShadingColor(FriendListTab.const_306,_loc1_ % 2 == 1);
            _loc1_++;
         }
      }
      ...
      {
         var _loc10_:IWindowContainer = var_59.getListItemAt(param2) as IWindowContainer;
         if(_loc10_ == null)
         {
            if(!param1)
            {
      ...
      private function onSearchStrInput(param1:Event) : void
      {
         ...
         else
         {
            ...
            {
               var_693.text = _loc6_.substring(0,_loc5_);
            }
         }
      }
      ...
      private function findIndexFor(param1:int) : int
      {
         ...
         {
            if(var_59.getListItemAt(_loc2_).id == param1)
            {
               return _loc2_;
            }
            _loc2_++;
