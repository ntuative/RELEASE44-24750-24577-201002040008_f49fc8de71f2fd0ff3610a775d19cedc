package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      private var var_1619:IAvatarRenderManager;
      
      private var var_1350:AvatarSearchResults;
      
      private var var_135:IHabboMessenger;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_740:FriendRequests;
      
      private var var_1617:int;
      
      var var_345:FriendCategories;
      
      private var var_191:IHabboToolbar;
      
      private var var_1618:FriendListLookAndFeel;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_401:FriendListTabs;
      
      private var var_1620:IHabboNotifications;
      
      private var _localization:IHabboLocalizationManager;
      
      private var var_1349:OpenedToWebPopup;
      ...
      {
         var_1618 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         var_345 = new FriendCategories(new FriendCategoriesDeps(this));
         var_1350 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(var_1349 == null)
         {
            var_1349 = new OpenedToWebPopup(this);
         }
         var_1349.show(x,y);
      }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         var_740.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            var_740.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            var_401.findTab(FriendListTab.const_102).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(var_740.getCountOfOpenRequests() > 0 ? "2" : "0");
         var_191.events.dispatchEvent(_loc1_);
      }
      ...
      public function getFriend(param1:int) : IFriend
      {
         ...
         return var_345.findFriend(param1);
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_740 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            var_345.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_345.addCategory(new FriendCategory(FriendCategory.const_983,getText("friendlist.friends")));
         var_345.addCategory(new FriendCategory(FriendCategory.const_413,getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in getSortedFriends(_loc2_.friends))
         {
            var_345.addFriend(new Friend(_loc4_));
         }
         var_401 = new FriendListTabs(new FriendListTabsDeps(this));
         _loc5_ = new Timer(120000);
         _loc5_.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
         _loc5_.start();
         getBuddyRequests();
         registerListeners();
         var_191.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_116,HabboToolbarIconEnum.FRIENDLIST));
      ...
      {
         var_345.onFriendListUpdate(param1);
      ...
      {
         var _loc2_:IAvatarImage = var_1619.createAvatarImage(param1,AvatarScaleType.const_95);
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1619 = param2 as IAvatarRenderManager;
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var_740.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = var_401.findTab(FriendListTab.const_102);
      ...
      {
         var_1620 = param2 as IHabboNotifications;
      ...
      public function getFriendCount(param1:Boolean, param2:Boolean) : int
      {
         ...
         return this.var_345.getFriendCount(param1,param2);
      }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            _view.openFriendList();
            _loc1_ = var_401.findSelectedTab();
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_328));
            }
            else
            {
               switch(_loc1_.id)
      ...
      {
         var_191 = IHabboToolbar(param2) as IHabboToolbar;
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1350.searchReceived(_loc2_.friends,_loc2_.others);
