package com.sulake.habbo.localization
{
   ...
   public class HabboLocalizationManager extends CoreLocalizationManager implements IHabboLocalizationManager
   {
      ...
      public function HabboLocalizationManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.events.addEventListener(com.sulake.core.localization.enum.LocalizationEvent.const_22,onLocalizationLoaded);
      }
      ...
      private function onConfigurationReady(param1:Event = null) : void
      {
         ...
         if("HabboRoomWidgetLib_memenu_fx_pause" == var_170.getKey("use.default.localizations","HabboRoomWidgetLib_memenu_fx_pause"))
         {
      ...
      {
         events.dispatchEvent(new Event(com.sulake.habbo.localization.enum.LocalizationEvent.const_22));
      }
   }
}
