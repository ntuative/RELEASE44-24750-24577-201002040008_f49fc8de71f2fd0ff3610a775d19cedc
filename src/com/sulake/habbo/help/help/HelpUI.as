package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private var var_1727:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         _windowManager.registerLocalizationParameter("info.client.version","version","24750-24577-201002032340");
         var_191 = param5;
         var_110 = new Map();
         var_110.add(HabboHelpViewEnum.const_1156,IHelpViewController(new PlaceholderView(this,_windowManager,_assetLibrary)));
         var_110.add(HabboHelpViewEnum.const_150,IHelpViewController(new HelpMainView(this,_windowManager,_assetLibrary)));
         var_110.add(HabboHelpViewEnum.const_371,IHelpViewController(new FaqBrowseTopView(this,_windowManager,_assetLibrary)));
         var_110.add(HabboHelpViewEnum.const_257,IHelpViewController(new FaqBrowseCategoryView(this,_windowManager,_assetLibrary)));
         var_110.add(HabboHelpViewEnum.const_186,IHelpViewController(new FaqBrowseEntry(this,_windowManager,_assetLibrary)));
         var_110.add(HabboHelpViewEnum.const_523,IHelpViewController(new FaqBrowseSearchResults(this,_windowManager,_assetLibrary)));
         var_110.add(HabboHelpViewEnum.const_293,IHelpViewController(new CallForHelpTopicSelection(this,_windowManager,_assetLibrary)));
         var_110.add(HabboHelpViewEnum.const_698,IHelpViewController(new CallForHelpTextInput(this,_windowManager,_assetLibrary)));
         var_110.add(HabboHelpViewEnum.const_200,IHelpViewController(new CallForHelpSentView(this,_windowManager,_assetLibrary,"help_cfh_thanks")));
         ...
         var_110.add(HabboHelpViewEnum.const_924,IHelpViewController(new CallForHelpPendingItemView(this,_windowManager,_assetLibrary)));
         var_110.add(HabboHelpViewEnum.const_721,IHelpViewController(new CallForHelpReportUserSelection(this,_windowManager,_assetLibrary)));
      }
      ...
      private function addBackButtonWindow() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(var_252 == HabboHelpViewEnum.const_150 || false)
         {
            return;
         }
         if(var_377 == null)
      ...
      {
         return var_110.getValue(var_252);
      }
      ...
      {
         var_1728 = param1;
         var _loc2_:IHelpViewController = var_110.getValue(HabboHelpViewEnum.const_150) as IHelpViewController;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_200:
               ...
               break;
            case CallForHelpResultEnum.const_885:
               showUI(HabboHelpViewEnum.const_924);
               break;
            case CallForHelpResultEnum.const_900:
      ...
      {
         var _loc3_:* = null;
         if(var_252 == HabboHelpViewEnum.const_150)
         {
            return;
         }
         if(true)
         {
            ...
            var_538.push(_loc3_.content as BitmapData);
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(var_538[1],var_538[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(var_538[0],var_538[0].rect,new Point(0,0));
         }
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         _window.height = _loc1_.height + var_1392;
         _window.width = _loc1_.width + var_1391;
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         if(_loc3_)
         {
            if(var_191 != null)
            {
               var_191.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_46,HabboToolbarIconEnum.HELP,_window));
            }
         }
      ...
      public function handleCallGuideBot() : void
      {
         ...
         hideUI();
         var_43.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_690));
      }
