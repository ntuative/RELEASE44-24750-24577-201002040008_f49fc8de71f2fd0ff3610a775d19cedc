package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      private var var_697:FaqCategory;
      
      private var var_696:FaqCategory;
      ...
      {
         super();
         var_696 = new FaqCategory(-999,"${help.faq.title.urgent}");
         _frontPageNormal = new FaqCategory(-9999,"${help.faq.title.normal}");
         var_697 = new FaqCategory(-99999,"${help.faq.title.searchresults}");
         var_143 = new Map();
      }
      ...
      {
         var _loc4_:* = null;
         if(var_696.method_2(param1))
         {
            var_696.getItem(param1).answerText = param2;
         }
         if(_frontPageNormal.method_2(param1))
         {
            _frontPageNormal.getItem(param1).answerText = param2;
         }
         if(var_697.method_2(param1))
         {
            var_697.getItem(param1).answerText = param2;
         }
         var _loc3_:int = 0;
         while(_loc3_ < var_143.length)
         {
            _loc4_ = var_143.getWithIndex(_loc3_);
            if(_loc4_.method_2(param1))
            {
