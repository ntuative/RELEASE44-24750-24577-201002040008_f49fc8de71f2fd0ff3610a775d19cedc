package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_2326:Dictionary;
      ...
      private var var_346:GuestRoomDoorbell;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_1567:ISessionDataManager;
      
      private var var_1566:RoomCreateViewCtrl;
      
      private var var_1569:RoomThumbnailRenderer;
      
      private var var_191:IHabboToolbar;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_1079:RoomInfoViewCtrl;
      
      private var var_94:IHabboCatalog;
      
      private var var_401:Tabs;
      
      private var var_435:MainViewCtrl;
      
      private var var_1568:Array;
      
      private var var_964:GuestRoomPasswordInput;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_435 = new MainViewCtrl(this);
         var_1079 = new RoomInfoViewCtrl(this);
         var_1566 = new RoomCreateViewCtrl(this);
         var_1569 = new RoomThumbnailRenderer(this);
         var_964 = new GuestRoomPasswordInput(this);
         var_346 = new GuestRoomDoorbell(this);
         var_401 = new Tabs(this);
      }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         var_435.startSearch(Tabs.const_208,Tabs.const_292,param1);
         var_435.mainWindow.activate();
      }
      ...
      {
         if(param1 != null && var_191 != null)
         {
            var_191.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_46,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         if(var_191 != null)
         {
            var_191.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_116,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.settings != null && this._data.settings.homeRoomId > 0)
            {
               var_191.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_116,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1567 = param2 as ISessionDataManager;
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         var_435.startSearch(Tabs.const_241,Tabs.const_199);
         var_401.getTab(Tabs.const_241).tabPageDecorator.tabSelected();
      }
      ...
      {
         var _loc1_:Boolean = var_435.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
