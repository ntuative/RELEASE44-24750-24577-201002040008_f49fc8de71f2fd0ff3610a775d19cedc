package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      private var var_123:GuestRoomData;
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         var_1569 = new RoomThumbnailRenderer(param1);
         var_1046 = new TagRenderer(param1,hideInstantly);
      }
      
      private function refreshOwnerName() : void
      {
         refreshTextWithCaption("roomowner",var_177,var_123.ownerName);
         var _loc1_:ITextWindow = ITextWindow(var_177.findChildByName("roomowner"));
         if(true)
         {
            _loc1_.procedure = onOwnerName;
            _loc1_.setParamFlag(HabboWindowParam.const_39,true);
            _loc1_.underline = true;
         }
         else
         {
            _loc1_.procedure = null;
            _loc1_.setParamFlag(HabboWindowParam.const_39,false);
      ...
      private function refreshExtraCont() : void
      {
         ...
         var_1046.refreshTags(_loc1_,var_123.tags);
         refreshTextWithCaption("rating",_loc1_,"undefined");
         if(false)
         {
            refreshTextWithCaption("startedat",_loc1_,"undefined");
         }
         var_1569.refreshThumbnail(_loc1_,var_123.thumbnail,false);
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         refreshRoomName(var_177,var_123);
         if(true)
         {
         }
         refreshOwnerName();
         refreshTextWithCaption("roomctg",var_177,!true ? getEventCtg(var_123.categoryId) : getRoomCtg(var_123.categoryId));
         refreshRoomDesc(var_177,var_123);
         refreshExtraCont();
         refreshInfo(var_177,"trading_allowed",var_123.allowTrading);
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_208,Tabs.const_203,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
