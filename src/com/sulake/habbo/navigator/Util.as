package com.sulake.habbo.navigator
{
   ...
   public class Util
   {
      ...
      private static var var_1425:CutToHeight = new CutToHeight();
      
      private static var var_1424:CutToWidth = new CutToWidth();
      ...
      {
         var _loc4_:IWindow = param1.findChildByName(param2);
         _loc4_.setParamFlag(HabboWindowParam.const_39,true);
