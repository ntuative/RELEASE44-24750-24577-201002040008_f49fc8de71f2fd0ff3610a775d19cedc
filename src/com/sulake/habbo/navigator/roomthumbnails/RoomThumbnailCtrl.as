package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private function refreshTab() : void
      {
         ...
         setEnabled(var_1430,this._model.mode != ThumbnailEditorModel.const_53);
         setEnabled(var_1431,this._model.mode != ThumbnailEditorModel.const_33);
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         var_1830 = IWindowContainer(find("tile_grid"));
         var_1831 = IWindowContainer(find("now_editing_container"));
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = var_1830;
         _loc1_.visible = true;
      ...
      {
         var _loc1_:IWindowContainer = var_1831;
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(_navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_55,HabboWindowStyle.const_37,HabboWindowParam.const_64,new Rectangle(0,0,param1.width,66)));
