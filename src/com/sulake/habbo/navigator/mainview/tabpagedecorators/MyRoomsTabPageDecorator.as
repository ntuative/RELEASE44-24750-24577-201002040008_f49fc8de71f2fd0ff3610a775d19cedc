package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class MyRoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_464:IDropMenuWindow;
      ...
      private function getSearchTypeForIndex(param1:int) : int
      {
         ...
         if(param1 == 2)
         {
            return Tabs.const_579;
         }
         if(param1 == 3)
         {
            return Tabs.const_551;
         }
         if(param1 == 4)
         {
      ...
      {
         var _loc1_:int = var_464 == null ? 0 : int(var_464.selection);
         Logger.log("Me subNavi selection changed: " + _loc1_);
         _navigator.mainViewCtrl.startSearch(Tabs.const_241,getSearchTypeForIndex(_loc1_));
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_464 == null)
         {
            var_464 = IDropMenuWindow(_loc3_.findChildByName("meSubNavi"));
            var_464.procedure = onChangeSubNavi;
            prepareSubNavi();
         }
         _loc3_.visible = true;
      }
