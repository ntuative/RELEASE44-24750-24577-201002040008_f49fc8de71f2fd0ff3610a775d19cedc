package com.sulake.habbo.session
{
   ...
   public class SessionDataManager extends Component implements ISessionDataManager
   {
      ...
      private var var_1374:UserTagManager;
      ...
      private var var_1375:GroupDetailsView;
      ...
      private var var_1134:BadgeImageManager;
      ...
      private var var_935:ProductDataParser;
      ...
      public function SessionDataManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_627 = [];
         var_1374 = new UserTagManager(events);
      ...
      {
         var_935.removeEventListener(ProductDataParser.const_135,onProductsReady);
         var_935 = null;
         _floorItems = new Map();
         _wallItems = new Map();
         var_761 = new Map();
         ...
         var_937 = new FurnitureDataParser(_loc2_,_floorItems,_wallItems,var_761,_localization);
         var_937.addEventListener(FurnitureDataParser.const_135,onFurnitureReady);
      }
      
      public function getUserTags(param1:int) : Array
      {
         return var_1374.getTags(param1);
      }
      ...
      private function onConfigurationInit(param1:Event = null) : void
      {
         ...
         var _loc3_:String = var_170.getKey("external.hash");
         _loc2_ = _loc2_.replace("%hash%",_loc3_);
         var_935 = new ProductDataParser(_loc2_,var_794);
         var_935.addEventListener(ProductDataParser.const_135,onProductsReady);
      }
      ...
      {
         return var_1134.getBadgeImage(param1,BadgeImageManager.const_987);
      }
      ...
      private function onUserObject(param1:IMessageEvent) : void
      {
         ...
         var_444 = _loc3_.petRespectLeft;
         var_532 = _loc3_.figure;
         _gender = _loc3_.sex;
         var_1152 = _loc3_.realName;
      ...
      public function getFloorItemDataByName(param1:String) : IFurnitureData
      {
         ...
         return getFloorItemData(parseInt(var_761.getValue(param1)));
      }
      ...
      private function onAvailabilityStatus(param1:IMessageEvent) : void
      {
         ...
         var_1697 = _loc2_.isOpen;
         var_1698 = _loc2_.onShutDown;
      }
      
      public function getBadgeImage(param1:String) : BitmapData
      {
         return var_1134.getBadgeImage(param1);
      }
      ...
      public function showGroupBadgeInfo(param1:int) : void
      {
         if(var_1375 == null)
         {
            var_1375 = new GroupDetailsView(this);
         }
         var _loc2_:HabboGroupDetails = var_936.getGroupDetails(param1);
         if(_loc2_ != null)
         {
            var_1375.showGroupDetails(param1);
         }
      }
      
      private function onFurnitureReady(param1:Event = null) : void
      {
         var_937.removeEventListener(FurnitureDataParser.const_135,onFurnitureReady);
         var_937 = null;
      }
      ...
      {
         var _loc2_:IConnection = _communication.getHabboMainConnection(null);
         if(param1 < 0 || var_444 < 1 || _loc2_ == null)
         {
      ...
      private function onUserChange(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.id == -1)
         {
            var_532 = _loc2_.figure;
            _gender = _loc2_.sex;
            events.dispatchEvent(new HabboSessionFigureUpdatedEvent(_id,var_532));
         }
      }
      ...
      public function hasUserRight(param1:String) : Boolean
      {
         ...
         return var_627.indexOf(param1) >= 0;
      }
      ...
      public function getWallItemDataByName(param1:String) : IFurnitureData
      {
         ...
         return getWallItemData(parseInt(var_761.getValue(param1)));
      }
      ...
      private function onHabboCommunicationReady(param1:IID, param2:IUnknown) : void
      {
         ...
         var_1374.communication = _communication;
      ...
      public function get isAnyRoomController() : Boolean
      {
         ...
         return var_627.indexOf("fuse_any_room_controller") >= 0;
      }
      ...
      private function initBadgeImageManager() : void
      {
         ...
         var_1134 = new BadgeImageManager(_loc1_,events,var_170,_localization);
      }
