package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private var var_47:String = "RSE_CREATED";
      
      private var var_1002:UserDataManager;
      ...
      {
         if(var_47 == RoomSessionEvent.const_320 && _connection != null)
         {
            var_47 = RoomSessionEvent.const_91;
            if(isPrivateRoom)
            {
      ...
      {
         return var_1002 as IUserDataManager;
      }
