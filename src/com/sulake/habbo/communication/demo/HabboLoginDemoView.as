package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      private var var_335:HabboCommunicationDemo;
      
      public var password:String = "";
      
      private var var_122:SSOTicket;
      ...
      {
         var_335.windowManager.removeWindow("habbo_login_window");
      }
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         var_335.shockwaveClientUrl = var_122.shockwaveClientUrl;
         var_335.ssoTicket = var_122.ticket;
         var_122.removeEventListener(SSOTicket.const_302,onParsedTicketSuccess);
         var_122.removeEventListener(SSOTicket.const_238,onParsedTicketFailure);
         var_122 = null;
      ...
      private function windowEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(const_1406,"/");
      ...
      {
         var _loc1_:XmlAsset = (var_335 as Component).assets.getAssetByName("login_window") as XmlAsset;
         if(_loc1_ == null)
         {
            Logger.log("Could  not find embedded Window XML for Login Window, login_window");
            return;
         }
         _window = var_335.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_356,HabboWindowStyle.const_40,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         var _loc2_:XML = _loc1_.content as XML;
         var _loc3_:IWindowContainer = var_335.windowManager.buildFromXML(_loc2_) as IWindowContainer;
         ...
         if(_loc4_ != null)
         {
            _loc4_.addEventListener(WindowMouseEvent.const_101,windowEventProcessor);
         }
         else
         {
            Logger.log("Could not find the button");
         }
         var _loc7_:SharedObject = SharedObject.getLocal(const_1406,"/");
         if(_loc5_ != null)
         {
      ...
      private function initSSOTicket() : void
      {
         ...
         if(false)
         {
            _loc1_ = var_335.habboConfiguration.getKey("url.prefix",_loc1_);
            _loc1_ = _loc1_.replace("http://","");
            _loc1_ = _loc1_.replace("https://","");
         }
         var _loc2_:IHabboWebLogin = var_335.habboCommunication.habboWebLogin(name,password);
         var_122 = new SSOTicket(var_335.assets,_loc2_,_loc1_);
         var_122.addEventListener(SSOTicket.const_302,onParsedTicketSuccess);
         var_122.addEventListener(SSOTicket.const_238,onParsedTicketFailure);
      }
