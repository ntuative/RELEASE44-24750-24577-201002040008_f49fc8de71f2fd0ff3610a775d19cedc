package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_1925:PseudoRandom;
      
      private var _windowManager:IHabboWindowManager;
      
      private var _habboConfiguration:IHabboConfigurationManager;
      
      private var var_1469:ILogger;
      
      private var var_1210:String;
      
      private var var_1926:String;
      
      private const const_1406:String = "fuselogin";
      
      private var var_586:ICoreCommunicationManager;
      
      private var var_470:IKeyExchange;
      ...
      private function onDisconnectReason(param1:IMessageEvent) : void
      {
         ...
         switch(_loc2_)
         {
            case DisconnectReasonEvent.const_295:
               _loc3_ = _habboConfiguration.getKey("logout.banned.url");
               break;
            case DisconnectReasonEvent.const_913:
            ...
            case DisconnectReasonEvent.const_976:
               ...
               break;
            case DisconnectReasonEvent.const_856:
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_1924)
         {
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_669 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(var_669);
            _loc2_.send(_loc4_);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         param1.send(new VersionCheckMessageComposer(401,var_1210,var_1926));
         var _loc2_:String = "";
         var _loc3_:SharedObject = SharedObject.getLocal(const_1406,"/");
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var_470.generateSharedKey(_loc4_,10);
         var _loc5_:String = var_470.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_1925);
      ...
      private function onUniqueMachineId(param1:UniqueMachineIDEvent) : void
      {
         ...
         var _loc2_:SharedObject = SharedObject.getLocal(const_1406,"/");
      ...
      {
         var_669 = _habboConfiguration.getKey("sso.ticket",null);
         var_1210 = _habboConfiguration.getKey("flash.client.url","");
         ...
         if(var_669 != null)
         {
            var_80.mode = HabboConnectionType.const_420;
            var_80.initConnection(HabboConnectionType.const_262);
         }
      }
      
      private function receiveLoggerInterface(param1:IID, param2:IUnknown) : void
      {
         var_1469 = param2 as ILogger;
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_657);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_1925 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_80.mode)
         {
            case HabboConnectionType.const_420:
               ...
               var_1001 = _loc4_;
               var_178.loadBannerImage(_loc7_ + "?token=" + var_1001,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1218:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1192:
               var_999 = generateRandomHexString(30);
               var_470 = new DiffieHellman(new BigInteger(_habboConfiguration.getKey("connection.development.prime"),16),new BigInteger(_habboConfiguration.getKey("connection.development.generator"),16));
               var_470.init(var_999);
               _loc8_ = var_470.getPublicKey(10);
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,var_1001);
         ...
         var_470 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 100;
         while(_loc12_.length < 64)
         {
            var_999 = generateRandomHexString(30);
            var_470.init(var_999);
            _loc12_ = var_470.getPublicKey(10);
            _loc13_--;
            if(_loc13_ == 0)
            {
            }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         if(param2 != null)
         {
            ...
            Component(_habboConfiguration).events.addEventListener(HabboConfigurationEvent.const_19,onConfigurationLoaded);
         }
      }
