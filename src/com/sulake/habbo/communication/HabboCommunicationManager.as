package com.sulake.habbo.communication
{
   ...
   public class HabboCommunicationManager extends Component implements IHabboCommunicationManager, IConnectionStateListener
   {
      ...
      private function onConfigurationReady(param1:Event = null) : void
      {
         ...
         {
            Core.crash("Received configuration ready event but configuration was null",CoreComponent.const_946);
         }
         else
         {
      ...
      public function messageReceived(param1:String, param2:String) : void
      {
         ...
         ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1289,param1 + " " + param2);
         if(false)
         {
            var_96 += ",R:" + param1;
         }
         ...
         if(false)
         {
            var_96 = var_96.substring(-150);
         }
         ErrorReportStorage.addDebugData("MESSAGE_QUEUE",var_96);
      }
      ...
      private function nextPort() : void
      {
         ...
         if(var_349 >= var_234.length)
         {
            ...
            if(var_868 > const_1617)
            {
               ...
               if(_loc1_ != null)
               {
                  _loc1_.error("Connection failed to host " + var_46 + " ports " + var_234,true,CoreComponent.const_708);
                  return;
               }
         ...
         _connection.timeout = var_868 * 5000;
      ...
      {
         return var_586.addConnectionMessageEvent(HabboConnectionType.const_262,param1);
      }
      ...
      public function initConnection(param1:String) : void
      {
         switch(param1)
         {
            case HabboConnectionType.const_262:
               if(_habboConfiguration == null)
               {
                  Core.crash("Tried to connect to proxy but configuration was null",CoreComponent.const_708);
                  return;
               }
               if(_connection == null)
               {
                  Core.crash("Tried to connect to proxy but connection was null",CoreComponent.const_708);
                  return;
               }
               var_2085 = true;
               if(var_2086)
      ...
      {
         ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1338,param1);
         ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1270,String(param2));
      }
      
      public function messageSent(param1:String, param2:String) : void
      {
         ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1205,String(new Date().getTime()));
         ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1257,param1 + " " + param2);
         if(false)
         {
            var_96 += ",S:" + param1;
         }
      ...
      private function onCoreCommunicationManagerInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            var_586 = param2 as ICoreCommunicationManager;
            var_586.connectionStateListener = this;
            var_586.registerProtocolType(HabboProtocolType.const_794,WedgieProtocol);
            _connection = var_586.createConnection(HabboConnectionType.const_262,ConnectionType.const_870);
            _loc3_ = var_586.getProtocolInstanceOfType(HabboProtocolType.const_794);
      ...
      {
         var_1274.addEventListener(TimerEvent.TIMER,onTryNextPort);
         var_1274.start();
      }
      
      public function getHabboMainConnection(param1:Function) : IConnection
      {
         return !!var_586 ? var_586.queueConnection(HabboConnectionType.const_262,param1) : null;
      }
   }
}
