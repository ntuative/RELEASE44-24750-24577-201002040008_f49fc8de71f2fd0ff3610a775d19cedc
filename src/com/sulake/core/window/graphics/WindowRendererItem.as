package com.sulake.core.window.graphics
{
   ...
   public class WindowRendererItem implements IDisposable
   {
      ...
      private static const const_747:uint = 1;
      
      private static const const_746:uint = 2;
       
      
      private var var_642:ISkinContainer;
      ...
      public function invalidate(param1:IWindow, param2:Rectangle, param3:uint) : Boolean
      {
         ...
         switch(param3)
         {
            ...
            case WindowRedrawFlag.const_964:
               var_643 = var_642.getTheActualState(param1.type,param1.style,param1.state);
               if(var_643 != var_972)
               {
                  var_221 = true;
                  _loc4_ = true;
      ...
      {
         return var_642.getTheActualState(param1.type,param1.style,param1.state) != var_972;
      }
      ...
      public function render(param1:IWindow, param2:Point, param3:Rectangle) : Boolean
      {
         var _loc4_:* = null;
         var _loc10_:* = 0;
         var _loc5_:uint = !!param1.background ? uint(const_746) : uint(const_482);
         var _loc6_:ISkinRenderer = resolveSkinRenderer(param1);
         if(_loc6_ != null)
         {
            _loc5_ = !!_loc6_.isStateDrawable(var_643) ? uint(const_747) : uint(_loc5_);
         }
         ...
         if(_loc5_ != const_482)
         {
            if(var_103 == null)
            {
               var_103 = _drawBufferAllocator.allocate(_loc7_,_loc8_,true,param1.color);
               var_221 = true;
            }
            else if(var_103.width != _loc7_ || var_103.height != _loc8_)
            {
               _drawBufferAllocator.free(var_103);
               var_103 = _drawBufferAllocator.allocate(_loc7_,_loc8_,true,param1.color);
               var_221 = true;
            }
         }
         ...
         if(_loc5_ != const_482)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc5_ == const_747)
               {
                  ...
                  {
                     var_221 = false;
                     var_103.fillRect(var_103.rect,param1.color);
                     _loc6_.draw(param1,var_103,var_103.rect,var_643,false);
                     if(!param1.background)
                     {
                        _loc10_ = uint(param1.color);
                        if((_loc10_ & 16777215) < 16777215)
                        {
                           var_103.colorTransform(_loc4_.rect,new ColorTransform(((_loc10_ & 16711680) >> 16) / 255 * 1,((_loc10_ & 65280) >> 8) / 255 * 1,(_loc10_ & 255) / 255 * 1));
                        }
                     }
                  }
                  if(param1.blend < 1 && param1.testParamFlag(WindowParam.const_32))
                  {
                     ...
                     _loc4_.draw(var_103,var_897,_colorTransform,null,param3,false);
                     param3.offset(-param2.x,-param2.y);
                  }
                  else
                  {
                     _loc4_.copyPixels(var_103,param3,param2,null,null,true);
                  }
               }
               else if(_loc5_ == const_746)
               {
                  if(param1.testParamFlag(WindowParam.const_32))
                  {
                     var_103.fillRect(var_103.rect,param1.color);
      ...
      {
         var _loc2_:ISkinRenderer = var_642.getSkinRendererByType(param1.type,param1.style);
         if(_loc2_ == null)
         {
            if(param1.style != WindowStyle.const_957)
            {
               _loc2_ = var_642.getSkinRendererByType(param1.type,WindowStyle.const_957);
            }
         }
         return _loc2_;
      }
