package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_1096:uint = 8;
       
      
      private var var_494:Dictionary;
      
      private var var_2046:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         var_2045 = new Dictionary();
         TypeCodeTable.fillTables(var_1494,var_2045);
         var_1255 = new Dictionary();
         var_2046 = new Dictionary();
         StateCodeTable.fillTables(var_1255,var_2046);
         var_494 = new Dictionary();
         var_494["skin"] = BitmapSkinRenderer;
         var_494["bitmap"] = BitmapDataRenderer;
         var_494["fill"] = FillSkinRenderer;
         var_494["text"] = TextSkinRenderer;
         var_494["shape"] = ShapeSkinRenderer;
         var_494["unknown"] = SkinRenderer;
         var_494["null"] = NullSkinRenderer;
         if(var_366 == null)
         {
            var_366 = new Array();
            var_366.push(WindowState.const_63);
            var_366.push(WindowState.const_65);
            var_366.push(WindowState.const_92);
            var_366.push(WindowState.const_45);
            var_366.push(WindowState.const_75);
            var_366.push(WindowState.const_71);
            var_366.push(WindowState.const_90);
            var_366.push(WindowState.const_81);
         }
         var _loc3_:Array = new Array();
         for(_loc4_ in var_1255)
         {
            _loc3_.push(var_1255[_loc4_]);
         }
         if(param1 != null)
         {
            ...
            if(_loc6_ > 0)
            {
               ...
               while(_loc18_ < _loc6_)
               {
                  ...
                  addSkinRenderer(var_1494[_loc9_],uint(_loc10_),_loc15_);
                  _loc18_++;
               }
            }
         }
      ...
      {
         var _loc3_:Array = var_581[param1];
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer) : void
      {
         if(true)
         {
            var_581[param1] = new Array(SkinContainer.const_1096);
         }
         var_581[param1][param2] = param3;
      }
      ...
      public function dispose() : void
      {
         ...
         {
            ISkinRenderer(var_581[_loc1_]).dispose();
