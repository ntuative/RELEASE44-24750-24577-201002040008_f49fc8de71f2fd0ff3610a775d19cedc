package com.sulake.core.window.graphics
{
   ...
   public class WindowRenderer implements IWindowRenderer
   {
      ...
      private var var_60:DisplayObjectContainer;
      
      private var _disposed:Boolean;
      
      private var var_642:ISkinContainer;
      
      private var var_1503:Rectangle;
      ...
      public function WindowRenderer(param1:ISkinContainer)
      {
         ...
         var_585 = new Array();
         var_1504 = new Point();
         var_1503 = new Rectangle();
         var_306 = new Rectangle();
         var_307 = new Dictionary(true);
         var_642 = param1;
      ...
      {
         var _loc2_:WindowRendererItem = var_307[param1] as WindowRendererItem;
      ...
      public function render() : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            _loc1_ = var_585.pop() as WindowController;
            if(!_loc1_.disposed)
            {
               _loc3_ = getWindowRendererItem(_loc1_);
               var_306.x = _loc3_.dirty.x;
               var_306.y = _loc3_.dirty.y;
               var_306.width = _loc3_.dirty.width;
               var_306.height = _loc3_.dirty.height;
               renderWindowBranch(_loc1_,_loc3_,var_306);
            }
            _loc4_++;
         }
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            _disposed = true;
            var_585 = null;
            for(_loc1_ in var_307)
            {
               delete var_307[_loc1_];
            }
            var_307 = null;
      ...
      private function renderWindowBranch(param1:WindowController, param2:WindowRendererItem, param3:Rectangle) : void
      {
         ...
         if(param1.visible)
         {
            if(getDrawLocationAndClipRegion(param1,param3,var_1504,var_1503))
            {
               if(param2.render(param1,var_1504,var_1503))
               {
      ...
      public function registerRenderable(param1:IWindow) : void
      {
         ...
         if(_loc2_ == null)
         {
            _loc2_ = new WindowRendererItem(this,_drawBufferAllocator,var_642);
            var_307[param1] = _loc2_;
      ...
      public function addToRenderQueue(param1:IWindow, param2:Rectangle, param3:uint) : void
      {
         ...
         if(getWindowRendererItem(param1).invalidate(param1,param2,param3))
         {
            ...
            var_306.x = param2.x - param1.x;
            var_306.y = param2.y - param1.y;
            var_306.width = param2.width;
            var_306.height = param2.height;
            if(param1.testParamFlag(WindowParam.const_32))
            {
               while(param1.testParamFlag(WindowParam.const_32))
               {
                  ...
                  var_306.offset(param1.x,param1.y);
                  param1 = _loc4_;
               }
            }
            getWindowRendererItem(param1).invalidate(param1,var_306,WindowRedrawFlag.const_234);
            if(var_585.indexOf(param1) == -1)
            {
               var_585.push(param1);
            }
         }
