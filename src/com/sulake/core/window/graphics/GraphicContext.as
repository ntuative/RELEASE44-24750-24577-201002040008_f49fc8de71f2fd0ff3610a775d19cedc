package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      protected static var var_614:uint = 0;
      
      protected static var var_367:uint = 0;
      
      public static const GC_TYPE_TEXTFIELD:uint = 2;
      
      public static const const_1544:uint = 128;
      
      public static const const_1581:uint = 64;
      ...
      protected var var_611:Boolean;
      
      protected var var_1564:Boolean;
      
      protected var var_167:DisplayObjectContainer;
      ...
      protected function setupChildContainer() : DisplayObjectContainer
      {
         ...
         {
            var_167 = new Sprite();
            var_167.name = this.name + " - Child Container";
            var_167.mouseEnabled = false;
            addChild(var_167);
         }
         return var_167;
      }
         ...
         if(var_611)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new BitmapData(width,height,var_1564,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new BitmapData(1,1,var_1564,16777215);
                  }
                  var_367 += bitmap.width * bitmap.height * 4;
               }
