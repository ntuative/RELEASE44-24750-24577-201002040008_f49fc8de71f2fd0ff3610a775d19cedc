package com.sulake.core.window.graphics.renderer
{
   ...
   public class SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_318:Dictionary;
      
      protected var var_319:Dictionary;
      ...
      {
         super();
         var_318 = new Dictionary();
         var_319 = new Dictionary();
      ...
      public function removeTemplate(param1:ISkinTemplate) : ISkinTemplate
      {
         ...
         if(param1 != null)
         {
            for(_loc2_ in var_319)
            {
               _loc3_ = uint(_loc2_ as uint);
               if(var_319[_loc3_] == param1)
               {
                  removeTemplateFromRenderState(_loc3_);
               }
            }
            delete var_318[param1.name];
         }
         return param1;
      }
      ...
      public function dispose() : void
      {
         ...
         for(_loc1_ in var_318)
         {
            ISkinTemplate(var_318[_loc1_]).dispose();
            delete var_318[_loc1_];
         }
         var_318 = null;
         var_319 = null;
      }
