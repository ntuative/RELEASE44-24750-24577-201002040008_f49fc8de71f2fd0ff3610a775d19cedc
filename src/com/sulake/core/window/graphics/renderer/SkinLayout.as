package com.sulake.core.window.graphics.renderer
{
   ...
   public class SkinLayout extends ChildEntityArray implements ISkinLayout
   {
      ...
      protected var var_896:IChildEntityArray;
      ...
      public function getDefaultRegion(param1:String, param2:Rectangle) : void
      {
         ...
         if(_loc3_ == null)
         {
            _loc3_ = var_896.getChildByName(param1) as ISkinLayoutEntity;
            if(_loc3_ == null)
            {
      ...
      public function dispose() : void
      {
         ...
         for(_loc3_ in var_896)
         {
            ISkinLayoutEntity(var_896[_loc3_]).dispose();
            delete var_896[_loc3_];
         }
      }
