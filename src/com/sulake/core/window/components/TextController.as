package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static var var_2311:Rectangle = new Rectangle();
       
      
      protected var var_211:Boolean;
      
      protected var var_75:TextMargins;
      
      protected var var_518:String = "none";
      
      protected var var_605:Number;
      
      protected var var_361:Number;
      
      protected var _field:TextField;
      
      protected var var_726:Boolean = false;
      ...
      {
         var_75 = new TextMargins(0,0,0,0,setTextMargins);
         var_211 = false;
         var_605 = 0;
         var_361 = 0;
         if(_field == null)
      ...
      {
         param1.var_75.dispose();
         param1.var_75 = new TextMargins(int(param2["left"]),int(param2["top"]),int(param2["right"]),int(param2["bottom"]),param1.setTextMargins);
         param1.refreshTextImage();
      }
      ...
      {
         return new Rectangle(var_605 * maxScrollH,var_361 * maxScrollV,width,height);
      }
      ...
      override public function dispose() : void
      {
         if(var_726)
         {
            context.removeLocalizationListener(var_317,this);
         }
         if(var_75 != null)
         {
            var_75.dispose();
      ...
      {
         var_605 = param1;
         _field.scrollH = var_605 * Number(_field.maxScrollH);
         refreshTextImage();
      }
      ...
      public function set text(param1:String) : void
      {
         ...
         var_317 = param1;
         if(var_317.charAt(0) == "$" && var_317.charAt(1) == "{")
         {
            context.registerLocalizationListener(var_317.slice(2,var_317.indexOf("}")),this);
            var_726 = true;
         }
         else if(_field != null)
         {
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         if(!var_211)
         {
            if(param2.type == WindowNotifyEvent.const_188)
            {
               refreshTextImage();
            }
         }
      ...
      public function setTextMargins(param1:IMargins) : void
      {
         ...
         {
            var_75.dispose();
            var_75 = new TextMargins(param1.left,param1.top,param1.right,param1.bottom,setTextMargins);
         }
         refreshTextImage();
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("font_size",defaultTextFormat.size,PropertyStruct.const_835,true));
         _loc1_.push(new PropertyStruct("text_color",_field.textColor,PropertyStruct.const_455,true));
         ...
         _loc1_.push(new PropertyStruct("border_color",_field.borderColor,PropertyStruct.const_455,true));
         ...
         _loc1_.push(new PropertyStruct("sharpness",_field.sharpness,PropertyStruct.const_719,true));
         _loc1_.push(new PropertyStruct("style_sheet",_field.styleSheet,PropertyStruct.STRING,false));
         _loc1_.push(new PropertyStruct("thickness",_field.thickness,PropertyStruct.const_719,true));
         _loc1_.push(new PropertyStruct("word_wrap",_field.wordWrap,PropertyStruct.const_54,true));
         _loc1_.push(new PropertyStruct("margin_left",var_75.left,PropertyStruct.const_61,true));
         _loc1_.push(new PropertyStruct("margin_top",var_75.top,PropertyStruct.const_61,true));
         _loc1_.push(new PropertyStruct("margin_right",var_75.right,PropertyStruct.const_61,true));
         _loc1_.push(new PropertyStruct("margin_bottom",var_75.bottom,PropertyStruct.const_61,true));
         _loc1_.push(new PropertyStruct("auto_size",var_518,PropertyStruct.STRING,var_518 != TextFieldAutoSize.NONE));
         ...
         _loc1_.push(new PropertyStruct("spacing",_field.defaultTextFormat.letterSpacing,PropertyStruct.const_719,_field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
      ...
      override public function clone() : IWindow
      {
         ...
         _loc1_.var_605 = var_605;
         _loc1_.var_361 = var_361;
         _loc1_.var_75 = var_75.clone(_loc1_.setTextMargins);
         _loc1_.var_518 = var_518;
         _loc1_.var_726 = var_726;
         return _loc1_;
      }
      ...
      protected function refreshTextImage() : void
      {
         ...
         if(_loc5_ != _loc3_)
         {
            if(var_518 == TextFieldAutoSize.LEFT)
            {
               setRectangle(var_22.x,var_22.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_518 == TextFieldAutoSize.RIGHT)
            {
               setRectangle(var_22.x,var_22.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_518 != TextFieldAutoSize.CENTER)
            {
         ...
         {
            if(var_518 != TextFieldAutoSize.NONE)
            {
               setRectangle(var_22.x,var_22.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
