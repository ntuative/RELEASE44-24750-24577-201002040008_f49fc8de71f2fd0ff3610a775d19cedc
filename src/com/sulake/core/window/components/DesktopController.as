package com.sulake.core.window.components
{
   ...
   public class DesktopController extends ActivatorController implements IDesktopWindow, IDisplayObjectWrapper
   {
      ...
      public function DesktopController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function)
      {
         super(param1,param2,param3,param4,param5,param6,param7,param8 != null ? param8 : defaultProcedure,null,null,0);
      }
      ...
      {
         var_610 = param1 != null ? param1 : defaultProcedure;
      }
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_31)
         {
            var_31 = new GraphicContext("GC {" + _name + "}",GraphicContext.GC_TYPE_DESKTOP,var_22);
