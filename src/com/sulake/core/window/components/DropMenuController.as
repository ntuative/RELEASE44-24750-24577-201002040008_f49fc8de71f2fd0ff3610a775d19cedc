package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow
   {
      ...
      private var var_139:DropMenuController;
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         if(var_139 == null || false)
         {
            var_139 = context.create(name + "::submenu","",WindowType.const_415,var_89,0 | 0,_loc1_,subMenuEventProc,null,0,null,[WindowController.EXCLUDE_CHILD_TAG]) as DropMenuController;
         }
         else
         {
            var_139.setGlobalRectangle(_loc1_);
         }
         var_139.activate();
         return var_139;
      }
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowMouseEvent.const_101)
         {
            ...
            {
               if(param2.testStateFlag(WindowState.const_75))
               {
         ...
         else if(param1.type == WindowEvent.const_799)
         {
            if(param2 == var_139)
            {
               closeMenuView();
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_436,var_89,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_329,var_89,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
         ...
         if(var_471 > -1 && _loc5_)
         {
            _loc4_.getListItemAt(var_471).setStateFlag(WindowState.const_45,true);
         }
      }
      ...
      protected function openMenuView() : void
      {
         if(!var_565)
         {
            if(open())
            {
               if(false)
               {
                  populateMenuItemContainer(var_472,getSubMenu(),subMenuEventProc);
                  var_565 = true;
               }
            }
         }
      ...
      public function set selection(param1:int) : void
      {
         ...
         var _loc2_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_365,this,null,true);
         update(this,_loc2_);
      ...
      public function getMenuItemIndex(param1:IDropMenuItemWindow) : int
      {
         ...
         if(_loc2_ == -1)
         {
            if(var_139 != null)
            {
               _loc2_ = var_139.getMenuItemIndex(param1);
            }
         }
         return _loc2_;
      }
      ...
      protected function closeMenuView() : void
      {
         if(close())
         {
            ...
            var_565 = false;
            getTitleText().text = var_471 < var_472.length && var_471 > -1 ? "null" : caption;
         }
      }
   }
}
