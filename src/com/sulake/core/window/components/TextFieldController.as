package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      private function onRemovedEvent(param1:Event) : void
      {
         ...
         {
            var_29.handleError(WindowContext.ERROR_DURING_EVENT_HANDLING,e);
         }
      }
      ...
      {
         var_29.getWindowServices().getFocusManagerService().removeFocusWindow(this);
         var_907 = false;
         if(_field)
         {
            if(focused)
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("focus_capturer",var_907,PropertyStruct.const_54,var_907 != false));
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            {
               var_907 = _loc2_.value as Boolean;
               if(var_907)
               {
                  var_29.getWindowServices().getFocusManagerService().registerFocusWindow(this);
               }
               break;
            }
         }
