package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow
   {
      ...
      private static const const_1084:String = "increment";
      
      private static const const_486:String = "slider_bar";
      
      private static const const_1083:String = "decrement";
      
      private static const const_766:String = "slider_track";
      ...
      protected var var_727:Number = 0.1;
      ...
      public function ScrollbarController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0, param12:IScrollableWindow = null)
      {
         ...
         _drawable = false;
         var_36 = param12;
         _horizontal = param2 == WindowType.const_461;
      ...
      {
         return findChildByName(ScrollbarController.const_766) as WindowController;
      }
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         if(var_36 != null && true)
         {
            IWindow(var_36).removeEventListener(WindowEvent.const_44,onScrollableResized);
         }
         var_36 = param1;
         if(var_36 != null && true)
         {
            IWindow(var_36).addEventListener(WindowEvent.const_44,onScrollableResized);
            updateLiftSizeAndPosition();
         }
      }
      ...
      {
         return track.findChildByName(ScrollbarController.const_486) as WindowController;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               var_828 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         if(var_828 != null)
         {
            _loc1_ = findParentByName(var_828) as IScrollableWindow;
            if(_loc1_ == null && var_23 is IWindowContainer)
            {
               _loc1_ = IWindowContainer(var_23).findChildByName(var_828) as IScrollableWindow;
               if(_loc1_)
               {
                  scrollable = _loc1_;
                  return true;
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(param2.name == ScrollbarController.const_1084)
            {
               if(var_36)
               {
                  var_564 = true;
            ...
            else if(param2.name == ScrollbarController.const_1083)
            {
               if(var_36)
               {
                  var_564 = true;
            ...
            else if(param2.name == ScrollbarController.const_766)
            {
               _loc4_ = new Point();
         ...
         if(param1.type == WindowMouseEvent.const_998)
         {
