package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_767:IItemListWindow;
      
      private var var_328:IScrollbarWindow;
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_328)
         {
            var_328 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(var_328)
            {
               var_328.addEventListener(WindowEvent.const_239,scrollBarEventProc);
               var_328.addEventListener(WindowEvent.const_219,scrollBarEventProc);
            }
         }
         return var_328;
      }
      ...
      override public function dispose() : void
      {
         if(var_328)
         {
            var_328.removeEventListener(WindowEvent.const_239,scrollBarEventProc);
            var_328.removeEventListener(WindowEvent.const_219,scrollBarEventProc);
            var_328 = null;
         }
         if(var_767)
         {
      ...
      private function scrollBarEventProc(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_219)
         {
            hideScrollBar();
         }
      }
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!var_767)
         {
            var_767 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
         return var_767;
      }
