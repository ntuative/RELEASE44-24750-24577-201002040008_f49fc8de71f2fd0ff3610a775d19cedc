package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_733:String = "margin_top";
      
      private static const const_1015:String = "_HEADER";
      
      private static const const_734:String = "margin_right";
      
      private static const const_1016:String = "_SCALER";
      
      private static const const_1013:String = "_TITLE";
      
      private static const const_1014:String = "_CONTENT";
      
      private static const const_732:String = "margin_left";
      
      private static const const_731:String = "margin_bottom";
      ...
      private var var_1087:IHeaderWindow;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_732,_loc3_.left,PropertyStruct.const_61,_loc2_));
         _loc1_.push(new PropertyStruct(const_733,_loc3_.top,PropertyStruct.const_61,_loc2_));
         _loc1_.push(new PropertyStruct(const_734,0 - _loc3_.right,PropertyStruct.const_61,_loc2_));
         _loc1_.push(new PropertyStruct(const_731,0 - _loc3_.bottom,PropertyStruct.const_61,_loc2_));
         return _loc1_;
      }
      ...
      public function get margins() : IMargins
      {
         ...
         if(!var_75)
         {
            ...
            var_75 = new TextMargins(_loc1_.left,_loc1_.top,_loc1_.right,_loc1_.bottom,marginsCallback);
         }
         return var_75;
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc3_:Boolean = testParamFlag(WindowParam.const_187);
         var _loc4_:Boolean = testParamFlag(WindowParam.const_197);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
            ...
            if(_loc4_ || _loc2_)
            {
               _loc1_.setParamFlag(WindowParam.const_197,true);
            }
            else
            {
               _loc1_.setParamFlag(WindowParam.const_197,false);
            }
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1087 == null)
         {
            var_1087 = findChildByTag(const_1015) as IHeaderWindow;
            if(!var_1087)
            {
      ...
      public function get title() : ITextWindow
      {
         if(_title == null)
         {
            _title = findChildByTag(const_1013) as ITextWindow;
            if(!_title)
            {
      ...
      {
         return findChildByTag(const_1016) as IScalerWindow;
      }
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_254,false);
         }
      ...
      {
         return content != null && var_1336 ? content.iterator : new Iterator(this);
      }
      ...
      public function get content() : IWindowContainer
      {
         if(var_35 == null)
         {
            var_35 = findChildByTag(const_1014) as IWindowContainer;
            if(!var_35)
            {
