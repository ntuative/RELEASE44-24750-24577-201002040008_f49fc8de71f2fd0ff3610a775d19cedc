package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1073:String = "content";
      ...
      protected var var_901:ITabSelectorWindow;
      
      private var var_867:Boolean = false;
      
      protected var var_1561:IWindowContainer;
      ...
      public function get container() : IWindowContainer
      {
         if(var_1561 == null)
         {
            var_1561 = findChildByTag(TabContextController.const_1073) as IWindowContainer;
         }
         return var_1561;
      }
      ...
      public function get selector() : ITabSelectorWindow
      {
         if(var_901 == null)
         {
            var_901 = findChildByTag(TabContextController.const_1074) as ITabSelectorWindow;
            if(var_901 != null)
            {
               var_901.procedure = selectorEventProc;
            }
         }
         return var_901;
      }
