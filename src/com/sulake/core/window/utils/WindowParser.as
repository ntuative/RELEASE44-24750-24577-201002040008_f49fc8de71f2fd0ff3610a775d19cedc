package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1583:String = "_INCLUDE";
      
      public static const const_837:String = "_EXCLUDE";
      
      public static const const_1508:String = "_TEMP";
      
      private static const const_1050:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1049:RegExp = /(\s|\n|\r|\t|\v)*$/;
      ...
      protected var var_899:Dictionary;
      
      protected var var_1327:Map;
      
      protected var var_29:IWindowContext;
      
      protected var var_1328:Dictionary;
      
      protected var var_1070:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         var_1071 = new Dictionary();
         TypeCodeTable.fillTables(var_1070,var_1071);
         var_899 = new Dictionary();
         var_1328 = new Dictionary();
         ParamCodeTable.fillTables(var_899,var_1328);
         var_1327 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1049,"");
         return param1.replace(const_1050,"");
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            for(_loc1_ in var_1070)
            {
               delete var_1070[_loc1_];
            }
            for(_loc1_ in var_1071)
            {
               delete var_1071[_loc1_];
            }
            for(_loc1_ in var_899)
            {
               delete var_899[_loc1_];
            }
            for(_loc1_ in var_1328)
            {
               delete var_1328[_loc1_];
            }
            var_1327.dispose();
            var_1327 = null;
            var_29 = null;
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         window = var_29.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,parseProperties(xml.child("variables")[0]),tags) as WindowController;
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_837) == -1)
                  {
