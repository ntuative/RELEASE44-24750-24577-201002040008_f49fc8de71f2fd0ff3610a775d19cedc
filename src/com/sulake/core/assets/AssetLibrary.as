package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_933:String = "AssetLibraryReady";
      
      public static const const_1251:String = "AssetLibraryUnloaded";
      
      public static const const_384:String = "AssetLibraryLoaded";
      
      public static const const_1355:String = "AssetLibraryLoadError";
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in var_426)
         {
            _loc4_ = AssetTypeDeclaration(var_426[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      public function unload() : void
      {
         ...
         for(_loc1_ in var_725)
         {
            delete var_725[_loc1_];
         }
         if(var_1 != null)
         {
            var_1.dispose();
         ...
         var_312 = false;
         _file = null;
         dispatchEvent(new Event(AssetLibrary.const_1251));
      }
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         if(var_515)
         {
            AssetLibrary.fetchLibraryContents(this,var_514,var_358);
         }
         var_312 = true;
         dispatchEvent(new Event(AssetLibrary.const_384));
         dispatchEvent(new Event(AssetLibrary.const_933));
         if(var_515)
         {
            var_1.dispose();
            var_1 = null;
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = var_425[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_801,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_992,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_836,assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         var_425[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(var_426.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_426[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      private function loadErrorHandler(param1:Event) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1355));
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         {
            _loc3_ = AssetTypeDeclaration(var_426[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      public function loadFromFile(param1:URLRequest, param2:Boolean = true, param3:LoaderContext = null) : LibraryLoader
      {
         ...
         else
         {
            if(var_1 == null)
            {
               var_1 = new LibraryLoader(var_1341);
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = var_425[loader.url];
         if(struct == null)
         {
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         _loc3_ = AssetTypeDeclaration(var_426[param1]);
         if(_loc3_ != null)
         {
            return _loc3_;
         }
