package com.sulake.core.assets
{
   ...
   public class AssetLibraryCollection extends EventDispatcher implements IAssetLibrary
   {
      ...
      protected var var_1069:LoaderContext;
      
      protected var var_45:Array;
      
      protected var var_519:Array;
      
      private var var_614:uint = 0;
      ...
      public function AssetLibraryCollection(param1:String)
      {
         ...
         var_45 = new Array();
         var_519 = new Array();
         var_1069 = new LoaderContext(false,ApplicationDomain.currentDomain,null);
         var_362 = new AssetLibrary("lib-" + var_614++);
         var_45.push(var_362);
      }
      ...
      private function method_4() : uint
      {
         var _loc1_:* = 0;
         var _loc2_:int = 0;
         var _loc3_:int = 0;
      ...
      public function unload() : void
      {
         while(false)
         {
            (var_519.pop() as IAssetLibrary).dispose();
         }
         while(false)
         {
      ...
      public function loadFromFile(param1:URLRequest, param2:Boolean = false, param3:LoaderContext = null) : LibraryLoader
      {
         ...
         var _loc4_:IAssetLibrary = new AssetLibrary("lib-" + var_614++);
         var_519.push(_loc4_);
      ...
      private function loadEventHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         {
            _loc4_ = 0;
            while(_loc4_ < var_519.length)
            {
               _loc3_ = var_519[_loc4_] as IAssetLibrary;
               if(_loc3_.url == _loc2_.url)
               {
                  var_519.splice(_loc4_,1);
                  break;
               }
               _loc4_++;
            }
