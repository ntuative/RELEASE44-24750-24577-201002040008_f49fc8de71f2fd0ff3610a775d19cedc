package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      public static const const_910:uint = 4;
      ...
      protected var var_900:String = "";
      
      protected var var_186:InterfaceStructList;
      
      protected var var_2233:String = "";
      
      protected var _assets:IAssetLibrary;
      
      protected var var_368:uint = 0;
      
      protected var var_29:IContext = null;
      
      protected var var_1616:Boolean = false;
      ...
      public function release(param1:IID) : uint
      {
         ...
         if(_loc2_ == null)
         {
            var_900 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(var_900);
         }
         var _loc3_:uint = _loc2_.release();
         if(var_1067 & const_910)
         {
            if(_loc3_ == 0)
            {
      ...
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + var_368 + "]";
      }
   }
}
